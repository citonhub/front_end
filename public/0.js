...
var TopBar = function TopBar() {
  return __webpack_require__.e(/*! import() | top-bar?v=0.19 */ "top-bar?v=0.19").then(__webpack_require__.bind(null, /*! ./TopBar.vue */ "./resources/js/components/Hub/TopBar.vue"));
};
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass: "col-12",
      staticStyle: { position: "fixed", height: "100%", background: "#F5F5FB" }
    },
    [_c("top-bar")],
    1
  )
