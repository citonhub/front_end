    ...
    uploadeFile: function uploadeFile() {
      ...
      axios.post('/upload-panel-file', formData, {
        ...
        if (response.status == 201) {
          _this2.loading = false; // push new files into the  file list

          _this2.$root.projectData.project_files.resources.unshift(response.data);
          ...
          _c("div", { staticClass: "row my-2 py-2 px-2" }, [
            ...
            _vm.fileUrl != ""
              ? _c(
                  "div",
                  {
                    staticClass: "col-12  d-flex py-2 px-1 my-2",
                    staticStyle: {
                      "align-items": "center",
                      "justify-content": "center"
                    }
              ...
              : _vm._e(),
            _vm._v(" "),
            _vm.progressvalue > 0 && _vm.fileUrl != ""
              ? _c(
                  "div",
                  {
