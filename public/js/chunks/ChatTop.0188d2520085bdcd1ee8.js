...
var render = function() {
  ...
  return _c("div", { staticClass: "row" }, [
    _c(
      "div",
      {
        staticClass: "col-md-9 py-0 d-md-flex px-md-1 flex-row  d-none",
            ...
            [
              ...
              this.$root.typingSpace == this.$root.selectedSpace.space_id
                ? _c("span", { staticClass: "typingText d-block" }, [
                    this.$root.selectedSpace.type != "Direct"
                      ? _c("span", [
                          _vm._v(" " + _vm._s(this.$root.typinguser) + " is")
                        ])
                      : _vm._e(),
                    _vm._v(" typing... ")
                  ])
    ...
    _c(
      "div",
      {
        staticClass: "col-md-1 py-1 d-md-block d-none text-right d-md-flex",
        staticStyle: { "align-items": "center" }
      },
      [
        this.$root.selectedSpace.type != "Direct" &&
    ...
    _c(
      "div",
      {
        staticClass: "col-md-1 py-1 text-right  d-none d-md-flex",
        staticStyle: { "align-items": "center" }
      },
      [
        _c(
    ...
    _c(
      "div",
      { staticClass: "col-1 py-0 px-0 d-md-none d-block pt-1 text-center" },
      [
        this.$root.selectedSpace.type != "Direct" &&
        this.$root.selectedSpace.type != "Bot"
          ? [
    ...
    _c(
      "div",
      { staticClass: "col-1 py-0 px-0 text-center pt-1 d-md-none d-block" },
      [
        this.$root.selectedSpace.type != "Bot"
          ? [
              _c(
