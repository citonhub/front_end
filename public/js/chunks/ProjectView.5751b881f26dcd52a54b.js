  ...
  methods: (_methods = {
    ...
    showPage: function showPage() {
      ...
      if (this.$root.selectedPost.project.project.is_web) {
        ...
        if (this.panelData.panel_language == '39' || this.panelData.panel_language == '100' || this.panelData.panel_language == '38') {
          var InputRegex = /(input\(')(.*)('\))/g;
          var InputFound = this.$root.selectedPost.project.project_files.code_files[0].content.match(InputRegex);

          if (InputFound == null) {
            InputRegex = /(input\(")(.*)("\))/g;
            InputFound = this.$root.selectedPost.project.project_files.code_files[0].content.match(InputRegex);
          }
          ...
          if (InputFound != null) {
            if (InputFound.length > 0) {
              ...
              InputFound.forEach(function (input) {
                ...
                _this8.$root.projectInputData.push(inputData);
              });
  ...
  return _c(
    ...
    [
      ...
      _c(
        ...
        [
          ...
          _c(
            ...
            {
              staticClass:
                "col-lg-6 offset-lg-3 py-1 px-0 mt-2 d-flex flex-row",
              staticStyle: {
                "align-items": "center",
      ...
      _c(
        "div",
        {
          staticClass: "col-lg-6 offset-lg-3 py-0 px-0 fixed-bottom",
          staticStyle: {
