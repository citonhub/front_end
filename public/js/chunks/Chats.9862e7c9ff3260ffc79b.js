  ...
  methods: {
    ...
    searchChatList: function searchChatList() {
      ...
      var chatListResult = this.$root.ChatList.filter(function (chat) {
        ...
        return nameValue.includes(_this2.searchValue.toLowerCase());
      });
        ...
        if (this.$root.ChatList.length == 0) {
          ...
          storedChat.then(function (result) {
            if (result != null) {
              ...
              _this3.$root.baseChatList = finalResult;
              ...
              axios.get('/fetch-chat-list/' + _this3.$root.userDeviceId).then(function (response) {
                ...
                _this3.showAlert('Oops!', 'Unable to fetch channels', 'error');

                _this3.loadingChatList = false;
                _this3.loadingIsError = true;
              });
            }
          });
        }
      ...
      if (this.$root.checkauthroot == 'auth') {
        ...
        storedMsg.then(function (result) {
          if (result != null) {
            ...
            setTimeout(function () {
              if (_this10.$root.selectedSpace.type == 'Channel' || _this10.$root.selectedSpace.type == 'Team') {
                if (_this10.$refs.messageContainer) {
                  _this10.$refs.messageContainer.scrollToBottom();
                }

                if (_this10.$refs.messageContainersmall) {
    ...
    fetchSpaceInfo: function fetchSpaceInfo() {
      ...
      axios.get('/fetch-space-info-' + this.$route.params.spaceId).then(function (response) {
        if (response.status == 200) {
          var storedMsg = _this12.$root.getLocalStore('full_' + _this12.$route.params.spaceId + _this12.$root.username);
          ...
          storedMsg.then(function (result) {
            if (result != null) {
              ...
              _this12.$root.LocalStore('full_' + _this12.$route.params.spaceId + _this12.$root.username, finalResult);
            }
          }); // update chatList

          var storedChat = _this12.$root.getLocalStore('user_chat_list' + _this12.$root.username);
            ...
            if (result != null) {
              ...
              if (response.data.space.type == 'Channel' || response.data.space.type == 'Team') {
                finalResult.channels.map(function (chat) {
                  if (chat.space_id == _this12.$route.params.spaceId) {
              ...
              _this12.$root.LocalStore('user_chat_list' + _this12.$root.username, finalResult);
            }
          });
        }
      })["catch"](function (error) {});
      ...
      _c(
        ...
        [
                    ...
                    ? [
                        ...
                        !this.$root.loadingIsError
                          ? [
                              _c("DynamicScroller", {
                                ref: "ChatContainer",
                                staticClass: "col-12 px-1  chatListScroller",
                                staticStyle: {
                                  position: "absolute",
                                  "overflow-y": "auto",
                                  top: "0%",
          ...
          _c(
            "div",
            {
              staticClass: "d-flex flex-column px-0 py-0",
              staticStyle: {
                height: "100%",
                width: "72%",
                left: "28%",
            ...
            [
              ...
              !_vm.messageIsDone
                ? [
                    _c(
                      ...
                      [
                        _c("img", {
                          attrs: { src: "/imgs/chat_side.svg", height: "250px" }
                        }),
                        _vm._v(" "),
                        _c(
                          "div",
                          ...
                          [
                            _c(
                              ...
                              [
                                _vm._v(
                                  _vm._s(
                                    _vm.qouteArray[_vm.selectedQuoteId].qoute
                                  )
                                )
                              ]
                            ),
              ...
              _vm.chatIsOpen && _vm.chatInnerSideBar
                ...
                : _vm._e(),
              _vm._v(" "),
              _vm.chatIsOpen && !_vm.chatInnerSideBar && _vm.liveSessionIsOpen
                ? _c(
                    "div",
                    {
                      staticClass: "col-12 py-0 px-0",
              ...
              _vm.chatIsOpen && !_vm.chatInnerSideBar && _vm.chatShareIsOpen
                ...
                : _vm._e(),
              _vm._v(" "),
              _vm.chatIsOpen && !_vm.chatInnerSideBar && _vm.imageCropperIsOpen
                ? _c(
                    "div",
                    {
                      staticClass: "col-12 py-0 px-0",
