...
var LiveSession = function LiveSession() {
  return Promise.all(/*! import() | LiveSession */[__webpack_require__.e("vendors~Board~Hub~LiveSession~ProjectView"), __webpack_require__.e("LiveSession")]).then(__webpack_require__.bind(null, /*! ./LiveSession.vue */ "./resources/js/components/chats/LiveSession.vue"));
};
...
var ProfileView = function ProfileView() {
  return Promise.all(/*! import() | ProfileView */[__webpack_require__.e("vendors~AddGem~AddProject~ChallengePanel~Chats~DiaryBoard~FeedForm~ForgotPassword~GetDiary~Hub~Panel~a01259d3"), __webpack_require__.e("vendors~ForgotPassword~Hub~ProfilePage~ResetPassword~SetUsername~register~verify"), __webpack_require__.e("ProfilePage")]).then(__webpack_require__.bind(null, /*! ../Profile/ProfilePage.vue */ "./resources/js/components/Profile/ProfilePage.vue"));
};
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    searchUdemy: function searchUdemy() {
      if (this.$router.currentRoute.path.indexOf('resource_search') >= 0) {
    ...
    searchDevto: function searchDevto() {
      this.$router.push({
        path: '/channels/' + this.$root.selectedSpace.space_id + '/resource_search'
      });
    ...
    [
      ...
      _c(
        "v-btn",
        {
          ...
          staticStyle: { position: "absolute", left: "12px", top: "3%" },
                ...
                [
                            ...
                            _c(
                              ...
                              [
                                _c(
                                  ...
                                  [_c("v-icon", [_vm._v("las la-folder")])],
                                  1
                                )
                              ],
                              1
                  ...
                  _vm.chatIsOpen && _vm.chatInnerConent == "channel_invitation"
                    ? _c(
                        "div",
                        {
                          staticClass: "col-12 py-2 pt-4 px-0 text-center ",
                          staticStyle: {
                              ...
                              _c(
                                ...
                                [
                                  ...
                                  _vm.innerSideBarContent == "resource_content"
                                    ...
                                    : _vm._e(),
                                  _vm._v(" "),
                                  this.$router.currentRoute.path.indexOf(
                                    "resource_"
                                  ) >= 0
                                    ? _c(
                                        "v-btn",
                  ...
                  [
                    ...
                    _vm.chatInnerConent == "channel_invitation"
                      ? _c(
                          "div",
                          {
                            staticClass: "col-12 py-0 pt-5 px-0 text-center ",
                            staticStyle: {
                              background: "rgba(27, 27, 30, 0.32)",
                              "border-top": "1px solid #c5c5c5",
                              left: "0",
                    ...
                    _vm.that.$root.showYoutubePlayer
                      ? _c(
                          "div",
                          {
                            staticClass: "d-flex flex-row text-center",
                            staticStyle: {
                              position: "fixed",
                              height: "100%",
                              background: "rgba(27, 27, 30, 0.32)",
