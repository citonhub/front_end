...
/* harmony import */ var vue_horizontal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! vue-horizontal */ "./node_modules/vue-horizontal/dist/vue-horizontal.esm.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    goToCardView: function goToCardView() {
      this.$router.push({
        path: '/board/wallet/card-view'
      });
    },
    fetchPaymentCard: function fetchPaymentCard() {
      ...
      storedPaymentCard.then(function (result) {
        if (result != null) {
          ...
          _this.paymentCards = finalResult.payment_cards; // this.paymentCards.sort(function(a, b){return b.balance - a.balance})
    ...
    checkForNewPaymentCard: function checkForNewPaymentCard() {
      ...
      axios.get('/payment-cards').then(function (response) {
        if (response.status == 200) {
          ...
          _this2.paymentCards = response.data.payment_cards; //  this.paymentCards.sort(function(a, b){return b.balance - a.balance})
        }
      })["catch"](function (error) {});
    },
        ...
        _c("div", { staticClass: "col-12 d-flex px-md-2 px-0 flex-row" }, [
          _c(
            ...
            [
              _c(
                "v-card",
                { staticClass: "bg-primary", attrs: { "min-width": "180" } },
                [
                  _c(
                    "div",
              ...
              _c(
                "v-card",
                {
                  staticStyle: {
                    ...
                    "border-radius": "10px",
                    background: "url(/imgs/card_bg_3.jpg)",
          ...
          _c(
            ...
            [
              _c("v-btn", { staticClass: "bg-primary" }, [
                _c(
                  "span",
                  {
                    staticStyle: {
        ...
        _c("div", { staticClass: "col-12 px-0 px-md-1 pt-md-5 pt-0" }, [
          ...
          _c("div", { staticClass: "col-12 px-0 d-flex py-0 flex-column" }, [
            ...
            _c(
              ...
              {
                staticClass:
                  "text-center col-12 application application--light",
                attrs: { "data-app": "true" }
              },
              [
                _c("v-pagination", {
      ...
      _c("div", { staticClass: "col-12 px-0 px-md-1 pt-md-5 pt-3" }, [
        ...
        _c("div", { staticClass: "col-12 px-0 d-flex py-0 flex-column" }, [
          ...
          _c(
            "div",
            {
              staticClass: "text-center col-12 application application--light",
              attrs: { "data-app": "true" }
            },
            [
              _c("v-pagination", {
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "normalText" }, [
      ...
      _c("span", { staticClass: "boldText" }, [_vm._v("₦3000")]),
      _vm._v(" donation from "),
      _c("span", { staticClass: "boldText" }, [_vm._v("Joy Adejumo")]),
      _vm._v(" to "),
      _c("span", { staticClass: "boldText" }, [_vm._v("DSC Landmark")]),
      _vm._v("\n                         | Aug 12, 2021\n                     ")
    ])
  ...
  function() {
    ...
    return _c("div", { staticClass: "normalText" }, [
      _c("span", { staticClass: "normalText" }, [_vm._v("Received ")]),
      _c("span", { staticClass: "boldText" }, [_vm._v("₦2000")]),
      _vm._v(" subscription from "),
      _c("span", { staticClass: "boldText" }, [_vm._v("David Shola")]),
      _vm._v(" to "),
      _c("span", { staticClass: "boldText" }, [_vm._v("DSC Landmark")]),
      _vm._v("\n                         | Aug 12, 2021\n                     ")
    ])
  ...
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "ml-auto pl-2" }, [
      _c("span", { staticClass: "boldText text-success" }, [
        _vm._v("Subscription")
      ])
    ])
  },
