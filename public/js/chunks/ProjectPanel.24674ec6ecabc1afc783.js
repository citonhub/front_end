                            ...
                            "v-chip",
                            {
                              ...
                              style:
                                _vm.that.$root.selectedFileId == file.id
                                  ? "color:white;background-color:#3C87CD;font-family:MediumFont;"
                                  : "background:transparent;font-family:MediumFont;border:1px solid #3C87CD;",
                              attrs: { close: "", small: "" },
                              on: {
        ...
        _c(
          ...
          [
            _c(
              "div",
              {
                staticClass: "col-lg-3 col-md-4  scroller d-md-block d-none",
                staticStyle: {
                  position: "absolute",
                  height: "98%",
                  background: "#ffffff",
            ...
            _c(
              "div",
              {
                staticClass: " col-lg-9 offset-lg-3  col-md-8 offset-md-4 ",
                staticStyle: {
                  position: "absolute",
                  height: "95%",
                  background: "#F3F8FC",
