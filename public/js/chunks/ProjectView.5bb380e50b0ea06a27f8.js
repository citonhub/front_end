  ...
  methods: (_methods = {
    ...
    storedPostData.then(function (result) {
      if (result != null) {
        ...
        _this11.panelData = _this11.$root.selectedPost.project.project.project_panel;
        console.log(_this11.$root.selectedPost.project.project);
        ...
        axios.get('/fetch-post/' + currentPostid).then(function (response) {
          if (response.status == 200) {
            _this11.$root.LocalStore('post_data_' + currentPostid + _this11.$root.username, response.data.data);
    ...
    axios.get('/fetch-post/' + this.$route.params.post_id).then(function (response) {
      if (response.status == 200) {
        _this12.$root.LocalStore('post_data_' + _this12.$route.params.post_id + _this12.$root.username, response.data.data);
  ...
  return _c(
    ...
    [
      ...
      _c("div", { staticClass: "px-2 col-12 py-0" }, [
        ...
        _vm._v(" "),
        this.$root.selectedPost.project.project
