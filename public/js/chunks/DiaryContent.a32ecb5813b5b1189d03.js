...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    addNote: function addNote() {
      ...
      axios.get('/add-new-note/' + this.$route.params.diary_id).then(function (response) {
        if (response.status == 200) {
          ...
          _this.$router.push({
            path: '/board/diary/board/' + _this.$route.params.diary_id + '/edit-note/' + _this.$root.noteContent.tag_unique_id
          });
        }
    ...
    showNote: function showNote(note) {
      ...
      this.$router.push({
        path: '/board/diary/board/' + this.$route.params.diary_id + '/edit-note' + this.$root.noteContent.tag_unique_id
      });
    },
    ...
    getdiaryData: function getdiaryData() {
      ...
      storedProjectData.then(function (result) {
        if (result != null) {
          ...
          _this2.$root.selectedDiary = finalResult;
          _this2.loading = false;

          _this2.updateNotes();
        } else {
          axios.get('get-diary-data/' + _this2.$route.params.diary_id).then(function (response) {
            if (response.status == 200) {
              _this2.$root.LocalStore('user_diary_data_' + _this2.$route.params.diary_id + _this2.$root.username, response.data.diary_data);

              _this2.$root.selectedDiary = response.data.diary_data;
              _this2.loading = false;
            }
          })["catch"](function (error) {
            _this2.loading = false;
                      ...
                      _c(
                        ...
                        [
                          ...
                          _c(
                            ...
                            [_vm._v(" " + _vm._s(element.note.tag_name))]
                          )
                        ],
                        1
                      ),
                          ...
                          _c(
                            ...
                            [
                              ...
                              _c(
                                ...
                                [_vm._v(_vm._s(element.note.likes))]
                              ),
                              _vm._v(" "),
                              _c(
                                "v-icon",
                              ...
                              _c(
                                ...
                                [_vm._v(_vm._s(element.note.views))]
                              )
                            ],
                            1
                          )
