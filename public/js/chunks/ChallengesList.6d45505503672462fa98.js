...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("div", {
        staticClass: "my-lg-2 mt-md-1 mb-md-2 mt-4 mb-4 col-12",
      ...
      _c(
        ...
        [
          _c(
            "div",
            { staticClass: "row text-center px-1 mt-2" },
            _vm._l(_vm.challenges, function(box, index) {
              return _c(
                "v-card",
                {
                  key: index,
                  staticClass: "col-12 py-0 px-md-0 px-1 d-flex mb-2 flex-row ",
                ...
                [
                  _c("div", { staticClass: "mx-2 py-3 d-md-block d-none" }, [
                    _c("div", {
                      staticStyle: {
                        "border-radius": "10px",
                        height: "100%",
                  ...
                  _vm._v(" "),
                  _c("div", { staticClass: "mx-1 py-2 d-block d-md-none" }, [
                    _c("div", {
                      staticStyle: {
                        "border-radius": "10px",
                        height: "50px",
