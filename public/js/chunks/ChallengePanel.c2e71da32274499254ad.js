  ...
  methods: {
    fetchChallenge: function fetchChallenge() {
      ...
      storedProjectData.then(function (result) {
        if (result != null) {
          ...
          _this.$root.selectedChallenge = finalResult;
          _this.loadingChallenge = false; // this.checkForNewChallengeData();
        } else {
          axios.get('/fetch-challenge-data/' + _this.$route.params.challenge_id).then(function (response) {
            if (response.status == 200) {
              _this.$root.LocalStore('challenge_data_' + _this.$route.params.challenge_id + _this.$root.username, response.data);

              _this.$root.selectedChallenge = response.data;
    ...
    imageStyleUser: function imageStyleUser(dimension, data) {
      if (data.background_color == null) {
        ...
        _styleString += 'background-color:#ffffff; background-image:url(imgs/profile.png);';
        return _styleString;
      } else {
    ...
    imageStyle: function imageStyle(height, data, type) {
      if (data.background_color == null) {
        if (type == 'large') {
          var _styleString3 = "position:absolute;height:" + height + ";top:0; left:0;width:100%;border-bottom:1px solid #c5c5c5; \n                 background-size: cover; border-top-left-radius:6px;border-top-right-radius:6px;\n                    background-repeat: no-repeat;";
        } else {
          var _styleString4 = "position:absolute;height:" + height + ";top:0; left:0;width:100%;border-bottom:1px solid #c5c5c5;\n                background-size: cover; border-radius:0px;\n                    background-repeat: no-repeat;";
        }
        ...
        if (type == 'large') {
          var _styleString5 = "position:absolute;height:" + height + ";top:0; left:0;width:100%;border-bottom:1px solid #c5c5c5; \n                 background-size: cover; border-top-left-radius:6px;border-top-right-radius:6px;\n                    background-repeat: no-repeat;";
        } else {
          var _styleString6 = "position:absolute;height:" + height + ";top:0; left:0;width:100%;border-bottom:1px solid #c5c5c5;\n                background-size: cover; border-radius:0px;\n                    background-repeat: no-repeat;";
        }
      ...
      _c(
        ...
        [
          _c(
            ...
            [
              this.$root.selectedChallenge.length > 0
                ? [
                    _c(
                      "div",
                      {
                      ...
                      _c(
                        ...
                        [
                          _c(
                            ...
                            [_vm._v(_vm._s(this.$root.selectedChallenge.title))]
                          ),
                          _vm._v(" "),
                          _c(
                            "div",
                            ...
                            [
                              _vm._v(
                                _vm._s(this.$root.selectedChallenge.summary) +
                                  " "
                              )
                            ]
                          )
