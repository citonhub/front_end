    ...
    return _c("div", { staticClass: "col-lg-12" }, [
      ...
      _c("div", { staticClass: "body col-lg-6 px-1 py-1 mb-4" }, [
        ...
        _c("div", { staticClass: "files  col-lg-6 px-1 py-1 mb-4" }, [
          ...
          _c("p", [
            _vm._v(
              "\n    There are many ways to add files to your project. On the project panels there are different file types such as views and styles.\n    Cick on the plus button beside each one. A like the one below appears. Choose your desired option and click save. You will now find the file under the category \n"
            )
          ])
        ]),
        _vm._v(" "),
