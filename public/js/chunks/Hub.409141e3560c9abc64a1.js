  ...
  methods: {
    ...
    imageStyle: function imageStyle(width, data) {
      if (data.image_name == null) {
        var styleString = "height: " + width + "px; width: 94%; left: 3%; border: 1px solid #c5c5c5;  background-repeat: no-repeat; border-radius: 20px; box-shadow: 0px 0px 8px -2px rgba(60, 135, 205, 0.25); background-size: cover;";
        ...
        var _styleString = "height: " + width + "px; width: 94%; left: 3%; border: 1px solid #c5c5c5;  background-repeat: no-repeat; border-radius: 20px; box-shadow: 0px 0px 8px -2px rgba(60, 135, 205, 0.25); background-size: cover;";

        var imgLink = data.image_name;
        _styleString += 'background-color:' + data.background_color + '; background-image:url(/imgs/posts/' + imgLink + ');';
        return _styleString;
      }
    },
