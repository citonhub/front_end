...
Vue.use(vue_flutterwave__WEBPACK_IMPORTED_MODULE_0___default.a, {
  publicKey: 'FLWPUBK-ea9a4693d8c3caabf78dafe50beccf96-X'
});
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
        ...
        callback: function callback(data) {
          if (data.status == 'successful') {
            ...
            axios.post('/save-transaction', {
              ...
              paymentplan: paymentplan,
              destination_currency: _this2.currency,
              origin_currency: _this2.spaceData.payment_data.currency
            }).then(function (response) {
              if (response.status == 200) {
                _this2.deleteTransactionCopy(reference);
    ...
    deleteTransactionCopy: function deleteTransactionCopy(ref) {
    ...
    makeTransactionCopy: function makeTransactionCopy(ref) {
        ...
        if (response.status == 200) {
          ...
          if (_this3.spaceData.is_member) {
            ...
            if (_this3.spaceData.payment_option == 'support' && _this3.$root.isLogged) {
              ...
              if (_this3.spaceData.payment_option == null) {
                if (!_this3.$root.fromSupportDirectlink) {
                  _this3.$root.chatComponent.openChat(_this3.$route.params.spaceId, true);
                      ...
                      [
                        _c(
                          "v-card",
                          {
                            ...
                            attrs: {
                              color: _vm.support_type == "once" ? "#3C87CD" : ""
                            },
                            on: {
                      ...
                      [
                        _c(
                          "v-card",
                          {
                            ...
                            style:
                              _vm.support_type == "recurrent"
                                ? "height:100px; border:1px solid #3C87CD; border-radius:7px;color:white;"
                                : "height:100px; border:1px solid #c5c5c5; border-radius:7px;",
                            attrs: {
                              color:
                                _vm.support_type == "recurrent" ? "#3C87CD" : ""
                            },
                            on: {
                              click: function($event) {
