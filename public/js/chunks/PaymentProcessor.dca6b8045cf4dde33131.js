...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "col-lg-6 col-md-6 d-flex flex-column " },
    [
      _c(
        "div",
        {
          staticClass: "text-center mb-2 mt-4 d-flex",
      ...
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _c("v-text-field", {
            staticStyle: { "font-size": "13px", width: "80%" },
            attrs: {
              placeholder: "amount",
              dense: "",
              type: "tel",
      ...
      _c(
        "div",
        { staticClass: "col-12 text-center py-2" },
        [
          _c(
            "v-btn",
            {
