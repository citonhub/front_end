...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "basics col-lg-6 px-1 py-1" }, [
      ...
      _c("div", { staticClass: "files  col-lg-6 px-1 py-1 mb-4 col-lg-10" }, [
        ...
        _vm._v(" "),
        _c("img", { attrs: { src: "imgs/guide/file-s.png", alt: "" } }),
        _vm._v(" "),
        _c("p", { staticClass: "mt-4" }, [
          _vm._v("Files created under differnt categories.")
        ])
      ]),
      _vm._v(" "),
  ...
  function() {
    ...
    return _c(
      "div",
      { staticClass: "common col-lg-12", attrs: { id: "common" } },
      [
        _c("h2", { staticClass: " ml-2" }, [_vm._v("Common Errors")]),
        _vm._v(" "),
        _c("div", { staticClass: "error mb-4 col-lg-8 " }, [
          _c("p", { staticClass: "text-danger" }, [
            _vm._v(
              " 1. Error: Framework(Vuejs, bootstrap) code not working as it should"
            )
          ]),
          _vm._v(" "),
          _c("ul", { staticClass: "solutions" }, [
            _c("li", { staticClass: "text-success" }, [
              _vm._v(
                "Possible solution: Make sure you are bringing in the framework via a  CDN."
              )
            ])
          ])
        ]),
        ...
        _c("div", { staticClass: "error mb-4 col-lg-8 " }, [
          _c("p", { staticClass: "text-danger" }, [
            _vm._v(" 1. Error: PHP web app displaying error page")
          ]),
          _vm._v(" "),
          _c("p", [_vm._v("Here is an example of what this could look like.")]),
          _vm._v(" "),
          _c("img", {
          ...
          _c("ul", { staticClass: "solutions" }, [
            _c("li", { staticClass: "text-success" }, [
              _vm._v(
                "Possible solution: Scroll down the error display page to see where the error occcurs in your code."
              )
            ]),
            _vm._v(" "),
            _c("img", {
            ...
            _c("p", [
              _vm._v(
                "Here is an example of what you see. In this case the error is due to wrong syntax on line 15."
              )
            ])
          ])
        ])
