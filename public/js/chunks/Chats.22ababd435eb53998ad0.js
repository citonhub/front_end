...
var SideBar = function SideBar() {
  return Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ../dashboard/sideBar.vue */ "./resources/js/components/dashboard/sideBar.vue"));
};
              ...
              _vm.chatIsOpen && !_vm.bottomIsVisible
                ? _c(
                    "v-btn",
                    {
                      ...
                      attrs: { fab: "", "x-small": "", color: "#3C87CD" },
                      on: {
                        click: function($event) {
