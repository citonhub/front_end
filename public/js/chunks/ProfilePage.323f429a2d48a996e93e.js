  ...
  methods: {
    ...
    fetchProfileContent: function fetchProfileContent() {
      ...
      axios.get('/fetch-profile-' + this.$route.params.username).then(function (response) {
        if (response.status == 200) {
          _this3.userData = response.data.user_data;
          _this3.profileData = response.data.profile;
          _this3.xp = _this3.profileData.points;

          _this3.calculateLevel();

          if (_this3.$route.params.username == _this3.$root.username) {
            // this should be true
            _this3.owner = true;
          } else if (_this3.$route.params.username = !_this3.$root.username) {
            _this3.owner = false;
          }
        ...
        _this3.showAlert('Oops!', 'Something went wrong', 'error');
      });
    },
