...
Vue.component('vue-draggable-resizable', vue_draggable_resizable__WEBPACK_IMPORTED_MODULE_0___default.a);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    onDrag: function onDrag(e) {
      document.querySelector('.file_explorer').style.width = document.querySelector('.file_explorer').clientWidth + e.clientX - this.startX + 'px';
    },
            ...
            _c(
              "vue-draggable-resizable",
              {
                attrs: {
                  draggable: false,
                  h: "100%",
                  "class-name-resizable": _vm.handle,
                  parent: true,
                  resizable: true,
                  "class-name": "file_explorer"
                }
              },
              [_c("v-btn", { staticClass: "handle" }, [_vm._v("move")])],
              1
            ),
            _vm._v(" "),
