  ...
  methods: (_methods = {
    ...
    axios.get("/fetch-resource/".concat(this.$root.selectedSpace.space_id, "/resource")).then(function (response) {
      if (response.status == 200) {
        ...
        if (_this9.resources.length == 0) {
          _this9.showTextarea = true;
        }
                            ...
                            [
                              _c("div", [
                                _c("input", {
                                  ...
                                  attrs: {
                                    placeholder:
                                      "Type resource title e.g PHP arrays"
                                  },
  ...
  function() {
    ...
    return _c("div", { staticClass: "col-12 text-center py-1" }, [
      _c(
        ...
        [_vm._v("If you have a YouTube channel, you can import your videos.")]
      )
    ])
  }
]
