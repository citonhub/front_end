  ...
  methods: {
    ...
    imageStyle: function imageStyle(width, data) {
      if (data.image_extension == null) {
        ...
        this.additionalStyle = _styleString2;
        var imgLink = data.image_name + '.' + data.image_extension;
        this.externalUrl = imgLink;
  ...
  return _c(
    ...
    [
      _c(
        ...
        {
          attrs: {
            externalUrl: _vm.externalUrl,
            backgroundColor: _vm.backgroundColor,
            additionalStyle: _vm.additionalStyle,
            externalClass: _vm.externalClass
          },
          on: {
          ...
          _c(
            ...
            [
              _c("div", { staticClass: "row" }, [
                _c(
                  "div",
                  { staticClass: "col-9 py-0 my-0 d-flex flex-column" },
                  [
                    _c(
                      "div",
                      {
                ...
                _c(
                  "div",
                  { staticClass: "col-3 py-0 my-0 text-right" },
