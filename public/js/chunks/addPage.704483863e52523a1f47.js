  ...
  methods: {
    ...
    postData: function postData() {
      ...
      if (this.$refs.addPost.validate()) {
        ...
        var languageList = this.post.tags.split(',');
        var finalLanguageArray = [];
        languageList.forEach(function (lang) {
          var langData = _this4.languageIcon.filter(function (data) {
            return data.name == lang;
          });

          finalLanguageArray.push(langData[0]);
        });
        formData.append('tags', finalLanguageArray);
        axios.post('/save-hub-post', formData, {
          ...
          if (response.status == 200) {
            _this4.$root.posts.unshift(response.data.data);
          ...
          _this4.showAlert('Oops!', 'Unable to save post,please try again', 'error');
              ...
              [
                ...
                _c("div", { staticClass: "d-flex flex-row mt-3" }, [
                  _c("div", {
                    ...
                    on: {
                      click: function($event) {
                        return _vm.selectDefaultImg("/imgs/background3.jpg", 1)
                      }
                    }
                  }),
                  _vm._v(" "),
                  _c("div", {
                    ...
                    on: {
                      click: function($event) {
                        return _vm.selectDefaultImg("/imgs/background1.jpg", 2)
                      }
                    }
                  }),
                  _vm._v(" "),
