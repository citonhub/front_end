      ...
      if (this.isURL(this.searchQuery)) {
        ...
        axios.post('/url/metadata', {
          ...
          if (response.status == 200) {
            ...
            _this2.loadingLink = false;
          }
        })["catch"](function (err) {
          console.log(err);

          _this2.$root.chatComponent.showAlert('Oops!', 'Unable to fetch URL details', 'error', 'bottomRight', 3000);
        });
      }
    }
  }
        ...
        : [
            _vm.linkInfo
              ? _c(
                  "div",
                  {
                    staticClass: "col-12  pb-0 pt-0 px-0 d-flex flex-row mt-2",
            ...
            _c(
              ...
              [
                _c(
                  ...
                  [
                    _vm._v(
                      "Add to " + _vm._s(_vm.that.$root.selectedResource.name)
                    )
                  ]
                )
              ],
