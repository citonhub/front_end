...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getAllProjects: function getAllProjects() {
      ...
      axios.get('/fetch-personal-projects').then(function (response) {
        if (response.status == 200) {
          ...
          _this.projectArray = response.data.projects;
        }
    ...
    selectProjectBtn: function selectProjectBtn() {
      this.clearData();
        ...
        [
          ...
          _c(
            ...
            [
              _c(
                "v-btn",
                { attrs: { title: "Share a video", icon: "" } },
                [
                  _c("v-icon", { staticStyle: { "font-size": "26px" } }, [
                    _vm._v("las la-video")
                  ]),
          ...
          _c(
            ...
            [
              _c(
                "v-btn",
                { attrs: { icon: "", title: "Share an audio" } },
                [
                  _c("v-icon", { staticStyle: { "font-size": "26px" } }, [
                    _vm._v("las la-music")
                  ]),
          ...
          _c(
            "v-card",
            {
              staticClass: "px-1 py-1 mx-1",
              staticStyle: { "border-radius": "10px" },
              on: { click: _vm.selectProjectBtn }
            },
            [
              _c(
                "v-btn",
                { attrs: { icon: "", title: "Share a project" } },
                [
                  _c("v-icon", { staticStyle: { "font-size": "26px" } }, [
                    ...
                    [
                      _c(
                        "v-btn",
                        {
                          ...
                          attrs: { small: "", rounded: "", color: "#ffffff" },
