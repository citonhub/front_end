...
var render = function() {
  ...
  return _c("div", { staticClass: "top" }, [
    _c("div", {
      staticClass: " mt-4 col-12 d-md-none d-block",
    ...
    _c(
      ...
      [
        _c(
          "h1",
          { staticClass: "text-left", staticStyle: { "font-size": "2.5rem" } },
        ...
        _c(
          "div",
          { staticClass: "message form-group col-lg-6 offset-lg-3" },
          [
            _c("v-textarea", {
              attrs: { label: "Your message", "auto-grow": "" }
            })
          ],
          1
        )
