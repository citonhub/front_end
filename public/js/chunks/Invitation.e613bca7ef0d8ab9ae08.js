...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: (_methods = {
      ...
      if (this.connectionformstate) {
        ...
        axios.post('/send-to-connections', {
          ...
          if (response.status == 200) {
            ...
            _this2.showAlert('Nice', 'Invitation sent', 'success');
          }
      ...
      if (this.Emailformstate) {
        ...
        axios.post('/send-space-invite-mail', {
          ...
          if (response.status == 200) {
            ...
            _this3.showAlert(5000, 'Invitation sent');
          }
        })["catch"](function (error) {
  ...
  }), _defineProperty(_methods, "closeShare", function closeShare() {
    ...
    var link = 'whatsapp://send?text=' + this.$root.shareLink + '. Sent from CitonHub.';
    window.location = link;
  }), _defineProperty(_methods, "shareToTwitter", function shareToTwitter() {
    var link = 'https://twitter.com/intent/tweet?' + 'url=' + this.$root.shareLink + '&text=Sent from CitonHub.';
    window.location = link;
  }), _defineProperty(_methods, "shareToFacebook", function shareToFacebook() {
    var link = 'https://www.facebook.com/sharer/sharer.php?u=' + this.$root.shareLink + '. Sent from CitonHub.';
    window.location = link;
                      ...
                      ? _c(
                          ...
                          [
                            _c("div", { staticClass: "row py-0 my-0" }, [
                              _c(
                                "div",
                                { staticClass: "col-12 px-1 pb-2 text-left" },
                                [
                                  _c(
                                    "v-btn",
                                    {
