  ...
  methods: {
    ...
    imageStyle: function imageStyle(height, data) {
      if (data.background_color == null) {
        var styleString = "width:100%;height:" + height + "px;position:absolute; left:0%; top:0%;  border:1px solid transparent;background-repeat: no-repeat; background-size:cover; ";
        ...
        var _styleString = "width:100%;height:" + height + "px;position:absolute; left:0%; top:0%; border:1px solid transparent; background-repeat: no-repeat; background-size:cover; ";
