...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: (_methods = {
    ...
    handleSetUp: function handleSetUp(type) {
      if (type == 'youtube') {
        this.$router.push({
          path: '/channels/' + this.$root.selectedSpace.space_id + '/playlists'
        });
      }
                ...
                ? [
                    _c(
                      ...
                      [
                        ...
                        _c(
                          "div",
                          { staticClass: "col-12 py-1 pt-0 px-2 text-left" },
                          [
                            _c(
                              "span",
                              {
                              ...
                              [
                                _vm._v(
                                  "Here is your brand new channel where you engage your community."
                                )
                              ]
                            )
                          ]
                        ...
                        !_vm.channelHasResources()
                          ? [
                              _c(
                                ...
                                [_vm._v("Set up your channel")]
                              ),
                              _vm._v(" "),
                              _c(
                                "div",
                                { staticClass: "col-12 py-1 px-2 text-left" },
                                [
                                  _c(
                                    "span",
                                    {
                                    ...
                                    [
                                      _vm._v(
                                        "Create playlists from Youtube and curate the best resources for your channel "
                                      )
                                    ]
                                  )
                                ]
                              ...
                              _c(
                                "v-card",
                                {
                                  ...
                                  on: {
                                    click: function($event) {
                                      return _vm.handleSetUp("youtube")
                                    }
                                  }
                                },
                                [
                                  ...
                                  _c("div", [
                                    _c(
                                      ...
                                      [_vm._v("Create playlists from Youtube")]
                                    )
                                  ])
                                ]
                              ),
                                ...
                                [
                                  ...
                                  _c("div", [
                                    _c(
                                      ...
                                      [_vm._v("Create resources from DevTo")]
                                    )
                                  ])
                                ]
                              )
                        ...
                        _vm.channelHasResources()
                          ? _c(
                              "div",
                              {
                                staticClass: "mt-5 mb-2 px-2",
                                staticStyle: {
                                  "font-family": "MediumFont",
                                  "font-size": "14px"
                                }
                              },
                              [_vm._v("Invite people")]
                            )
                          : _vm._e()
                      ],
                      2
                ...
                ? [
                    ...
                    _c("div", { staticClass: "col-12  py-0" }, [
                      _c(
                        ...
                        { staticClass: "row" },
                        [
                          _vm.infoText != "custom" || _vm.channelHasResources()
                            ? [
                                _c(
                                  "v-card",
                                  {
                                ...
                                _vm._v(" "),
                                _vm.fromChat &&
                                !_vm.that.$root.comingFromDiaryBank
                                  ? _c(
                                      "v-card",
                                      {
                                        staticClass:
