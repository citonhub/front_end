...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    loadPageContent: function loadPageContent() {
      ...
      axios.get('/run-panel/' + this.projectData.panel_id).then(function (response) {
        if (response.status == 200) {
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("iframe", {
        staticClass: "col-12 mt-5 mt-md-1",
        staticStyle: {
          position: "absolute",
          height: "88%",
          background: "white",
        ...
        attrs: {
          ...
          src:
            "https://blog.citonhub.com/faqs-on-hosting-a-front-end-application-on-on-citonhub-nodejs"
        }
      }),
      _vm._v(" "),
      _vm.pageContent == ""
        ? _c("v-app", { staticClass: "col-12 py-0 my-0" }, [
            _c(
              "div",
              {
                staticClass: " px-5 col-lg-6 offset-lg-3 px-1 py-0 d-flex",
                staticStyle: {
                  border: "0",
                  height: "91%",
                  top: "7%",
        ...
        : _c("div", { staticClass: "col-12 py-1 my-0 px-0" }, [
            _vm.projectData.is_web
              ? _c("iframe", {
                  staticClass: "col-12 mt-5 mt-md-1",
                  staticStyle: {
                    position: "absolute",
      ...
      _c(
        ...
        [
          _c(
            ...
            {
              staticClass: "d-block",
              attrs: { color: "#35747e", fab: "" },
              on: { click: _vm.showPanel }
            },
            [
              _c("v-icon", { attrs: { color: "#ffffff" } }, [_vm._v("mdi-xml")])
            ],
            1
          )
        ],
