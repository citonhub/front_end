...
var MoreOptions = function MoreOptions() {
  return Promise.all(/*! import() | MoreOptionsPanel */[__webpack_require__.e(0), __webpack_require__.e("MoreOptionsPanel")]).then(__webpack_require__.bind(null, /*! ./MoreOptions.vue */ "./resources/js/components/projects/MoreOptions.vue"));
};

var openGit = function openGit() {
  return Promise.all(/*! import() | MoreOptionsPanel */[__webpack_require__.e(0), __webpack_require__.e("MoreOptionsPanel")]).then(__webpack_require__.bind(null, /*! ./AddGit */ "./resources/js/components/projects/AddGit.vue"));
};

var showContributor = function showContributor() {
  return __webpack_require__.e(/*! import() | showContributor */ "showContributor").then(__webpack_require__.bind(null, /*! ./contributors */ "./resources/js/components/projects/contributors.vue"));
};
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
        ...
        if (result != null) {
          ...
          axios.get('/fetch-project-data/' + _this.$route.params.project_slug).then(function (response) {
            if (response.status == 200) {
              ...
              _this.filesAreReady = true; // if(this.$root.projectData.project.is_web){
    ...
    openLoader: function openLoader() {
      this.$root.projectPanelComponent.showSideBar = false;
      this.$router.push({
        path: '/board/projects/panel/' + this.$root.projectData.project.project_slug + '/project-display'
      });
    },
    openMembers: function openMembers() {
      // this.showMember=true
      this.$root.projectPanelComponent.showSideBar = false;
      this.$router.push({
        path: '/board/projects/panel/' + this.$root.projectData.project.project_slug + '/contributors'
      });
    }
  }
});
                ...
                _c("div", { staticClass: "col-4 py-0 my-0  d-flex flex-row" }, [
                  _c(
                    ...
                    [
                      ...
                      _c(
                        "v-btn",
                        { attrs: { icon: "" }, on: { click: _vm.openMembers } },
                        [
                          _c(
                            "v-icon",
                            { staticStyle: { "font-size": "25px" } },
