...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    crophandler: function crophandler(event) {
      ...
      this.imageExist = true; // Reference to the DOM input element
    ...
    saveChanges: function saveChanges() {
      ...
      axios.post('/update-profile', formData, {
        ...
        if (response.status == 200) {
          _this2.loading = false; // update profile data

          _this2.$root.profilePageComponent.userData.name = response.data.user.name;
          _this2.$root.profilePageComponent.userData.about = response.data.user.about;
          _this2.$root.profilePageComponent.profileData.image_name = response.data.profile.image_name;
          _this2.$root.profilePageComponent.profileData.image_extension = response.data.profile.image_extension;
          _this2.$root.profilePageComponent.profileData.background_color = response.data.profile.background_color; // update base user data

          _this2.$root.authProfile.name = response.data.user.name;
          _this2.$root.authProfile.about = response.data.user.about;
          _this2.$root.authProfile.image_name = response.data.profile.image_name;
          _this2.$root.authProfile.image_extension = response.data.profile.image_extension;
          _this2.$root.authProfile.background_color = response.data.profile.background_color;
