    ...
    getNotification: function getNotification() {
      ...
      axios.get('/user-notification').then(function (response) {
        if (response.status == 200) {
          _this.notifications = response.data.notifications; // this.loading = false;
        }
                        ...
                        [
                          notification.type == "post_like"
                            ? [
                                ...
                                _c(
                                  ...
                                  [_vm._v(_vm._s(notification.post_data.title))]
                                )
                              ]
                            : _vm._e(),
                          _vm._v(" "),
                          ...
                          notification.type == "space_invitation"
                            ? [
                                _c(
                                  ...
                                  [
                                    _vm._v(
                                      _vm._s(notification.dataArray[0].username)
                                    )
                                  ]
                                ),
                                _vm._v(" "),
                          ...
                          _c(
                            ...
                            [
                              _vm._v(
                                _vm._s(
                                  _vm.checkDatereal(notification.created_at)
                                )
                              )
                            ]
                          )
