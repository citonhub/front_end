      ...
      _c(
        ...
        [
          _c(
            "div",
            {
              staticClass: "created-lists",
              staticStyle: { background: "white" }
            },
            [
              _c(
                "div",
                { staticClass: "top d-flex" },
                [
                  ...
                  _c(
                    ...
                    [
                      _c(
                        "v-icon",
                        { staticClass: "mt-1", attrs: { color: "#fff" } },
                        [_vm._v("las la-plus")]
                      ),
                      _vm._v(" "),
                      _c(
              ...
              _vm._l(_vm.lists, function(list, index) {
                return _c(
                  "div",
                  { key: index, staticClass: "lists d-flex" },
                  [
                    _c(
                      "v-icon",
                    ...
                    _vm._v(" "),
                    _c("span", { staticClass: "ml-2" }, [_vm._v(_vm._s(list))])
                  ],
                  1
                )
              }),
              _vm._v(" "),
              _c("v-btn", { attrs: { color: "#3C87CD" } }, [_vm._v("Done")])
            ],
            2
          ),
          _vm._v(" "),
          _vm.toggleForm
            ? _c(
                "div",
                {
                  staticClass: "playlist-form",
                  staticStyle: { background: "white" }
                },
                [
                  _c("v-text-field", {
                    attrs: { label: "New Playlist", placeholder: "Title" }
                  }),
                  _vm._v(" "),
                  _c(
                    "div",
                    { staticClass: "action-buttons d-flex" },
                    [
