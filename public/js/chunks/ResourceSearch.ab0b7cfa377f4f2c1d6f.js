    ...
    AddItemsToResources: function AddItemsToResources() {
      ...
      axios.post('/add-items-to-resource', {
        ...
        if (response.status == 200) {
          _this.loading = false;
          console.log(_this.$root.selectedResource); //if(this.$root.selectedResource.type== 'playlist'){}

          _this.$root.chatComponent.showAlert('Added!', 'Playlist has been created', 'success');
