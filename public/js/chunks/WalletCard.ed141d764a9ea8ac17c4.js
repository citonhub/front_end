    ...
    _c("div", { staticClass: "col-lg-10 offset-lg-1 py-0 pb-2 px-1 px-md-2" }, [
      _c("div", { staticClass: "col-12 d-flex px-md-2 px-0 flex-row" }, [
        ...
        _c(
          ...
          {
            staticClass:
              "col-md-4 text-center d-flex flex-column px-1  py-md-2 py-0"
          },
          [
            _c(
              "v-card",
                ...
                _c(
                  ...
                  [
                    _c("img", {
                      ...
                      attrs: { height: "50", src: "/imgs/credit-card-chip.png" }
                    })
                  ]
                ),
                _vm._v(" "),
            ...
            _c(
              "div",
              {
                staticClass: "col-12 d-md-none d-flex py-1 px-1",
                staticStyle: {
                  "align-items": "center",
                  "justify-content": "center"
                }
              ...
              [
                _c(
                  "v-card",
                  { staticClass: "bg-primary", attrs: { width: "100%" } },
                  [
                    _c(
                      "div",
                      { staticClass: "d-flex px-2 pb-2 flex-column text-left" },
            ...
            _vm._v(" "),
            _c("div", { staticClass: "col-12 px-0 d-flex flex-row" }, [
              _c(
                "div",
        ...
        _c(
          "div",
          {
            staticClass: "col-md-4 d-md-flex flex-column px-0 d-none",
            staticStyle: {
              "align-items": "center",
              "justify-content": "center"
            }
