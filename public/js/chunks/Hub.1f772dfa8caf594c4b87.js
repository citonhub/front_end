...
/* harmony import */ var vue_virtual_scroller__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! vue-virtual-scroller */ "./node_modules/vue-virtual-scroller/dist/vue-virtual-scroller.esm.js");
/* harmony import */ var vue_virtual_scroller_dist_vue_virtual_scroller_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! vue-virtual-scroller/dist/vue-virtual-scroller.css */ "./node_modules/vue-virtual-scroller/dist/vue-virtual-scroller.css");
/* harmony import */ var vue_virtual_scroller_dist_vue_virtual_scroller_css__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(vue_virtual_scroller_dist_vue_virtual_scroller_css__WEBPACK_IMPORTED_MODULE_4__);
//
//
//
//
...
Vue.component('DynamicScroller', vue_virtual_scroller__WEBPACK_IMPORTED_MODULE_3__["DynamicScroller"]);
Vue.component('DynamicScrollerItem', vue_virtual_scroller__WEBPACK_IMPORTED_MODULE_3__["DynamicScrollerItem"]);
...
var ProjectView = function ProjectView() {
  return Promise.all(/*! import() | ProjectView */[__webpack_require__.e("vendors~ChallengesList~Chats~Hub~ProjectView"), __webpack_require__.e("ProjectView")]).then(__webpack_require__.bind(null, /*! ./ProjectView.vue */ "./resources/js/components/Hub/ProjectView.vue"));
};
  ...
  return _c(
    ...
    [
      ...
      _c(
        ...
        {
          staticClass:
            "col-lg-10 offset-lg-1 d-none d-md-block col-12 px-0 d-md-block d-none",
          staticStyle: {
            background: "#F5F5FB",
            position: "absolute",
            height: "92%",
      ...
      _c("DynamicScroller", {
        ...
        staticClass:
          " col-lg-10 offset-lg-1 col-12 py-0 pt-md-5 mt-md-3 px-md-2 px-1 d-flex flew-row scroller  px-0",
        staticStyle: {
          position: "absolute",
          height: "92%",
          top: "8%",
        ...
        scopedSlots: _vm._u([
          ...
          },
          {
            key: "after",
            fn: function() {
              return [_c("div", { staticClass: "my-4 py-3 col-12" })]
            },
            proxy: true
          }
        ])
      ...
      _c(
        ...
        [
          _c(
            ...
            {
              staticClass:
                "col-lg-10 offset-lg-1 col-12 py-0 pt-md-5 mt-md-3 px-md-2 px-1 d-flex flex-column",
              staticStyle: { position: "absolute", height: "100%", left: "0%" }
            },
            [
                          ...
                          _vm.loadingSearchPost
                            ...
                            : [
                                _c("DynamicScroller", {
                                  ...
                                  attrs: {
                                    items: _vm.that.$root.postsSearch,
                                    keyField: "id",
                                    "min-item-size": 36,
                                    buffer: 5000,
                                    id: "ScrollerPost"
