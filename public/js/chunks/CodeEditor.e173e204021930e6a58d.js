...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    loadPage: function loadPage() {
      this.$router.push({
        path: '/' + this.$route.params.projectSlug + '/page-loader/user'
      });
    },
    fetchProject: function fetchProject() {
      ...
      if (this.$root.projectData.length != 0) {} else {
        axios.get('/fetch-project-' + this.$route.params.projectSlug).then(function (response) {
          if (response.status == 200) {
    ...
    showCode: function showCode(codeBox) {
      ...
      if (this.$root.SelectedCodeBox.type == 'front_end') {
        ...
        var codeData = this.$root.frontEndFiles.filter(function (file) {
      ...
      if (this.$root.SelectedCodeBox.type == 'back-end') {
        ...
        var _codeData = this.$root.backEndFiles.filter(function (file) {
          return file.id == _this5.$root.selectedFileId;
        });
      ...
      if (this.$root.SelectedCodeBox.type == 'code_files' || this.$root.SelectedCodeBox.type == 'code_file') {
        ...
        var _codeData2 = this.$root.codeFiles.filter(function (file) {
          return file.id == _this5.$root.selectedFileId;
        });
      ...
      axios.post('/save-code-content-project', {
        ...
        if (response.status == 200) {
          ...
          if (_this6.$root.SelectedCodeBox.file_name == 'extensions') {
            var indexFile = _this6.$root.frontEndFiles.filter(function (codeFile) {
    ...
    onCmCodeChange: function onCmCodeChange(code) {
      ...
      this.$root.frontEndFiles.map(function (file) {
        if (file.id == _this7.$root.selectedFileId) {
          file.content = code;
        }
      });
      this.$root.backEndFiles.map(function (file) {
        if (file.id == _this7.$root.selectedFileId) {
          file.content = code;
        }
      });
      this.$root.CodeFilesData[0].map(function (file) {
        if (file.id == _this7.$root.selectedFileId) {
          file.content = code;
        }
      });
...
var render = function() {
  ...
  return _c("div", { staticClass: "row py-0 my0" }, [
    _c(
      "div",
      {
        staticClass: "col-12 my-0 d-md-block py-1  pt-3 d-none scroller ",
        staticStyle: {
          position: "absolute",
          "overflow-x": "auto",
          "white-space": "nowrap",
      ...
      [
        _c(
          "v-chip",
          { attrs: { close: "", small: "", outlined: "", color: "#3C87CD" } },
          [_vm._v("index.html ")]
        )
      ],
      1
    ...
    _c(
      "div",
      {
        staticClass: "col-12 px-0 py-0 mt-2 mt-md-0",
        staticStyle: {
          position: "absolute",
          height: "100%",
          top: "0%",
