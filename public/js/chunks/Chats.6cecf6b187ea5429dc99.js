      ...
      this.$root.subSpaces.map(function (space) {
        ...
        unreadStoredMsg.then(function (result) {
          if (result != null) {
            var finalResultUnread = JSON.parse(result);
            space.unread = finalResultUnread.length;
            _this20.$root.selectedSpace.subspace_messages += space.unread;
          } else {
            space.unread = 0;
          }

          console.log(_this20.$root.selectedSpace.subspace_messages);
        });
      });
    },
        ...
        if (response.status == 200) {
          ...
          storedMsg.then(function (result) {
            if (result != null) {
              ...
              _this23.$root.selectedSpace.subspace_messages = 0;

              _this23.handleUnreadUpdate();
