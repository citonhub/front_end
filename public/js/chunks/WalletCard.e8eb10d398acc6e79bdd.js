...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    showReferral: function showReferral() {
    ...
    fetchTransactions: function fetchTransactions(pageNum) {
      ...
      axios.get('/fetch-transactions/' + this.$route.params.card_no + '?page=' + pageNum).then(function (response) {
        if (response.status == 200) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    fetchPaymentCard: function fetchPaymentCard() {
      ...
      this.loadingPaymentCard = true;
      var storedPaymentCard = this.$root.getLocalStore('user_payment_card_new_' + this.$root.username);
      storedPaymentCard.then(function (result) {
        if (result != null) {
          var finalResult = JSON.parse(result);
          var returnedCard = finalResult.payment_cards;
          returnedCard.sort(function (a, b) {
            return b.balance - a.balance;
          });
          _this.paymentCards = finalResult.personal_card.concat(returnedCard);
          setTimeout(function () {
          ...
          axios.get('/payment-cards').then(function (response) {
            if (response.status == 200) {
              _this.$root.LocalStore('user_payment_card_new_' + _this.$root.username, response.data);

              var _finalResult = response.data;
              var _returnedCard = _finalResult.payment_cards;

              _returnedCard.sort(function (a, b) {
                return b.balance - a.balance;
              });

              _this.paymentCards = _finalResult.personal_card.concat(_returnedCard);
              _this.loadingPaymentCard = false;
              setTimeout(function () {
                if (_this.paymentCards.length > 3) {
                  _this.$refs.horizontal.hasNext = true;
    ...
    checkForNewPaymentCard: function checkForNewPaymentCard() {
      ...
      axios.get('/payment-cards').then(function (response) {
        if (response.status == 200) {
          _this2.$root.LocalStore('user_payment_card_new_' + _this2.$root.username, response.data);
          ...
          _this2.paymentCards = finalResult.personal_card.concat(returnedCard);
    ...
    _c(
      ...
      [
        _c("div", { staticClass: "col-12 d-flex px-md-2 px-0 flex-row" }, [
          ...
          _c(
            "div",
            { staticClass: "col-lg-4  px-1  py-md-2 py-0 text-center" },
            [
              _c(
                "v-card",
                {
              ...
              _c(
                ...
                [
                  _vm.that.$root.selectedPaymentCard.type != "personal"
                    ? [
                        _c(
                          "div",
                  ...
                  _vm.transactions.length == 0
                    ? [
                        _c(
                          ...
                          [
                            _c("div", { staticClass: "mb-1  px-3" }, [
                              _vm._v(
                                "\n                  You have no transaction yet. Invite your friends to mentor on CitonHub and get 5% commission on their first 10 earnings. \n                       "
                              )
                            ]),
                            _vm._v(" "),
                            _c(
                      ...
                      [
                        _c(
                          ...
                          [
                            ...
                            _vm._v(" "),
                            _c("div", { staticClass: "ml-auto pt-1 pr-2" }, [
                              _c(
                                "span",
                                {
                                  staticStyle: {
                                    ...
                                    _vm._v(
                                      " " +
                                        _vm._s(
                                          _vm.formatMoney(
                                            paymentCard.balance -
                                              (paymentCard.platform_fee +
                                                paymentCard.payment_processing_fee)
                                          )
                                        )
                                    )
                                  ]
