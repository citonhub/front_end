...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    setShareLink: function setShareLink(space_id) {
      this.$root.shareText = 'Join ' + this.$root.selectedSpace.name + ' on Citonhub';
      this.$root.shareLink = 'https://www.citonhub.com/link/channel/' + space_id;
      console.log(this.$root.shareLink);
    },
