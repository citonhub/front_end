...
var ProjectView = function ProjectView() {
  return Promise.all(/*! import() | ProjectView */[__webpack_require__.e("vendors~ChallengesList~Chats~ProjectView"), __webpack_require__.e("vendors~Board~Hub~ProjectView"), __webpack_require__.e("ProjectView")]).then(__webpack_require__.bind(null, /*! ../Hub/ProjectView.vue */ "./resources/js/components/Hub/ProjectView.vue"));
};
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    channelStyle: function channelStyle(dimension, data) {
    ...
    followUser: function followUser() {
      ...
      if (this.$root.checkauthroot == 'auth') {
        ...
        axios.get('/connect-user-' + this.userData.username).then(function (response) {
          if (response.status == 200) {
            _this.loadingFollowing = false;
            _this.profileData.following_user = true;
            _this.profileData.followers += 1;
          }
    ...
    handleSelectedTab: function handleSelectedTab(tabname) {
      if (tabname == 'projects') {
    ...
    getUserChannel: function getUserChannel(tabname) {
      var _this2 = this;

      this.$root.routeIsLoading = true;
      axios.get('/fetch-user-channels/' + this.userData.username).then(function (response) {
        if (response.status == 200) {
          _this2.userChannel = response.data.channels;
          _this2.selectedTab = tabname;
          _this2.$root.routeIsLoading = false;
        }
      })["catch"](function (error) {
        _this2.showAlert('Oops!', 'Unable to fetch user channels', 'error');
      });
    },
    viewChannel: function viewChannel(channel) {
    ...
    getUserDiaries: function getUserDiaries(tabname) {
      var _this3 = this;

      this.$root.routeIsLoading = true;
      axios.get('/fetch-user-diaries/' + this.userData.username).then(function (response) {
        if (response.status == 200) {
          _this3.userDiaries = response.data.diaries;
          _this3.selectedTab = tabname;
          _this3.$root.routeIsLoading = false;
        }
      })["catch"](function (error) {
        _this3.showAlert('Oops!', 'Unable to fetch user diaries', 'error');
      });
    },
    imageStyleDiary: function imageStyleDiary(size, data) {
      if (data.background_color == null) {
        ...
        var _styleString2 = "height:" + size + "px;width:" + size + "px;background-size:cover;border-radius:3px;background-repeat: no-repeat; border:1px solid #c5c5c5;";
    ...
    getUserProjects: function getUserProjects(tabname) {
      var _this4 = this;

      this.loadingUserProjects = true;
      axios.get('/fetch-user-posts/' + this.userData.username).then(function (response) {
        if (response.status == 200) {
          _this4.userProjects = response.data.data;
          _this4.selectedTab = tabname;
          _this4.loadingUserProjects = false;
        }
      })["catch"](function (error) {
        _this4.showAlert('Oops!', 'Unable to fetch user projects', 'error');
      });
    },
    ...
    chatUser: function chatUser() {
      ...
      axios.post('/create-space', {
        ...
        if (response.status == 200) {
          var storedChat = _this5.$root.getLocalStore('user_chat_list_new_' + _this5.$root.username);
          ...
          storedChat.then(function (result) {
            if (result != null) {
              ...
              if (userSpace.length > 0) {} else {
                ...
                _this5.$root.LocalStore('user_chat_list_new_' + _this5.$root.username, finalResult);
              ...
              if (_this5.fromModal) {
                _this5.$root.chatComponent.openChat(response.data.space.space_id, true);
              } else {
                _this5.$root.autoOpenChat = true;
                _this5.$root.autoOpenChatId = response.data.space.space_id;
    ...
    fetchProfileContent: function fetchProfileContent() {
      ...
      axios.get('/fetch-profile-' + this.mainUserName).then(function (response) {
        if (response.status == 200) {
          _this6.userData = response.data.user_data;
          _this6.profileData = response.data.profile;
          _this6.xp = _this6.profileData.points;

          _this6.calculateLevel();

          if (_this6.mainUserName == _this6.$root.username) {
            // this should be true
            _this6.owner = true;

            _this6.$root.initialPushMangerReg();
          } else if (_this6.mainUserName = !_this6.$root.username) {
            _this6.owner = false;
          }

          _this6.loadingProfile = false;

          _this6.getUserProjects('projects');
        }
      })["catch"](function (error) {
        _this6.showAlert('Oops!', 'Something went wrong', 'error');
      });
    },
    calculateLevel: function calculateLevel() {
      ...
      } else if (this.xp >= 100 && this.xp <= 299) {
        this.level = 'Bronze';
      ...
      } else if (this.xp >= 600 && this.xp <= 999) {
        this.level = 'Gold';
      ...
      } else if (this.xp >= 1000 && this.xp <= 1499) {
        this.level = 'Platinum';
      ...
      } else if (this.xp >= 1500 && this.xp <= 9999) {
        this.level = 'Platinum';
        this.nextLevel = 'Diamond';
    ...
    imageStyleUser: function imageStyleUser(dimension, data) {
      if (data.background_color == null) {
        ...
        var _styleString3 = "border-radius:50%;height:" + dimension + "px;width:" + dimension + "px;background-size:contain;border:5px solid #3C87CD;cursor:pointer; ";

        var imgLink = data.image_name + '.' + data.image_extension;
        _styleString3 += 'background-color:' + data.background_color + '; background-image:url(/imgs/profile/' + imgLink + ');';
        return _styleString3;
      }
    }
  }
});
                ...
                _c(
                  ...
                  [
                    _c(
                      "div",
                      {
                        staticClass: "col-md-6 col-lg-3 pt-2 px-0",
                ...
                _c(
                  ...
                  [
                    _c(
                      ...
                      {
                        staticClass:
                          "col-lg-3 col-md-6 offset-lg-9 offset-md-6 pt-0 pb-3   px-0 ",
                        staticStyle: {
                          height: "100%",
                          top: "0%",
                          position: "absolute",
                      ...
                      [
                        _c(
                          ...
                          {
                            staticClass:
                              "col-12 px-md-1 px-0 py-2 pt-0 fixed-top d-flex flex-row",
                            staticStyle: {
                              left: "0",
                              position: "sticky",
                              background: "white",
                ...
                [
                  ...
                  !_vm.loadingProfile
                    ? [
                            ...
                            _vm.owner
                              ...
                              : [
                                  ...
                                  _c(
                                    ...
                                    [
                                      _vm.profileData.following_user
                                        ? [
                                            _c(
                                              "v-btn",
                                              {
                        ...
                        _c(
                          "div",
                          { staticClass: "col-12 px-1 mt-2" },
                          [
                            _vm.profileData.is_mentor
                              ? [
                                  _c(
                                    "div",
                                    {
                                      staticClass:
                                        "col-12 px-0 d-flex flex-row py-0 mt-2",
                                      staticStyle: {
                                        "align-items": "center",
                                        "border-bottom": "1px solid #c5c5c5",
                                        "overflow-x": "auto",
                                                        ...
                                                        _c(
                                                          ...
                                                          [
                                                            ...
                                                            _c(
                                                              ...
                                                              {
                                                                staticClass:
                                                                  "col-12 py-0 mt-3 px-1 text-center"
                                                              },
                                                              [
                                                                _c(
                                                                  "v-btn",
                                                    ...
                                                    [
                                                      ...
                                                      _vm.that.$root.username
                                                        ...
                                                        : _c(
                                                            ...
                                                            [
                                                              _vm._v(
                                                                "You have no channel yet. Channel is where you mentor and earn from donation, subscriptions and paid sessions"
                                                              )
                                                            ]
                                                          )
                                                    ]
                                                  ...
                                                  function(diary) {
                                                    return _c(
                                                      "div",
                                                      {
                                                        key: diary.id + "diary",
                                                        staticClass:
                                                          "col-lg-4 col-md-6 px-2 mb-1 py-2 pt-0 mt-md-2"
                                                      },
                                                      [
                                                        _c(
                                                          "v-card",
                                                    ...
                                                    [
                                                      ...
                                                      _vm.that.$root.username
                                                        ...
                                                        : _c(
                                                            ...
                                                            [
                                                              _vm._v(
                                                                "You have no diary yet. Diary is where you share what you know in the way you want."
                                                              )
                                                            ]
                                                          )
                                                    ]
                                                    ...
                                                    [
                                                      ...
                                                      _vm.that.$root.username
                                                        ...
                                                        : _c(
                                                            ...
                                                            [
                                                              _vm._v(
                                                                "You have no project yet. Share your projects and get more experience points (XP)"
                                                              )
                                                            ]
                                                          )
                                                    ]
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c(
                        "div",
                        {
                          staticClass: "col-12 py-0 my-0 px-0 d-flex ",
                          staticStyle: {
                            position: "absolute",
                            height: "100%",
                            left: "0%",
