    ...
    [
      ...
      this.$root.TopBarComponentBoard
        ? _c(
            ...
            {
              staticClass:
                "col-lg-10 offset-lg-1 col-md-10 offset-md-1 px-2  pb-1 pt-0   "
            },
            [
                    ...
                    !_vm.loadingSearchChallenges
                      ? [
                          ...
                          _c(
                            "div",
                            { staticClass: "row" },
                            _vm._l(this.$root.challengeSearchList, function(
                              challenge,
                              index
                            ) {
                              return _c("challenge", {
                                key: "search" + index,
                                attrs: { source: challenge }
                              })
                            }),
                            1
                          ),
                          _vm._v(" "),
                          _c("div", { staticClass: "col-12 my-5 mt-md-0 " })
                        ]
                      : [
                          _c("div", {
                            staticClass: "col-12 mt-5 mt-md-0 d-md-none d-block"
                    ...
                    !_vm.loadingChallenges
                      ? [
                          ...
                          _c(
                            "div",
                            { staticClass: "row" },
                            _vm._l(this.$root.challengesList, function(
                              challenge,
                              index
                            ) {
                              return _c("challenge", {
