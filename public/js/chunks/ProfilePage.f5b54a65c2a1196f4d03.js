...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    ...
    return _ref = {
      ...
      owner: false
    }, _defineProperty(_ref, "profileData", []), _defineProperty(_ref, "loadingProfile", false), _ref;
  },
  methods: {
    showFullImage: function showFullImage(data) {
      if (data.image_name) {
        this.$root.baseImageLink = data.image_name + '.' + data.image_extension;
    ...
    imageStyleUser: function imageStyleUser(dimension, data) {
      if (data.background_color == null) {
        var styleString = "border-radius:50%;height:" + dimension + "px;width:" + dimension + "px;background-size:contain;border:5px solid #3C87CD;";
        styleString += 'background-color:#ffffff; border:5px solid #3C87CD;';
        return styleString;
      } else {
        var _styleString = "border-radius:50%;height:" + dimension + "px;width:" + dimension + "px;background-size:contain;border:5px solid #3C87CD; ";
                      ...
                      _c(
                        ...
                        [
                          ...
                          _c(
                            ...
                            {
                              staticClass:
                                "col-12 py-0 my-0 px-0 d-flex scroller",
                              staticStyle: {
                                position: "absolute",
                                "b height": "100%",
                                width: "100%",
