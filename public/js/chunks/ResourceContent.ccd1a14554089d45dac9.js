...
var Resource = function Resource() {
  return Promise.all(/*! import() | Resource */[__webpack_require__.e("vendors~Board~Hub~LiveSession~ProjectView~Resource"), __webpack_require__.e("vendors~Resource~ResourceUrl"), __webpack_require__.e("Resource")]).then(__webpack_require__.bind(null, /*! ./Resource.vue */ "./resources/js/components/chats/Resource.vue"));
};
      ...
      _c(
        ...
        [
          ...
          _c(
            "div",
            {
              staticClass: "col-8 pt-1 pb-0 text-center",
              staticStyle: {
                "white-space": "nowrap",
                overflow: "hidden",
                      ...
                      _vm.that.$root.selectedResource.type == "playlist"
                        ? [
                            _c(
                              ...
                              [_vm._v("No video in this playlist yet.")]
                            ),
                            _vm._v(" "),
                            _vm.checkIfisOwner() &&
                        ...
                        : [
                            ...
                            _vm._v(" "),
                            _vm.checkIfisOwner() &&
                            _vm.that.$root.selectedResource.devto_username ==
                              null
                              ? _c(
                                  "div",
                                  {
                                    staticClass:
                                      "col-12 py-1 text-center d-flex flex-row mt-2 flex-wrap"
                                  },
                                  [
                                    _c(
                                      "div",
