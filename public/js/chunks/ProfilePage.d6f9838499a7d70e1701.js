...
var ProjectView = function ProjectView() {
  return Promise.all(/*! import() | ProjectView */[__webpack_require__.e("vendors~ChallengesList~Chats~Hub~ProjectView"), __webpack_require__.e("ProjectView")]).then(__webpack_require__.bind(null, /*! ../Hub/ProjectView.vue */ "./resources/js/components/Hub/ProjectView.vue"));
};
  ...
  methods: {
    ...
    chatUser: function chatUser() {
      ...
      axios.post('/create-space', {
        ...
        _this3.showAlert('Oops!', 'Unable to fetch user projects', 'error');
      });
    },
