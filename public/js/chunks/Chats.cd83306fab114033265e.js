      ...
      if (this.$root.checkauthroot == 'auth') {
        ...
        storedMsg.then(function (result) {
          if (result != null) {
            ...
            _this11.$root.selectedSpace = []; // generate unread msg and the mark as read

            _this11.generateUnreadMessage();
            ...
            _this11.$root.selectedSpaceMembers = finalResult.members; // set default admin user
