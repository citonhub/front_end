...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    handleInput: function handleInput(pageNum) {
      ...
      axios.get('/referral-info' + '?page=' + pageNum).then(function (response) {
        if (response.status == 200) {
          _this.referralData = response.data.referrals.data;
          _this.currentpage = response.data.referrals.current_page;
          _this.lastPage = response.data.referrals.last_page;
    ...
    fetchReferralInfo: function fetchReferralInfo() {
      var _this2 = this;

      this.loading = true;
      var storedReferral = this.$root.getLocalStore('user_referral_info' + this.$root.username);
      storedReferral.then(function (result) {
        if (result != null) {
          var finalResult = JSON.parse(result);
          _this2.referralData = finalResult.referrals.data;
          _this2.currentpage = finalResult.referrals.data.current_page;
          _this2.lastpage = finalResult.referrals.data.last_page;
          _this2.totalReferral = finalResult.total_referrals;
          _this2.totalEarned = finalResult.amount_earned;
          _this2.loading = false;

          _this2.checkForReferral();
        } else {
          axios.get('/referral-info').then(function (response) {
            if (response.status == 200) {
              _this2.$root.LocalStore('user_referral_info' + _this2.$root.username, response.data);

              var _finalResult = response.data;
              _this2.referralData = _finalResult.referrals.data;
              _this2.currentpage = _finalResult.referrals.data.current_page;
              _this2.lastpage = _finalResult.referrals.data.last_page;
              _this2.totalReferral = _finalResult.total_referrals;
              _this2.totalEarned = _finalResult.amount_earned;
              _this2.loading = false;
            }
          })["catch"](function (error) {
            _this2.$root.cardViewComponent.showAlert('Oops!', 'Something went wrong', 'error');
    ...
    checkForReferral: function checkForReferral() {
      var _this3 = this;

      axios.get('/referral-info').then(function (response) {
        if (response.status == 200) {
          _this3.$root.LocalStore('user_referral_info' + _this3.$root.username, response.data);

          var finalResult = response.data;
          _this3.referralData = finalResult.referrals.data;
          _this3.currentpage = finalResult.referrals.data.current_page;
          _this3.lastpage = finalResult.referrals.data.last_page;
          _this3.totalReferral = finalResult.total_referrals;
          _this3.totalEarned = finalResult.amount_earned;
        }
      })["catch"](function (error) {
        _this3.$root.cardViewComponent.showAlert('Oops!', 'Something went wrong', 'error');
          ...
          _vm.loading
            ...
            : [
                _c(
                  ...
                  [
                    ...
                    _c(
                      ...
                      [_vm._v(_vm._s(_vm.totalReferral))]
                    )
                  ]
                ),
                _vm._v(" "),
                _c(
                  "div",
                  {
                    staticClass: "col-12 d-flex pb-1 flex-column",
                    staticStyle: {
                      "align-items": "center",
                      "justify-content": "center"
                    }
                  ...
                  [
                    ...
                    _c(
                      ...
                      [
                        ...
                        _vm._v(_vm._s(_vm.formatMoney(_vm.totalEarned)))
                      ]
                    )
                  ]
                ),
                ...
                _c(
                  "div",
                  {
                    staticClass: "d-flex flex-row py-0 px-1 col-12",
                  ...
                  [
                    ...
                    _c(
                      "v-btn",
                      { attrs: { icon: "" }, on: { click: _vm.copyMessage } },
