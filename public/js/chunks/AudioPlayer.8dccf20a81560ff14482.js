...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    playbackListener: function playbackListener(e) {
      ...
      this.playbackTime = audio.currentTime / audio.duration * 100;
      console.log(this.playbackTime); //console.log("update: " + audio.currentTime);
        ...
        _c(
          ...
          [
            _c("v-progress-linear", {
              attrs: { rounded: "", height: "7", color: _vm.colorBase },
              on: { change: _vm.seek },
              model: {
