          ...
          [
            _c("div", { staticClass: "row" }, [
              _c(
                ...
                {
                  staticClass:
                    "col-lg-7 col-md-8  px-0 px-md-2  d-flex flex-row"
                },
                [
                  _c("div", {
                    staticStyle: {
          ...
          [
            _c("div", { staticClass: "row" }, [
              _c(
                "div",
                {
                  staticClass: "col-lg-7 col-md-8 px-0 px-md-2  d-flex flex-row"
                },
                [
                  _c("div", {
                    staticStyle: {
    ...
    _vm.source.type == "code" && _vm.checkOwner(_vm.source.user_id) == false
      ? _c("div", { staticClass: "col-10 py-0 " }, [
          _c("div", { staticClass: "row" }, [
            _c(
              "div",
              { staticClass: "col-lg-5 col-md-6 px-0 px-md-2 d-flex flex-row" },
              [
                _c("div", {
                  staticStyle: {
                    "border-radius": "50%",
    ...
    _vm.source.type == "audio" && _vm.checkOwner(_vm.source.user_id) == false
      ? _c("div", { staticClass: "col-10 py-0 " }, [
          _c("div", { staticClass: "row" }, [
            _c(
              "div",
              { staticClass: "col-lg-6 col-md-6 px-0 px-md-2 d-flex flex-row" },
              [
                _c("div", {
                  staticStyle: {
                    "border-radius": "50%",
      ...
      ? _c("div", { staticClass: "col-10 py-0 " }, [
          _c("div", { staticClass: "row" }, [
            _c(
              "div",
              {
                staticClass: "col-lg-6 px-0 px-md-2 col-md-6  d-flex flex-row"
              },
              [
                _c("div", {
                  staticStyle: {
