    ...
    _c("div", { staticClass: "col-12 py-1 my-0 " }, [
      _c("div", { staticClass: "row" }, [
        ...
        _c(
          ...
          [
            _c("div", { staticClass: "col-lg-12  py-2 pt-0 my-0 px-1 mt-3" }, [
              _vm._m(1),
              _vm._v(" "),
                              ...
                              _c("div", [
                                _c(
                                  "span",
                                  {
                                    style:
                                      _vm.that.$root.payment_option == "support"
                                        ? "font-size:13px; font-family:BodyFont;color:white;"
                                        : "font-size:13px; font-family:BodyFont;"
                                  },
                                  [_vm._v("Donation")]
                                )
                              ])
                  ...
                  [
                    _c(
                      "v-card",
                      {
                        ...
                        on: {
                          click: function($event) {
                            return _vm.selectPaymentOption("membership")
                          }
                        }
                      },
                      [
          ...
          [
            _c(
              "v-btn",
              {
                ...
                attrs: {
                  type: "submit",
                  disabled: _vm.that.$root.payment_option == "",
                  small: "",
                  color: "#3C87CD",
                  loading: _vm.loading
                },
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticStyle: { "font-size": "14px" } }, [
      _vm._v("Select how you will like to earn. "),
      _c(
        "a",
        {
          attrs: {
            href:
              "https://blog.citonhub.com/how-developers-make-money-on-citonhub",
            target: "_blank"
          }
        },
        [_vm._v("Read more...")]
      ...
      _c("br"),
      _vm._v(" "),
      _c("span", { staticStyle: { color: "grey", "font-size": "13px" } }, [
        _vm._v("We only earn when you earn.")
      ])
    ])
  }
]
