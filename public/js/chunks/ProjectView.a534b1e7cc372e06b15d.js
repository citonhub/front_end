...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "row px-0", staticStyle: { background: "whitesmoke" } },
    [
      _c(
        "div",
        {
      ...
      _c("div", { staticClass: "px-2 col-12 py-0" }, [
        _c(
          "div",
          { staticClass: "col-lg-6 offset-lg-3 py-2 px-0 mt-1 text-center" },
          [
            _c(
              "span",
              {
        ...
        _c(
          "div",
          {
            staticClass: "col-lg-6 offset-lg-3 py-2 px-0 pt-1 ",
        ...
        _c("div", { staticClass: "col-lg-6 offset-lg-3 px-2 mt-2 " }, [
          _c("div", { staticClass: "row" }, [
            _c(
              "div",
              { staticClass: "col-6 px-0 py-1 text-left" },
              [
                _c(
                  "v-btn",
        ...
        _vm._v(" "),
        _c("div", { staticClass: "col-lg-6 offset-lg-3 px-1 mt-1 text-left" }, [
          _c(
            "div",
      ...
      _c(
        "div",
        {
          ...
          staticStyle: {
            ...
            background: "#ffffff",
            "background-image": "url(/imgs/chat_background.png)",
      ...
      _c(
        "div",
        {
          staticClass: "col-lg-6 offset-lg-3 px-2 py-1 pb-1",
        ...
        [
          _c("div", { staticClass: "row px-md-3 py-0" }, [
            _c(
              "div",
              {
                staticClass: "col-12  py-0 my-0 d-flex px-md-2 px-2 flex-row",
                staticStyle: {
                  "align-items": "center",
                  "justify-content": "center"
                }
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "col-lg-6 offset-lg-3 px-1 mt-1 " }, [
      _c(
        "div",
        { staticStyle: { "font-size": "15px", "font-family": "MediumFont" } },
        [_vm._v("Comments")]
      )
    ])
  },
