  ...
  methods: {
    ...
    fetchPaymentCard: function fetchPaymentCard() {
      ...
      storedPaymentCard.then(function (result) {
        if (result != null) {
          var _finalResult = JSON.parse(result);

          _this.$root.selectedPaymentCard = _finalResult.payment_card;
          ...
          axios.get('/payment-cards/' + _this.$route.params.card_no).then(function (response) {
            if (response.status == 200) {
              _this.$root.LocalStore('user_payment_card_' + _this.$route.params.card_no + _this.$root.username);
    ...
    checkForNewPaymentCard: function checkForNewPaymentCard() {
      ...
      axios.get('/payment-cards/' + this.$route.params.card_no).then(function (response) {
        if (response.status == 200) {
          _this2.$root.LocalStore('user_payment_card_' + _this2.$route.params.card_no + _this2.$root.username);

          _this2.$root.selectedPaymentCard = finalResult.payment_card;
          _this2.loadingPaymentCard = false;

          _this2.fetchTransactions();
        }
      })["catch"](function (error) {});
    },
    fetchTransactions: function fetchTransactions() {
      ...
      axios.get('/fetch-transactions/' + this.$route.params.card_no).then(function (response) {
        if (response.status == 200) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    fetchTransactions: function fetchTransactions() {
      ...
      axios.get('/fetch-transactions').then(function (response) {
        if (response.status == 200) {
          _this3.transactions = response.data.transactions.data;
        }
      })["catch"](function (error) {});
  ...
  return _c("div", { staticStyle: { "overflow-x": "hidden" } }, [
        ...
        _c("div", { staticClass: "row" }, [
          _c(
            ...
            [
              ...
              _vm._v(" "),
              this.$root.selectedPaymentCard.length > 0
                ? _c("h5", [
                    _vm._v(_vm._s(this.$root.selectedPaymentCard.name))
                  ])
                : _vm._e()
            ],
            1
    ...
    _c(
      ...
      [
                  ...
                  _c(
                    ...
                    [
                      _c(
                        ...
                        {
                          staticStyle: { width: "90%" },
                          attrs: { color: "#3C87CD", outlined: "", small: "" }
                        },
                        [
                          _c(
                            "span",
        ...
        _vm._v(" "),
        _c("div", { staticClass: "col-12 px-0 px-md-1 pt-md-5 pt-0" }, [
          _c("h6", [_vm._v("Transactions")]),
          _vm._v(" "),
          _c("div", { staticClass: "col-12 px-0 d-flex py-0 flex-column" }, [
            _c(
              "div",
              {
            ...
            _c(
              "div",
              {
                ...
                staticStyle: { background: "rgba(60, 135, 205, 0.4)" },
                attrs: { "data-app": "true" }
              },
              [
                _c("v-pagination", {
                  attrs: { length: 4, circle: "", color: "#3C87CD" },
                  model: {
                    value: _vm.page,
                    callback: function($$v) {
                      _vm.page = $$v
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "normalText" }, [
      _c("span", { staticClass: "normalText" }, [_vm._v("Received ")]),
      _c("span", { staticClass: "boldText" }, [_vm._v("₦3000")]),
      _vm._v(" donation from "),
      _c("span", { staticClass: "boldText" }, [_vm._v("David King")]),
      _vm._v(" to "),
      _c("span", { staticClass: "boldText" }, [_vm._v("DSC Landmark")]),
      _vm._v("\n                         | Aug 12, 2021\n                     ")
    ])
  },
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "ml-auto pl-2" }, [
      _c("span", { staticClass: "boldText text-success" }, [_vm._v("Donation")])
    ])
  },
  function() {
    var _vm = this
    ...
    return _c("div", { staticClass: "normalText" }, [
      _c("span", { staticClass: "normalText" }, [_vm._v("Received ")]),
      _c("span", { staticClass: "boldText" }, [_vm._v("₦4000")]),
      _vm._v(" payment from "),
      _c("span", { staticClass: "boldText" }, [_vm._v("Ngozi")]),
      _vm._v(" to "),
      _c("span", { staticClass: "boldText" }, [_vm._v("DSC Landmark")]),
      _vm._v("\n                         | Aug 12, 2021\n                     ")
    ])
  ...
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "ml-auto pl-2" }, [
      _c("span", { staticClass: "boldText text-success" }, [_vm._v("Payment")])
    ])
  },
  function() {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "normalText" }, [
      _c("span", { staticClass: "normalText" }, [_vm._v("Paid out ")]),
      _c("span", { staticClass: "boldText" }, [_vm._v("₦4000")]),
      _vm._v(" from "),
      _c("span", { staticClass: "boldText" }, [_vm._v("DSC Landmark")]),
      _vm._v(" to "),
      _c("span", { staticClass: "boldText" }, [_vm._v("Pelumi")]),
      _vm._v("\n                         | Aug 12, 2021\n                     ")
    ])
  },
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "ml-auto pl-2" }, [
      _c("span", { staticClass: "boldText text-danger" }, [_vm._v("Payout")])
    ])
  },
  function() {
    var _vm = this
  ...
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "normalText" }, [
      _c("span", { staticClass: "normalText" }, [_vm._v("Withdrawn ")]),
      _c("span", { staticClass: "boldText" }, [_vm._v("₦10,000")]),
      _vm._v(" from "),
      _c("span", { staticClass: "boldText" }, [_vm._v("DSC Landmark")]),
      _vm._v("\n                         | Aug 12, 2021\n                     ")
    ])
  ...
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "ml-auto pl-2" }, [
      _c("span", { staticClass: "boldText text-primary" }, [
        _vm._v("Withdrawal")
      ])
    ])
  },
...
var render = function() {
  ...
  return _c("div", [
    _vm._m(0),
    _vm._v(" "),
    _c("div", { staticClass: "col-lg-10 offset-lg-1 py-0 pb-2 px-1 px-md-2" }, [
      ...
      _vm._v(" "),
      _c("div", { staticClass: "col-12 px-0 px-md-1 pt-md-5 pt-3" }, [
        _vm._m(1),
        _vm._v(" "),
        _c(
          "div",
                  ...
                  _c(
                    ...
                    [
                      transaction.type == "support"
                        ? [
                            _c("span", { staticClass: "normalText" }, [
                              _vm._v("Received ")
                            ]),
                            _c("span", { staticClass: "boldText" }, [
                              ...
                              _vm._v(
                                " " +
                                  _vm._s(_vm.formatMoney(transaction.amount))
                              )
                            ]),
                            _vm._v(" support from "),
                            _c("span", { staticClass: "boldText" }, [
                              _vm._v(_vm._s(transaction.customer_name))
                            ]),
                            _vm._v(" to "),
                            _c("span", { staticClass: "boldText" }, [
                              _vm._v(_vm._s(transaction.card_name))
                            ])
                          ]
                        : _vm._e(),
                      _vm._v(
                        "\n                         | " +
                          _vm._s(_vm.handleDateFormat(transaction.created_at)) +
                          "\n                     "
                      )
                    ],
                    2
                      ...
                      transaction.type == "payout"
                        ? [
                            _c(
                              "span",
                              {
                                staticClass: "boldText text-danger",
                      ...
                      transaction.type == "withdrawal"
                        ? [
                            _c(
                              "span",
                              {
                                staticClass: "boldText text-primary",
                                staticStyle: { "text-transform": "capitalize" }
                              },
                              [_vm._v(_vm._s(transaction.type))]
                            )
                      ...
                      transaction.type != "withdrawal"
                        ? [
                            _c(
                              "span",
                              {
                                staticClass: "boldText text-success",
                                staticStyle: { "text-transform": "capitalize" }
                              },
                              [_vm._v(_vm._s(transaction.type))]
                            )
