...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: (_methods = {
    ...
    var storedPlaylist = this.$root.getLocalStore('channel_resource_' + this.$root.selectedSpace.space_id + this.$root.username);
    ...
    axios.post('/create-resource', {
      ...
      if (response.status == 200) {
        _this4.resourceName = '', _this4.resources.push(response.data);
        _this4.saving = false;
      }
    })["catch"](function (err) {
      comsole.log(err);
