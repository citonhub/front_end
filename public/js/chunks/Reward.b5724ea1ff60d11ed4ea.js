...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    calculateLevel: function calculateLevel(point) {
      ...
      if (point >= 50 && point <= 99) {
        this.nextLevel = 'a Junior developer';
        this.remainingPoints = 100 - point;
        this.presentLevel = 'a Newbie';
        this.newLevelImage = '/imgs/newbie.svg';
      } else if (point >= 100 && point <= 199) {
        this.nextLevel = 'an Intermediate developer';
        this.remainingPoints = 200 - point;
        this.presentLevel = 'a Junior developer';
        this.newLevelImage = '/imgs/junior.svg';
      } else if (point >= 200 && point <= 299) {
        this.nextLevel = 'a Senior developer';
        this.remainingPoints = 300 - point;
        this.presentLevel = 'an Intermediate developer';
        this.newLevelImage = '/imgs/intermediate.svg';
      } else if (point >= 300 && point <= 399) {
        this.nextLevel = 'an Expert developer';
        this.remainingPoints = 400 - point;
        this.presentLevel = 'a Senior developer';
        this.newLevelImage = '/imgs/senior.svg';
      } else if (point >= 400 && point <= 499) {
        this.nextLevel = 'a Super developer';
        this.remainingPoints = 500 - point;
        this.presentLevel = 'an Expert developer';
        this.newLevelImage = '/imgs/expert.svg';
      } else if (point >= 500 && point <= 599) {
        this.nextLevel = 'a Super developer';
        this.remainingPoints = 500 - point;
        this.presentLevel = 'a Super developer';
        this.newLevelImage = '/imgs/super_dev.svg';
      }
