...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    send: function send() {
      ...
      if (this.query.length < 3) {} else {
        query = this.query;
      }

      setTimeout(function () {
        _this.$root.hubComponents.loadingPost = true;
        axios.get('/hub-search/' + query).then(function (response) {
          ...
          _this.$root.hubComponents.showAlert('Oops!', 'Unable to fetch posts,please try again', 'error');
        });
      }, 1000);
    }
  }
