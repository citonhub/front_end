  ...
  methods: {
    ...
    fetchSpaceInfo: function fetchSpaceInfo() {
      ...
      axios.get('/fetch-space-info-' + this.$root.selectedSpace.space_id).then(function (response) {
        if (response.status == 200) {
          var storedMsg = _this14.$root.getLocalStore('full_' + _this14.$root.selectedSpace.space_id + _this14.$root.username);
          ...
          storedMsg.then(function (result) {
            if (result != null) {
              ...
              _this14.$root.LocalStore('full_' + _this14.$root.selectedSpace.space_id + _this14.$root.username, finalResult);
            }
          }); // update chatList
            ...
            if (result != null) {
              ...
              if (response.data.space.type == 'Channel' || response.data.space.type == 'Team') {
                finalResult.channels.map(function (chat) {
                  if (chat.space_id == _this14.$root.selectedSpace.space_id) {
