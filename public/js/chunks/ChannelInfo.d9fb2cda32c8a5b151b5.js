    ...
    _c("div", { staticClass: "row" }, [
      ...
      _c(
        ...
        [
          _c("div", {
            style:
              "border-radius:50%;height:150px;width:150px;background-color:" +
              _vm.that.$root.selectedSpace.background_color +
              ";background-image:url(/imgs/space/" +
              _vm.that.$root.selectedSpace.image_name +
              "." +
              _vm.that.$root.selectedSpace.image_extension +
              ");background-size: cover;background-repeat: no-repeat; border:5px solid #3C87CD;"
          })
        ]
      ),
      _vm._v(" "),
      ...
      _c("div", { staticClass: "col-12 text-left py-1" }, [
        ...
        _c("span", { staticStyle: { "font-size": "12px" } }, [
          _vm._v(_vm._s(_vm.that.$root.selectedSpace.description))
        ])
      ]),
      _vm._v(" "),
      _vm._m(1),
