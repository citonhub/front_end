    ...
    saveRoute: function saveRoute() {
      ...
      if (this.$refs.form.validate()) {
        ...
        axios.post('/save-route-project', {
          ...
          _this.$root.projectPanelComponent.showAlert('Oops!', 'Unable to add web route,please try again', 'error');
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c(
        "div",
        { staticClass: "col-md-8 col-lg-4 offset-lg-4 offset-md-2 py-1" },
        [
          _c(
            "v-form",
            {
                  ...
                  "select",
                  {
                    ...
                    on: {
                      change: function($event) {
                        ...
                        _vm.RouteType = $event.target.multiple
                          ? $$selectedVal
                          : $$selectedVal[0]
                      }
                    }
                  },
                  _vm._l(_vm.Routes, function(option, index) {
                    return _c(
                      "option",
                  ...
                  "select",
                  {
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.ControllerFile,
                        expression: "ControllerFile"
                      }
                    ],
                    staticClass: "browser-default custom-select",
                    staticStyle: {
                    ...
                    on: {
                      change: function($event) {
                        ...
                        _vm.ControllerFile = $event.target.multiple
                          ? $$selectedVal
                          : $$selectedVal[0]
                      }
                    }
                  },
                  _vm._l(_vm.Controllers, function(option, index) {
                    return _c(
                      "option",
                      { key: index, domProps: { value: option.file_name } },
                      [_vm._v(_vm._s(option.file_name))]
                    )
                  }),
                  0
                )
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col-12 mt-5 mt-md-1 ml-lg-4" }, [
