  ...
  methods: {
    ...
    checkIfSelected: function checkIfSelected(content) {
      var thisContent = this.$root.resourcesSearchComponent.selectedItems.filter(function (eachContent) {
        return content.id == eachContent.id;
      });
    ...
    addToSelected: function addToSelected(content) {
      this.$root.resourcesSearchComponent.selectedItems.push(content);
    },
  ...
  return _c(
    ...
    _vm._l(_vm.contents, function(content, index) {
      return _c(
        ...
        {
          key: index,
          staticClass: "col-12 py-0 px-0 hoverEffect",
          on: {
            ...
            ? [
                _c(
                  "div",
                  {
                    ...
                    style:
                      content.content.id == _vm.that.$root.playingYoutubeVideoId
                  ...
                  [
                            ...
                            _vm.show_add_icon
                              ? _c(
                                  "div",
                                  {
                                    ...
                                    style: _vm.checkIfSelected(content)
                                      ? "background:#3C87CD; cursor:pointer; position:absolute; top:0px; right:0px; border:1px solid black; border-top-right-radius:8px;"
                                      : "background:rgba(0, 0, 0,0.6); cursor:pointer; position:absolute; top:0px; right:0px; border:1px solid black; border-top-right-radius:8px;",
                                    on: {
                                      click: function($event) {
                                        $event.stopPropagation()
                    ...
                    _vm._v(" "),
                    _c("div", [_c("v-icon", [_vm._v("las la-ellipsis-v")])], 1)
                  ]
                )
              ]
            : _vm._e(),
