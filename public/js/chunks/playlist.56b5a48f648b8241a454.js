...
var render = function() {
  ...
  return _c("div", { staticClass: "py-1 px-0" }, [
    ...
    _vm._v(" "),
    _c("div", { staticClass: "video-list mt-2" }, [
      _c(
        "div",
        {
          staticClass: "list-item px-0 d-flex",
          staticStyle: { background: "rgba(125, 179, 229, 0.5)" }
        },
        [
          _c("v-icon", { staticClass: "ml-2", attrs: { color: "#B0B0B0" } }, [
            _vm._v("las la-play-circle")
          ]),
          _vm._v(" "),
          _c("span", { staticClass: "ml-3" }, [_vm._v("Vue Routes")])
        ],
        1
      )
    ])
