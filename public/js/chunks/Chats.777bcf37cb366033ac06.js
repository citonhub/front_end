...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    fetchMessages: function fetchMessages(spaceId) {
      ...
      this.errorLoadingMessage = false; // clear diary suggestions
    ...
    handleUnreadUpdate: function handleUnreadUpdate() {
      ...
      storedSubChat.then(function (result) {
        if (result != null) {
          ...
          _this19.checkForUnreadSubSpace();
        }
      });
    },
    checkForUnreadSubSpace: function checkForUnreadSubSpace() {
      var _this20 = this;
      ...
      for (var index = 0; index < this.$root.subSpaces.length; index++) {
        var spaceData = this.$root.subSpaces[index];
        console.log(spaceData.unread);
        this.$root.selectedSpace.subspace_messages += spaceData.unread;
      }

      console.log(this.$root.selectedSpace.subspace_messages);
    },
