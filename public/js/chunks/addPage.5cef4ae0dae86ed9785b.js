    ...
    postData: function postData() {
      ...
      if (this.$refs.addPost.validate()) {
        ...
        axios.post('/save-hub-post', formData, {
          ...
          if (response.status == 200) {
            var currentPost = _this5.$root.posts;
            _this5.$root.hubComponents.loadingPost = true;
            var newPost = [response.data.data];
            var NewPostsArray = newPost.concat(currentPost);
            _this5.$root.posts = NewPostsArray;
