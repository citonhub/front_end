...
/* harmony import */ var vue_screen__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! vue-screen */ "./node_modules/vue-screen/dist/vue-screen.esm.js");
var _methods;
...
Vue.use(vue_screen__WEBPACK_IMPORTED_MODULE_4__["default"], 'bootstrap');
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: (_methods = {
    monitorLink: function monitorLink() {
      var _this2 = this;
      ...
      axios.post('/run-project-link', {
        ...
        if (response.status == 200) {
          if (response.data.status == 'allowed') {
            _this2.supportedLink = true;
            _this2.projectLinkFullContent = 'working';
          } else {
            _this2.supportedLink = false;
            _this2.projectLinkFullContent = 'false';
          }
        }
    ...
    fetchComments: function fetchComments(postId) {
      ...
      axios.get('/comments/' + postId).then(function (response) {
        if (response.status == 200) {
          ...
          _this3.loadingPostComments = false;
        }
      })["catch"](function (error) {
        _this3.loadingPostComments = false;
      });
    ...
    likeComment: function likeComment(comment) {
      ...
      axios.post('/like-hub-post-comment', {
        ...
        if (response.status == 200) {
          _this5.comments.map(function (eachcomment) {
      ...
      if (this.commentValue != '') {
        ...
        axios.post('/comment-hub-post', formData).then(function (response) {
          if (response.status == 201) {
            ...
            _this6.comments.unshift(Newcomment);
    ...
    likePost: function likePost() {
      ...
      this.$root.posts.map(function (post) {
        if (post.id == _this7.$root.selectedPost.id) {
          post.likes += 1;
        }
      });
      var formData = new FormData();
      ...
      axios.post('/like-hub-post', formData).then(function (response) {
        if (response.status == 204) {
          if (response.data == "liked") {
            _this7.$root.selectedPost.isLiked = 1;
          }
        } else {
      ...
      axios.post('/pin-hub-post', formData).then(function (response) {
        if (response.status == 201) {
          if (response.data == "pinned") {
            _this8.$root.selectedPost.isPinned = 1;
          }
        } else {
          if (response.data == "Post Pinned Already") {
            _this8.showAlert('Oops!', response.data, 'error');
    ...
    showPage: function showPage() {
      ...
      if (this.$root.selectedPost.project.project.is_web) {
        ...
        var status = this.$root.checkCodeForInput(this.$root.selectedPost.project.project_files.code_files[0].content, this.panelData.panel_language);
    ...
    loadPageContent: function loadPageContent(panelId) {
      ...
      axios.get('/run-panel/' + panelId).then(function (response) {
        if (response.status == 200) {
          _this9.loadingCode = false;
          _this9.pageContent = response.data;
        }
      })["catch"](function (error) {
        _this9.showAlert('Oops!', 'Unable to load page content', 'error');
      });
    },
  ...
  }), _defineProperty(_methods, "runCodeOnSandbox", function runCodeOnSandbox(codeContent) {
    var _this10 = this;
    ...
    axios.post('/run-code-on-sandbox-project', {
      ...
      if (response.status == 200) {
        ...
        if (response.data[0][0].status.description == 'Accepted') {
          _this10.pageContent = response.data[0][0].stdout;
        } else if (response.data[0][0].status.description == 'In Queue') {
          _this10.pageContent = 'In Queue...';

          _this10.checkResponse(token, response.data[1]);
        } else if (response.data[0][0].status.description == 'Processing') {
          _this10.pageContent = 'Processing...';

          _this10.checkResponse(token, response.data[1]);
        } else {
          _this10.pageContent = response.data[0].stdout + '\n Error: \n' + response.data[0].stderr + ' \n' + response.data[0].compile_output + '\n' + response.data[0].error;
        }
      }
    })["catch"](function (error) {
      _this10.pageContent = 'An issue occured,unable to run on sandbox...';
    });
    ...
    var storedPostData = this.$root.getLocalStore('post_data_new_' + currentPostid + this.$root.username);
    storedPostData.then(function (result) {
      if (result != null) {
        var finalResult = JSON.parse(result);
        _this11.$root.selectedPost = finalResult;
        _this11.panelData = _this11.$root.selectedPost.project.project_panel;

        _this11.fetchComments(_this11.$root.selectedPost.id);

        _this11.loadingPost = false;

        _this11.updatePost();

        if (!_this11.$root.selectedPost.link) {
          _this11.showPage();
        } else {
          _this11.monitorLink();
        }
        ...
        axios.get('/fetch-post/' + currentPostid).then(function (response) {
          if (response.status == 200) {
            _this11.$root.LocalStore('post_data_new_' + currentPostid + _this11.$root.username, response.data.data);
    ...
    axios.get('/fetch-post/' + this.$route.params.post_id).then(function (response) {
      if (response.status == 200) {
        _this12.$root.LocalStore('post_data_new_' + _this12.$route.params.post_id + _this12.$root.username, response.data.data);

        _this12.$root.selectedPost = response.data.data;
      }
    })["catch"](function (error) {});
  ...
  return _c(
    ...
    [
      _c(
        ...
        {
          staticClass:
            "col-lg-6 offset-lg-3 py-1 py-md-2  d-flex flex-row flex-wrap px-md-2 px-1",
          staticStyle: {
            background: "white",
            position: "fixed",
            "z-index": "99999999",
        ...
        [
          ...
          _c(
            "div",
            {
              staticClass: "col-lg-12 py-1 px-0 mb-1",
              style:
            ...
            [
              ...
              this.$root.selectedPost.link
                          ...
                          _vm.supportedLink
                            ? _c("iframe", {
                                ...
                                attrs: {
                                  ...
                                  src: _vm.that.$root.selectedPost.project_url,
                                  id: "mainIframe"
                                }
                              })
                            : _vm._e(),
                            ...
                            ? _c(
                                ...
                                [
                                  _c(
                                    ...
                                    [
                                      _vm._v(
                                        "Oops! This project cannot be opened in an iframe. "
                                      ),
                                      _c(
                                        "a",
                                        {
                                          attrs: {
                                            target: "_blank",
                                            href: this.$root.selectedPost
                                              .project_url
                                          }
                                        },
                                        [_vm._v("Click here to view project. ")]
                                      )
                                    ]
                                  )
                                ]
                ...
                : [
                    ...
                    _vm._v(" "),
                    _vm.pageContent != "" &&
                    this.$root.selectedPost.project.project.is_web
                      ? [
                          _c("iframe", {
                            staticClass: "col-12  px-0 py-0",
                            staticStyle: {
          ...
          [
            ...
            _c(
              ...
              [
                _c(
                  "v-btn",
                  { attrs: { icon: "" }, on: { click: _vm.sharePost } },
                  [
      ...
      _c(
        "div",
        {
          staticClass: "col-lg-6 offset-lg-3 py-0 px-0 ",
          staticStyle: { "font-family": "BodyFont", background: "white" }
        },
        [
          _vm.replyCommentIsOn
            ? [
                _c("div", [
                  _c("div", { staticClass: "px-2" }, [
                    _c(
                      ...
                      [
                        _c(
                          "div",
                          { staticClass: "col-12 py-1 px-1  text-right" },
                          [
                            _c(
                              "span",
                              {
                                staticClass:
                                  "msgTextReplynew text-left d-block",
                                staticStyle: {
                                  color: "white",
                                  "white-space": "nowrap",
                                  overflow: "hidden",
                              ...
                              [
                                _vm._v(
                                  "\n                 " +
                                    _vm._s(_vm.repliedComment.content) +
                                    "\n                 "
                                )
                              ]
                            )
                          ...
                          _c(
                            ...
                            [
                              !_vm.that.$root.selectedPost.link
                                ...
                                : _vm._e(),
                              _vm._v(" "),
                              _vm.that.$root.selectedPost.project.project
                                ? _c(
                                    "div",
                                    { staticClass: "px-1" },
                                    [
    ...
    return _c(
      ...
      [
        _c(
          "span",
          { staticStyle: { "font-size": "13px", "font-family": "BodyFont" } },
          [_vm._v("No comment yet, be the first to comment")]
        )
      ]
    )
  }
