  ...
  methods: {
    ...
    setVideoData: function setVideoData() {
      ...
      intevalVideoSetting = setInterval(function () {
        if (_this4.player == undefined) {
          _this4.player = new YT.Player('YTplayer' + _this4.screenType, {
            events: {
              'onReady': _this4.onPlayerReady,
              'onStateChange': _this4.onPlayerStateChange
            }
          });
        } else {
            ...
            _c(
              "div",
              {
                ...
                style:
                  ...
                  _vm.playerHeight +
                  "px; width:100%; background:white; align-items:center;justify-content:center;"
              },
              [
                ...
                _c(
                  ...
                  [
                    ...
                    _c(
                      ...
                      [
                        _vm.that.$root.playingVideoSubState == "subscribed"
                          ? [
                              _c(
                                "v-btn",
                                {
                              ...
                              [
                                _c(
                                  "v-icon",
                                  {
                                    ...
                                    attrs: {
                                      color:
                                        _vm.that.$root.playingVideoRating ==
                                        "like"
                                          ? "red"
                                          : ""
                                    }
