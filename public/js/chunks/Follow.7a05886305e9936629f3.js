...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "col-lg-6 offset-lg-3  col-md-8 offset-md-2 offset-sm-1  col-sm-10   scroller py-0",
      staticStyle: {
      ...
      _c(
        ...
        _vm._l(_vm.diaries, function(diary, index) {
          return _c(
            ...
            [
              _c("div", { staticClass: "diary col-lg-4 py-1 col-7 px-1 " }, [
              ...
              _c(
                ...
                {
                  staticClass:
                    "mt-1 offset-lg-5 offset-md-5 offset-sm-4 offset-1 ",
                  staticStyle: {
                    color: "white",
