    ...
    createSubSpace: function createSubSpace() {
      ...
      axios.post('/create-sub-space', {
        ...
        if (response.status == 200) {
          ...
          var storedSubChat = _this.$root.getLocalStore('sub_channels_' + _this.$root.selectedSpace.general_spaceId + _this.$root.username);
          ...
          storedSubChat.then(function (result) {
            if (result != null) {
              ...
              _this.$root.LocalStore('sub_channels_' + _this.$root.selectedSpace.general_spaceId + _this.$root.username, finalResult);
