  ...
  methods: {
    ...
    sendMessageData: function sendMessageData(formData) {
      ...
      axios.post('/create-response-content', formData, {
        ...
        if (response.status == 200) {
          var message = response.data.message[0];

          _this7.clearData();

          _this7.responseContents.push(message);
              ...
              _c(
                ...
                [
                  _c("v-text-field", {
                    ...
                    model: {
                      value: _vm.that.$root.noteContent.subject.tag_name,
                      callback: function($$v) {
                        _vm.$set(
                          _vm.that.$root.noteContent.subject,
                          "tag_name",
                          $$v
                        )
                      },
                      expression: "that.$root.noteContent.subject.tag_name"
                    }
                  })
                ],
                1
