    ...
    setLanguageType: function setLanguageType() {
      ...
      if (this.$route.params.language_type == 'code_files') {
        var codeLang = this.appTypeList.filter(function (code) {
          return code.id == _this.$root.panelLanguage;
        });
      ...
      if (this.$refs.form.validate()) {
        ...
        axios.post('/save-code-file-project', {
          ...
          if (response.status == 201) {
            _this2.$root.CodeFilesData[0].push(response.data);

            _this2.$root.LocalStore(_this2.$route.params.projectSlug, _this2.$root.CodeFilesData);
