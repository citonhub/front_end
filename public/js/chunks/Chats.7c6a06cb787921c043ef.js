    ...
    fetchSpaceInfo: function fetchSpaceInfo() {
      ...
      axios.get('/fetch-space-info-' + this.$root.selectedSpace.space_id).then(function (response) {
        if (response.status == 200) {
          ...
          var storedChat = _this23.$root.getLocalStore('user_chat_list' + _this23.$root.username);
          ...
          storedChat.then(function (result) {
            if (result != null) {
              ...
              _this23.$root.LocalStore('user_chat_list' + _this23.$root.username, finalResult);
            }
          });
        }
      })["catch"](function (error) {});
