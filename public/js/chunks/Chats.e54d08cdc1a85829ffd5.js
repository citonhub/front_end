        ...
        if (this.$root.ChatList.length == 0) {
          ...
          storedChat.then(function (result) {
            if (result != null) {
              ...
              var fullList = finalResult.channels.concat(finalResult.direct_messages, finalResult.pet_spaces); //  this.$root.ChatList = fullList;
                ...
                [
                  _vm.chatbarContent == "chat_list"
                    ? [
                        ...
                        _vm._v(" "),
                        !_vm.loadingChatList && !_vm.loadingIsError
                          ? [
                              _c("DynamicScroller", {
                                ref: "ChatContainer",
                        ...
                        fn: function(ref) {
                          ...
                          return [
                            _c(
                              ...
                              [_c("chat-list", { attrs: { source: item } })],
                              1
                            )
                          ]
                        }
