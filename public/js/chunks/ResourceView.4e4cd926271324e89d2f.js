...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    showContent: function showContent(content) {
      this.$router.push({
        path: '/channels/resources/content/' + this.$root.selectedSpace.space_id
      });
    ...
    goBack: function goBack() {
      this.$router.push({
        path: '/channels/resources/view/' + this.$root.selectedSpace.space_id
      });
    },
    ...
    [
      _vm.loadingContent
        ...
        : [
                  ...
                  _vm.loadingResourceContent
                    ...
                    : [
                        _c("div", { staticClass: "col-12" }, [
                          _c("div", [_c("h6", [_vm._v("Description")])]),
                          _vm._v(" "),
                          _c("div", [
                            _c("span", {
                              staticStyle: {
                        ...
                        _c(
                          "div",
                          {
                            staticClass: "col-12 py-1 ml-1 px-1 px-md-2 ",
                            staticStyle: {
            ...
            _vm._v(" "),
            _vm.showYoutubePlayerTemp
              ? _c("div", {
                  staticClass: "d-flex flex-row col-md-6 px-0 py-0 text-center",
                  staticStyle: {
