    ...
    _c(
      ...
      [
        _c("h1", { staticClass: "text-center" }, [
          _vm._v(" Select Your Interests-sm")
        ]),
        _vm._v(" "),
    ...
    _c(
      ...
      [
        _c(
          ...
          {
            staticClass:
              "col-lg-6 offset-lg-3 col-md-6 offset-md-3 col-sm-6 offset-sm-3 d-sm-block d-none"
          },
          [
            _c("h1", { staticClass: "text-center" }, [
              _vm._v(" Select Your Interestsb")
            ]),
            _vm._v(" "),
            _c("p", { staticClass: "text-center" }, [
              _vm._v("Pick one or more.")
            ]),
            _vm._v(" "),
            _vm._l(_vm.Interests, function(interest, index) {
              return _c(
