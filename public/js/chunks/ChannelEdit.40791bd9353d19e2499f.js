...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {},
  mounted: function mounted() {//     if(this.$root.selectedSpace.description == null){
  ...
  methods: {
    goBack: function goBack() {
      ...
      setTimeout(function () {
        _this2.$root.chatComponent.innerSideBarContent = 'channel_info';
      }, 500);
    },
    fetchMessages: function fetchMessages() {
      ...
      axios.get('/fetch-space-messages-' + this.$route.params.spaceId).then(function (response) {
        if (response.status == 200) {
          _this3.$root.selectedSpace = response.data[1];
        }
    ...
    saveChanges: function saveChanges() {
      ...
      axios.post('/update-space', formData, {
        ...
        if (response.status == 200) {
          ...
          _this5.$root.croppedImage = '';
          _this5.$root.reloadSpaceInfo = true;

          _this5.goBack();
        } else {}
      })["catch"](function (error) {
        _this5.showAlert(5000, 'Failed- ' + error);
                  ...
                  [
                    _c("div", [
                      _c("span", { staticStyle: { "font-size": "13px" } }, [
                        _vm._v(" " + _vm._s(_vm.$t("space.space_image")))
                      ])
                    ]),
                    _vm._v(" "),
                    _c(
