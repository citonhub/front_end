  ...
  methods: {
    ...
    imageStyle: function imageStyle(height, data) {
      if (data.background_color == null) {
        var styleString = "width:100%;height:" + height + "px;position:absolute; left:0%; top:0%;border-top-left-radius:6px;  border-top-right-radius:6px;  border:1px solid transparent;background-repeat: no-repeat; background-size:cover; ";
        ...
        var _styleString = "width:100%;height:" + height + "px;position:absolute; left:0%; top:0%; border:1px solid transparent; border-top-left-radius:6px;  border-top-right-radius:6px;background-repeat: no-repeat; background-size:cover; ";
            ...
            _c(
              ...
              [
                ...
                _c(
                  ...
                  _vm._l(_vm.appName(_vm.source), function(lang, index) {
                    return _c(
                      "span",
                      { key: "lang" + index, staticClass: "mx-1" },
                      [
                        _c("i", {
                          class: lang.icon,
