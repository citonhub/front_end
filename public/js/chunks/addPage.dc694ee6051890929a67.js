                ...
                _c("div", { staticClass: "d-flex flex-row mt-3" }, [
                  _c("div", {
                    ...
                    staticStyle: {
                      ...
                      "background-image": "url(/imgs/default_1.jpg)",
                    ...
                    on: {
                      click: function($event) {
                        return _vm.selectDefaultImg("/imgs/default_1.jpg", 1)
                      }
                    }
                  }),
                  _vm._v(" "),
                  _c("div", {
                    ...
                    staticStyle: {
                      ...
                      cursor: "pointer",
                      "background-color": "#c5c5c5",
                      "background-image": "url(/imgs/default_2.jpg)",
                      "background-size": "cover",
                      "background-repeat": "no-repeat",
                      border: "1px solid #c5c5c5"
                    },
                    on: {
                      click: function($event) {
                        return _vm.selectDefaultImg("/imgs/default_2.jpg", 2)
                      }
                    }
                  }),
                  _vm._v(" "),
