          ...
          if (response.status == 200) {
            ...
            storedChat.then(function (result) {
              if (result != null) {
                ...
                _this2.$root.LocalStore('user_chat_list' + _this2.$root.username, finalResult, 'new_channel');
                ...
                _this2.$root.chatComponent.chatbarContent = 'chat_list';

                _this2.$root.chatComponent.openChat(response.data.space.space_id, true);
              }
            });
          }
              ...
              _c(
                ...
                [
                  _c(
                    ...
                    {
                      staticClass:
                        "col-lg-12 col-md-6 offset-md-3 offset-lg-0 py-2 my-0 px-2",
                      staticStyle: { height: "70px", width: "100%" }
                    },
                    [
                      _c("v-text-field", {
