...
/* harmony import */ var vue_virtual_scroller_dist_vue_virtual_scroller_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! vue-virtual-scroller/dist/vue-virtual-scroller.css */ "./node_modules/vue-virtual-scroller/dist/vue-virtual-scroller.css");
/* harmony import */ var vue_virtual_scroller_dist_vue_virtual_scroller_css__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(vue_virtual_scroller_dist_vue_virtual_scroller_css__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var izitoast_dist_css_iziToast_min_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! izitoast/dist/css/iziToast.min.css */ "./node_modules/izitoast/dist/css/iziToast.min.css");
/* harmony import */ var izitoast_dist_css_iziToast_min_css__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(izitoast_dist_css_iziToast_min_css__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var v_emoji_picker__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! v-emoji-picker */ "./node_modules/v-emoji-picker/lib/v-emoji-picker.esm.js");
//
//
//
//
...
Vue.component('DynamicScroller', vue_virtual_scroller__WEBPACK_IMPORTED_MODULE_1__["DynamicScroller"]);
Vue.component('DynamicScrollerItem', vue_virtual_scroller__WEBPACK_IMPORTED_MODULE_1__["DynamicScrollerItem"]);

Vue.directive('observe-visibility', vue_observe_visibility__WEBPACK_IMPORTED_MODULE_3__["ObserveVisibility"]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    VEmojiPicker: v_emoji_picker__WEBPACK_IMPORTED_MODULE_6__["VEmojiPicker"],
  ...
  methods: {
    ...
    showAlert: function showAlert() {
      ...
      if (type == 'info') {
        izitoast__WEBPACK_IMPORTED_MODULE_4___default.a.info({
          title: title,
          message: message,
          zindex: '9999999999',
          timeout: 2000,
      ...
      if (type == 'success') {
        izitoast__WEBPACK_IMPORTED_MODULE_4___default.a.success({
          title: title,
          message: message,
          zindex: '9999999999',
          timeout: 2000,
      ...
      if (type == 'warning') {
        izitoast__WEBPACK_IMPORTED_MODULE_4___default.a.warning({
          title: title,
          timeout: 2000,
          message: message,
          zindex: '9999999999',
      ...
      if (type == 'error') {
        izitoast__WEBPACK_IMPORTED_MODULE_4___default.a.error({
          title: title,
          message: message,
          timeout: 2000,
          zindex: '9999999999',
      ...
      if (this.$root.checkauthroot == 'auth') {
        if (this.$root.ChatList.length == 0) {
          ...
          storedChat.then(function (result) {
            if (result != null) {
              var finalResult = JSON.parse(result);
              _this10.$root.baseChatList = finalResult;
              _this10.$root.channelChats = finalResult.channels;
              var fullList = finalResult.channels.concat(finalResult.direct_messages, finalResult.pet_spaces);
              _this10.$root.ChatList = fullList;

              _this10.$root.sortChatList();

              _this10.SetUnread(); // get all new messages


              _this10.$root.updateSpaceMessages();

              _this10.$root.loadingChatList = false;
            } else {
              axios.get('/fetch-chat-list/' + _this10.$root.userDeviceId).then(function (response) {
                if (response.status == 200) {
                  var responseList = response.data;
                  _this10.$root.baseChatList = response.data;
                  _this10.$root.channelChats = responseList.channels;
                  _this10.$root.ChatList = responseList.channels.concat(responseList.direct_messages, responseList.pet_spaces);

                  _this10.$root.LocalStore('user_chat_list' + _this10.$root.username, response.data, false, 'sort_chat');

                  _this10.$root.loadingChatList = false;
                }
              })["catch"](function (error) {
                _this10.showAlert('Oops!', 'Unable to fetch channels', 'error');

                _this10.loadingChatList = false;
                _this10.loadingIsError = true;
              });
            }
          });
        } else {
    ...
    SetUnread: function SetUnread() {
      ...
      this.$root.ChatList.map(function (space) {
        var unreadStoredMsg = _this11.$root.getLocalStore('unread_messages_' + space.space_id + _this11.$root.username);
    ...
    checkIfisOwner: function checkIfisOwner() {
      ...
      var userMemberData = this.$root.selectedSpaceMembers.filter(function (members) {
        return members.user_id == _this12.$root.user_temp_id;
      });
        ...
        if (result != null) {
          ...
          if (finalResult.length != 0) {
            for (var index = 0; index < finalResult.length; index++) {
              _this13.$root.sendTextMessage(finalResult[index]);
            }

            _this13.$root.LocalStore('unsent_messages_' + _this13.$route.params.spaceId + _this13.$root.username, []);
          }
        } else {}
      });
    },
    makeUserMaster: function makeUserMaster(member) {
      ...
      axios.post('/make-user-master', {
        ...
        if (response.status == 200) {
          _this14.$root.adminMembers.forEach(function (member) {
            member.master_user = false;
          });

          _this14.$root.adminMembers.map(function (member) {
            if (member.memberId == response.data) {
              member.master_user = true;
            }
          });

          _this14.$root.selectedSpaceMembers.forEach(function (member) {
            member.master_user = false;
          });

          _this14.$root.selectedSpaceMembers.map(function (member) {
            if (member.memberId == response.data) {
              member.master_user = true;
            }
    ...
    autoMakeuserMaster: function autoMakeuserMaster() {
      ...
      if (this.checkIfisOwner()) {
        ...
        var userMember = this.$root.selectedSpaceMembers.filter(function (member) {
          return member.user_id == _this15.$root.user_temp_id;
        });
      ...
      axios.post('/check-for-unread-messages-clean', {
        ...
        if (response.status == 200) {
          if (response.data[0].length > 0) {
            var messageData = {
              space_id: _this16.$root.selectedSpace.space_id,
              new_messages: response.data[0]
            };

            _this16.$root.handleSpaceData([messageData]);
          }
        }
      })["catch"](function (error) {});
    },
    ...
    fetchMessages: function fetchMessages(spaceId) {
      ...
      if (this.$root.checkauthroot == 'auth') {
        ...
        storedMsg.then(function (result) {
          if (result != null) {
            var finalResult = JSON.parse(result);
            _this17.$root.spaceFullData = finalResult;

            var returnedData = _this17.handleResults(finalResult.messages);

            _this17.$root.Messages = returnedData;
            _this17.$root.selectedSpace = [];
            _this17.$root.selectedSpace = finalResult.space;

            if (finalResult.space.type == 'SubSpace') {
              var generalSpace = finalResult.space.gen_space;
              _this17.$root.selectedGenSpaceType = finalResult.space.gen_space.type;
              ...
              _this17.$root.selectedSubSpaceName = finalResult.space.name;
              _this17.$root.selectedSubSpaceType = subSpaceData.type;
              generalSpace.sub_spaces = finalResult.space.sub_spaces;
              _this17.$root.selectedSpace = generalSpace;
            }

            _this17.$root.TrackLastSubSpace.push(_this17.$root.selectedSpace.general_spaceId, _this17.$route.params.spaceId);

            _this17.$root.selectedSpaceMembers = finalResult.members; // set default admin user

            _this17.autoMakeuserMaster(); // get the message scroller component and scroll to bottom


            _this17.$root.msgScrollComponent = _this17.$refs;

            _this17.setShareLink(); // check for space in chatlist


            if (_this17.$root.selectedSpace.type == 'Channel' || _this17.$root.selectedSpace.type == 'Team' || _this17.$root.selectedSpace.type == 'Direct') {
              _this17.$root.addSpaceToChatList(_this17.$root.selectedSpace.space_id);
            } // generate unread msg and the mark as read


            _this17.generateUnreadMessage();

            setTimeout(function () {
              if (_this17.$root.selectedSpace.type == 'Channel' || _this17.$root.selectedSpace.type == 'Team') {
                if (_this17.$refs.messageContainer) {
                  _this17.$refs.messageContainer.scrollToBottom();
                }

                if (_this17.$refs.messageContainersmall) {
                  _this17.$refs.messageContainersmall.scrollToBottom();
                }
              } else {
                if (_this17.$refs.messageContainer) {
                  _this17.$refs.messageContainer.scrollToBottom();
            ...
            _this17.messageIsDone = true; // check for unsent messages and resend

            var unsentStoredMsg = _this17.$root.getLocalStore('unsent_messages_' + _this17.$route.params.spaceId + _this17.$root.username);

            unsentStoredMsg.then(function (result) {
              _this17.resendMessages();
            });

            _this17.fetchSpaceInfo();
          } else {
            axios.get('/fetch-space-messages-' + _this17.$route.params.spaceId).then(function (response) {
              if (response.status == 200) {
                if (response.data.space.space_id == _this17.$route.params.spaceId) {
                  _this17.$root.spaceFullData = response.data;

                  _this17.$root.LocalStore('full_space_' + _this17.$route.params.spaceId + _this17.$root.username, response.data);

                  _this17.$root.LocalStore('unread_messages_' + _this17.$route.params.spaceId + _this17.$root.username, []);

                  var _returnedData = _this17.handleResults(response.data.messages);

                  _this17.$root.Messages = _returnedData;
                  _this17.$root.selectedSpace = response.data.space;

                  if (response.data.space.type == 'SubSpace') {
                    var _generalSpace = response.data.space.gen_space;
                    _this17.$root.selectedGenSpaceType = response.data.space.gen_space.type;
                    ...
                    _this17.$root.selectedSubSpaceName = response.data.space.name;
                    _this17.$root.selectedSubSpaceType = _subSpaceData.type;
                    _generalSpace.sub_spaces = response.data.space.sub_spaces;
                    _this17.$root.selectedSpace = _generalSpace;
                  }

                  if (response.data.space.type == 'Bot') {
                    _this17.$root.botSuggestionArray = response.data.patterns;

                    _this17.$root.LocalStore('bot_latest_suggestions' + _this17.$root.selectedSpace.space_id + _this17.$root.username, response.data.patterns);
                  }

                  _this17.$root.TrackLastSubSpace.push(_this17.$root.selectedSpace.general_spaceId, _this17.$route.params.spaceId);

                  _this17.$root.selectedSpaceMembers = response.data.members;
                  _this17.$root.msgScrollComponent = _this17.$refs;
                  ...
                  _this17.messageIsDone = true;
                }
              }
            })["catch"](function (error) {
              _this17.errorLoadingMessage = true;
            });
          }

          if (_this17.$root.selectedSpace.type == 'Bot') {
            _this17.checkForNewNotes();
    ...
    checkForUnreadMessagesDisconnected: function checkForUnreadMessagesDisconnected() {
      ...
      if (this.chatIsOpen) {
        ...
        unreadStoredMsg.then(function (result) {
          ...
          if (_this18.$root.sendingMessage == false) {
            _this18.periodicUpdate(finalResultUnread);
          }
        });
      }
    },
    checkForNewNotes: function checkForNewNotes() {
      ...
      axios.get('/fetch-diary-notes-' + this.$root.selectedSpace.bot_data.bot_id).then(function (response) {
        if (response.status == 200) {
          _this19.$root.LocalStore('diary_notes_' + _this19.$root.selectedSpace.space_id + _this19.$root.username, response.data);

          var finalResult = response.data.diary_notes;
          _this19.$root.diaryNotes = finalResult;
        }
      })["catch"](function (error) {});
    },
    fetchSpaceInfo: function fetchSpaceInfo() {
      ...
      axios.get('/fetch-space-info-' + this.$root.selectedSpace.space_id).then(function (response) {
        if (response.status == 200) {
          var storedMsg = _this20.$root.getLocalStore('full_space_' + _this20.$root.selectedSpace.space_id + _this20.$root.username);
          ...
          storedMsg.then(function (result) {
            if (result != null) {
              ...
              _this20.$root.LocalStore('full_space_' + _this20.$root.selectedSpace.space_id + _this20.$root.username, finalResult);
            }
          }); // update chatList

          var storedChat = _this20.$root.getLocalStore('user_chat_list' + _this20.$root.username);
            ...
            if (result != null) {
              ...
              if (response.data.space.type == 'Channel' || response.data.space.type == 'Team') {
                finalResult.channels.map(function (chat) {
                  if (chat.space_id == _this20.$root.selectedSpace.space_id) {
              ...
              var fullList = finalResult.channels.concat(finalResult.direct_messages, finalResult.pet_spaces);
              _this20.$root.ChatList = fullList;

              _this20.$root.sortChatList();

              _this20.$root.LocalStore('user_chat_list' + _this20.$root.username, finalResult);
            }
          });
        }
      })["catch"](function (error) {});
      ...
      if (this.$root.Messages.length == 0) {} else {
        ...
        storedSuggestions.then(function (result) {
          ...
          if (finalResultUnread != null) {
            _this21.$root.botSuggestionArray = finalResultUnread;
          }
        });
      }
    }
                ...
                ? _c(
                    ...
                    [
                      _c(
                        "v-icon",
                        {
                          staticStyle: { "font-size": "25px", color: "#3C87CD" }
                        },
                        [_vm._v("las la-code")]
                      )
                    ],
                            ...
                            ? _c(
                                ...
                                [
                                  _c(
                                    ...
                                    [_vm._v("las la-angle-double-down")]
                                  )
                                ],
                                1
                              )
                  ...
                  [
                    ...
                    _vm.that.$root.Messages
                      ? [
                          _vm.that.$root.Messages.length > 0
                            ? [
                                _vm.chatIsOpen && !_vm.bottomIsVisible
                                  ? _c(
                                      "v-btn",
                                      {
                                        staticStyle: {
