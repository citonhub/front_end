...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-textarea-autosize'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
//
//
//
//
...
Vue.use(!(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-textarea-autosize'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    startCounter: function startCounter() {
      ...
      var recorderInterval = setInterval(function () {
        _this2.seconds++;
        var secondsString = '';
          ...
          ? [
              ...
              _c("textarea-autosize", {
                ...
                attrs: {
                  ...
                  value: _vm.input,
                  important: true,
                  "min-height": _vm.screenType == "large" ? 40 : 40,
                  "max-height": _vm.screenType == "large" ? 60 : _vm.textHeight
                },
                on: { input: _vm.update },
                nativeOn: {
