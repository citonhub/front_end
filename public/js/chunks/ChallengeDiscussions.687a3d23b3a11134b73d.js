...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    scrollToBottom: function scrollToBottom() {
      ...
      var containerSm = document.querySelector('#scrollerDiscussionSm');
      container.scrollTo(0, container.scrollHeight);
      containerSm.scrollTo(0, containerSm.scrollHeight);
    },
...
var render = function() {
  ...
  return _c("div", [
    _c(
      ...
      {
        staticClass:
          "col-lg-10 offset-lg-1 d-md-block d-none scroller scrollerDiscussion px-md-2 px-1 py-1 ",
        staticStyle: {
          background: "#E1F0FC",
          position: "absolute",
          height: "100%",
    ...
    _c(
      ...
      {
        staticClass:
          "col-lg-10 offset-lg-1 d-md-none d-block scroller  px-md-2 px-1 py-1 ",
        staticStyle: {
          background: "#E1F0FC",
          position: "absolute",
          height: "100%",
        ...
        _c(
          ...
          [
            _vm._l(_vm.comments, function(comment, index) {
              return _c(
                "div",
                { key: index + "small", staticClass: "col-12 py-2 px-1" },
                [
                  comment.username != _vm.that.$root.username
                    ? _c(
                        "div",
