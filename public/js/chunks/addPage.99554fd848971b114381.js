...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    setFrameLoaded: function setFrameLoaded() {
      this.projectIsFit = true;
      console.log('loaded');
    },
    textProject: function textProject() {
      var _this2 = this;
      ...
      axios.post('/check-project-status', {
        ...
        if (response.status == 200) {
          if (response.data.status == 'allowed') {
            ...
            _this2.showAlert('Oops!', 'You already shared this project. Please change and try again', 'error');

            _this2.loading = false;
          }
        }
      })["catch"](function (error) {
        _this2.showAlert('Oops!', 'Unable to save post,please try again', 'error');
    ...
    setTagHandler: function setTagHandler() {
      ...
      var selectedProject = this.projectArray.filter(function (project) {
        return project.project_slug == _this3.post.project_slug;
      });
    ...
    getAllProjects: function getAllProjects() {
      ...
      axios.get('/fetch-personal-projects').then(function (response) {
        if (response.status == 200) {
          _this4.loadingProjects = false;
          _this4.projectArray = response.data.projects;
        }
      })["catch"](function (error) {});
    },
    ...
    crophandler: function crophandler(event) {
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
          ...
          _this5.$root.imagepath = e.target.result;
          _this5.imagepath = e.target.result;
          _this5.$root.imageExist = true;
    ...
    postData: function postData() {
      ...
      if (this.$refs.addPost.validate()) {
        ...
        languageList.forEach(function (lang) {
          var langData = _this6.languageIcon.filter(function (data) {
        ...
        axios.post('/save-hub-post', formData, {
          ...
          if (response.status == 200) {
            _this6.$root.posts.unshift(response.data.data);

            _this6.loading = false;

            _this6.goBack();

            _this6.$root.formerPoint = _this6.$root.authProfile.points;
            _this6.$root.addedPoint = 0;

            if (_this6.$root.authProfile.points < 100) {
              _this6.$root.authProfile.points += 25;
              _this6.$root.addedPoint = 25;
            } else {
              _this6.$root.authProfile.points += 10;
              _this6.$root.addedPoint = 10;
            }

            _this6.$root.showRewardBoard = true;
            _this6.$root.hubComponents.loadingPost = false;
          }
        })["catch"](function (error) {
          _this6.showAlert('Oops!', 'Unable to save post,please try again', 'error');
  ...
  return _c(
    ...
    [
        ...
        [
          _c(
            ...
            [
              ...
              _vm._v(" "),
              _c("div", { staticClass: "col-12 py-0  mt-n3 " }, [
                _c(
                  "span",
                  {
                    staticStyle: {
              ...
              _c(
                ...
                [
                  _c(
                    ...
                    [_vm._v("Select from project list")]
                  ),
                  _vm._v(" "),
                  _vm.projectArray.length > 0
                    ? [
                        _c("v-select", {
                          staticStyle: { "font-size": "13px" },
                          attrs: {
                    ...
                    : [
                        _c(
                          "div",
                          {
                            staticClass: "mb-1 mt-3 text-center",
                            staticStyle: {
                              "font-size": "13px",
                              color: "grey",
                              "font-family": "BodyFont"
              ...
              _c(
                "div",
                { staticClass: "col-12 py-1 my-0 mt-n3 px-2 " },
                [
                  _c(
                    "span",
                    {
              ...
              _c(
                "div",
                {
                  staticClass: " col-12 py-1 mt-1 my-0 px-2 pt-3",
      ...
      _c("iframe", {
        ...
        attrs: { id: "testiframe", src: _vm.projectUrl },
        on: { load: _vm.setFrameLoaded }
      })
    ],
    1
  )
