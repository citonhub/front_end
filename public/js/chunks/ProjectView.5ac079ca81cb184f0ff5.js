...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: (_methods = {
    ...
    scrollToComment: function scrollToComment(comment) {
      ...
      var container = document.querySelector('#commentScrollerPost');
      var commentElement = document.querySelector('#commentBox' + comment.id);
      container.scroll(0, findPos(commentElement));
    },
      ...
      if (this.commentValue != '') {
        ...
        axios.post('/comment-hub-post', formData).then(function (response) {
          if (response.status == 201) {
            _this4.comments.push(response.data.data);
                ...
                : [
                    _vm.comments.length == 0
                      ...
                      : [
                          _vm._l(_vm.comments, function(comment, index) {
                            return _c(
                              "div",
                              {
                                ...
                                attrs: { id: "commentBox" + comment.id }
                              },
                              [
                          ...
                          _vm._v(" "),
                          _c("div", { staticClass: "my-4 py-3 col-12" })
                        ]
                  ]
            ],
            2
