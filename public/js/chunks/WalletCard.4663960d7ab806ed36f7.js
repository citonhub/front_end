  ...
  return _c("div", [
    ...
    _c("div", { staticClass: "col-lg-10 offset-lg-1 py-0 pb-2 px-1 px-md-2" }, [
      ...
      _c("div", { staticClass: "col-12 d-flex flex-row" }, [
        ...
        _c(
          "div",
          { staticClass: "col-lg-4 text-center d-flex flex-column" },
          [
            _c(
              "v-card",
              {
            ...
            _c("div", { staticClass: "col-12 px-0 d-flex flex-row" }, [
              _c(
                "div",
                { staticClass: "col-6 py-0 px-0" },
                [
                  _c(
                    "v-btn",
                    { staticClass: "bg-primary", attrs: { small: "" } },
                    [
                      _c(
                        "span",
                        {
        ...
        _c(
          "div",
          {
            staticClass: "col-lg-4 d-flex flex-column px-0",
            staticStyle: {
              "align-items": "center",
              "justify-content": "center"
            }
          ...
          [
            _c("v-btn", { staticClass: "bg-primary", attrs: { small: "" } }, [
              _c(
                "span",
                {
                  staticStyle: {
