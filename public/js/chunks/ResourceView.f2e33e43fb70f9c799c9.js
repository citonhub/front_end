...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    showContent: function showContent(content) {//     this.$router.push({ path: '/channels/e_resources/content/'+ this.$route.params.spaceId });
    ...
    fetchSpaceInfo: function fetchSpaceInfo() {
      ...
      axios.get('/fetch-space-info-' + this.$route.params.spaceId).then(function (response) {
        if (response.status == 200) {
          ...
          _this2.mainContent = _this2.spaceData.name + ' Resources';
                                  ...
                                  "div",
                                  {
                                    ...
                                    on: {
                                      click: function($event) {
                                        return _vm.goToChannel(resource)
                                      }
                                    }
                                  },
                                  [
