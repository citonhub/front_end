...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    selectDiaryNote: function selectDiaryNote(subSpace) {},
    ...
    checkForNewNotes: function checkForNewNotes() {
      ...
      axios.get('/fetch-diary-notes-' + this.$root.selectedSpace.bot_data.bot_id).then(function (response) {
        if (response.status == 200) {
          _this2.$root.LocalStore('diary_notes_' + _this2.$root.selectedSpace.space_id + _this2.$root.username, response.data);

          var finalResult = response.data.diary_notes;
          _this2.diaryNotes = finalResult;
        }
      })["catch"](function (error) {});
    },
                            ...
                            [
                              _c("div", { staticClass: "row py-0 my-0" }, [
                                ...
                                _c(
                                  "div",
                                  {
                                    staticClass: "col-10 py-0 my-0 text-center"
                                  },
                                  [
                                    _c(
                                      "span",
