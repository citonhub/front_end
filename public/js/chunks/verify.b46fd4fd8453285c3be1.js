...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  }), _defineProperty(_methods, "resendMail", function resendMail() {
    var _this3 = this;
  ...
  }), _defineProperty(_methods, "verify", function verify() {
    var _this4 = this;
    ...
    axios.post('/verify-user-email', {
      ...
      if (response.status == 200) {
        if (response.data.status == 'verified') {
          ...
          _this4.showAlert('Oops!', 'Wrong code, give it another shot.', 'error');
        }
      } else {
