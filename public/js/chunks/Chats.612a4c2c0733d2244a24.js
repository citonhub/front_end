...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    fetchMessages: function fetchMessages() {
      ...
      if (this.$root.checkauthroot == 'auth') {
        ...
        var storedMsg = this.$root.getLocalStore('full_' + this.$route.params.spaceId + this.$root.username);
        storedMsg.then(function (result) {
          if (result != null) {
            ...
            setTimeout(function () {
              if (_this10.$root.selectedSpace.type == 'Bot' || _this10.$root.selectedSpace.type == 'Direct') {
            ...
            axios.get('/fetch-space-messages-' + _this10.$route.params.space_id).then(function (response) {
              if (response.status == 200) {
          ...
          if (_this10.$root.selectedSpace.general_spaceId != undefined) {
            _this10.getMemberUpdates(_this10.$root.selectedSpace.general_spaceId);
          }
        });
      }
    }
  ...
  checkForUnreadMessagesDisconnected: function checkForUnreadMessagesDisconnected() {
    if (this.chatIsOpen) {
      var unreadStoredMsg = _this.$root.getLocalStore('unread' + _this.$route.params.spaceId + _this.$root.username);
