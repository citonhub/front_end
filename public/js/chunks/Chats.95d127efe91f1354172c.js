  ...
  methods: {
    ...
    controlChatPath: function controlChatPath() {
      ...
      if (!this.$root.isLogged) {
        ...
        if (this.$route.params.spaceId != undefined && this.$router.currentRoute.path.indexOf('resources') >= 0 || this.$route.params.spaceId != undefined && this.$router.currentRoute.path.indexOf('e_resources') >= 0) {
          this.$router.push({
            path: '/channels/e_resources/view/' + this.$route.params.spaceId
          });
          return;
