...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    joinChallenge: function joinChallenge() {
      var _this2 = this;
    ...
    fetchChallenge: function fetchChallenge() {
      ...
      storedProjectData.then(function (result) {
        if (result != null) {
          ...
          _this5.$root.selectedChallenge = finalResult;
          ...
          _this5.loadingChallenge = false; // this.checkForNewChallengeData();
        } else {
          axios.get('/fetch-challenge-data/' + _this5.$route.params.challenge_id).then(function (response) {
            if (response.status == 200) {
