...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getChallenges: _.debounce(function (query) {
      ...
      axios.get('/get-challenges/' + query).then(function (response) {
        if (response.status == 200) {
          _this.$root.challengeSearchList = response.data.challenges;
          _this.$root.challengeListComponent.loadingSearchChallenges = false;
        }
            ...
            [
              _c("div", { staticClass: "row" }, [
                _c(
                  ...
                  [
                    this.$router.currentRoute.path.indexOf("notifications") <= 0
                      ? [
                          _c("v-text-field", {
