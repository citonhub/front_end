  ...
  created: function created() {
    ...
    axios.get('/get-challenges').then(function (response) {
      if (response.status == 200) {
        ...
        _this.challenges.push(response.data);
      } else {
  ...
  return _c(
    ...
    [
      ...
      _c(
        "div",
        {
          staticClass: "col-lg-10 offset-lg-1 pb-1 pt-0 col-md-10 offset-md-1  "
        },
        [
          _c(
            "div",
            ...
            [
              _c(
                "v-card",
                {
                  staticClass: "col-12 py-0 px-md-0 px-1 mb-2 d-flex flex-row "
                },
                [
              ...
              _c(
                ...
                [
                  ...
                  _vm._v(" "),
                  _c("div", { staticClass: "mr-1 py-2 d-block d-md-none" }, [
                    _c("div", {
                      staticStyle: {
                        "border-radius": "10px",
                        height: "50px",
