...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    saveResourceContentOrder: function saveResourceContentOrder() {
      ...
      var ResourcesArray = [];
      this.contentData.forEach(function (content) {
        ResourcesArray.push(content.id);
      });
      axios.post('/save-resources-content-order', {
        space_id: this.$root.selectedResource.resource_id,
        contents: ResourcesArray
        ...
        _vm._b(
          {
            ...
            model: {
              value: _vm.contentData,
              callback: function($$v) {
                _vm.contentData = $$v
              },
              expression: "contentData"
            }
          },
          "draggable",
          _vm.dragOptions,
