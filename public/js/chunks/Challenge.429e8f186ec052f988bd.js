  ...
  methods: {
    ...
    imageStyle: function imageStyle(height, data) {
      if (data.background_color == null) {
        var styleString = "width:100%;height:" + height + "px;position:absolute; left:0%; border:1px solid transparent;background-repeat: no-repeat; box-shadow: 0px 0px 8px -2px rgba(60, 135, 205, 0.25);background-size:cover; ";
        ...
        var _styleString = "width:100%;height:" + height + "px;position:absolute; left:0%; border:1px solid transparent;background-repeat: no-repeat; box-shadow: 0px 0px 8px -2px rgba(60, 135, 205, 0.25);background-size:cover; ";
  ...
  return _c(
    ...
    [
      _c(
        ...
        [
          _c("div", { style: _vm.imageStyle(110, _vm.source) }, [
            _c(
              "div",
              {
                  ...
                  [
                    _c(
                      "v-chip",
                      {
                        ...
                        attrs: { color: "warning", dense: "", "x-small": "" }
                      },
                      [
                        _vm._v(
                          "\n     \n    " +
          ...
          _c(
            "div",
            { staticClass: "px-2", staticStyle: { "margin-top": "115px" } },
            [
              ...
              _c(
                "div",
                {
                  staticClass: " py-0 my-0 px-2 text-left",
                  staticStyle: {
                    height: "60px",
                    "text-overflow": "ellipsis",
                    "overflow-y": "hidden"
              ...
              _vm._v(" "),
              _c("div", { staticClass: " py-0 my-0 text-center mt-1" }, [
                _c(
                  "div",
                  {
                    staticStyle: {
                  ...
                  [
                    _c("v-icon", { staticStyle: { "font-size": "17px" } }, [
