...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    generateRegex: function generateRegex() {
      var _ = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module 'regexgen.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

      var regex = _(_.capture('input\(\''), _.capture(_.anything()), _.capture('\'\)'));

      var regexString = _(_.anyCharBut('input\(\'\)'));
    ...
    showCode: function showCode(codeBox) {
      ...
      if (this.$root.SelectedCodeBox.type == 'back-end') {
        ...
        this.$root.EditorLanguage = _codeData.language_type;
        this.$root.codeEditorContent = _codeData.content;
