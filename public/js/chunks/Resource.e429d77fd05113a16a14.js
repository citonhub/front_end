                            ...
                            : [
                                _c(
                                  "v-icon",
                                  {
                                    on: {
                                      click: function($event) {
                                        return _vm.showOptions(content)
                                      }
                                    }
                                  },
                                  [_vm._v("las la-trash-alt")]
                                )
                              ]
                        ],
                        2
