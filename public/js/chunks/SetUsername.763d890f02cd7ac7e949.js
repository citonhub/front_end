...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  }), _defineProperty(_methods, "showVerifiedAlert", function showVerifiedAlert() {
    this.showAlert('Nice!', 'Email verified', 'success');
  }), _defineProperty(_methods, "setUsername", function setUsername() {
    var _this3 = this;
      ...
      axios.post('/check-if-username-exist', {
        ...
        if (response.status == 200) {
          if (response.data == 'exist') {
            ...
            _this3.showAlert('Oops!', 'Username exists. please, change username and try again', 'error');
          } else {
            _this3.loginuser();
          }
        } else {
  ...
  }), _defineProperty(_methods, "loginuser", function loginuser() {
    var _this4 = this;
