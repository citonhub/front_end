...
var render = function() {
  ...
  return _c(
    "v-card",
    { staticClass: "col-lg-4  py-2 pt-4  col-md-8 text-center" },
    [
      ...
      _c(
        ...
        [
          _vm._v(
            "You have " +
              _vm._s(_vm.calculateLevel(_vm.that.$root.authProfile.points)[1]) +
      ...
      _c(
        ...
        [
          _vm._v(
            _vm._s(_vm.calculateLevel(_vm.that.$root.authProfile.points)[0]) +
              " dev"
          )
        ]
      )
