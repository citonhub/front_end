...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    showFullMsg: function showFullMsg(message) {
      document.querySelector('.moreContentbtn' + message.message_id).style.visibility = 'hidden';
      document.querySelector('.shortContent' + message.message_id).style.display = 'none';
      document.querySelector('.fullContent' + message.message_id).style.display = 'inline-block';
    },
                  ...
                  _c(
                    ...
                    [
                      _vm.checkIfMsgIsLong(_vm.source)
                        ? [
                            _c("span", {
                              class: "shortContent" + _vm.source.message_id,
                              staticStyle: {
                                color: "white",
                                "font-size": "13px"
                              },
