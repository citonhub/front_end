  ...
  methods: {
    ...
    startrecord: function startrecord() {
      ...
      navigator.mediaDevices.getUserMedia({
        ...
        _this.showAlert(5000, 'Recording Started');
      });
    },
    ...
    sendMessage: function sendMessage() {
      ...
      this.$root.LocalStore('full_' + this.$route.params.spaceId + this.$root.username, this.$root.spaceFullData.messages);
...
var render = function() {
  ...
  return _c("div", { staticClass: "row px-md-3 py-0" }, [
    _c("div", [_c("VEmojiPicker", { on: { select: _vm.selectEmoji } })], 1),
    _vm._v(" "),
    _c(
      "div",
      {
      ...
      [
        ...
        _c("textarea", {
          ...
          on: { input: _vm.update, keydown: _vm.handelkeyAct }
        }),
        _vm._v(" "),
        _vm.showSend
          ? _c(
