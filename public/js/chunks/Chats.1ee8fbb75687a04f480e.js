...
var ChatShare = function ChatShare() {
  return Promise.all(/*! import() | ChatShare */[__webpack_require__.e("vendors~Board~ChatShare~ForgotPassword~Hub~ProfilePage~ResetPassword~SetUsername~login~register~verify"), __webpack_require__.e("vendors~ChatShare~login"), __webpack_require__.e("ChatShare")]).then(__webpack_require__.bind(null, /*! ./Share.vue */ "./resources/js/components/chats/Share.vue"));
};
          ...
          if (result != null) {
            ...
            setTimeout(function () {
              if (_this10.$root.selectedSpace.type == 'Channel' || _this10.$root.selectedSpace.type == 'Team') {
                _this10.$root.msgScrollComponent.messageContainer.scrollToItem(_this10.$root.Messages.length);

                _this10.$refs.messageContainersmall.scrollToItem(_this10.$root.Messages.length);
              } else {
