...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    calculateLevel: function calculateLevel() {
      ...
      } else if (this.xp >= 200 && this.xp <= 199) {
        this.level = 'Junior';
        this.nextLevel = 'Intermediate';
        this.xpLeft = 200 - this.xp;
        this.barValue = this.xp / 200 * 100;
        this.pic = '/imgs/intermediate.svg';
        this.pic1 = '/imgs/junior.svg';
      } else if (this.xp >= 300 && this.xp <= 399) {
        this.level = 'Intermediate';
        this.nextLevel = 'Senior';
        this.xpLeft = 400 - this.xp;
        this.barValue = this.xp / 400 * 100;
        this.pic = '/imgs/senior.svg';
        this.pic1 = '/imgs/intermediate.svg';
      } else if (this.xp >= 400 && this.xp <= 499) {
        this.level = 'Senior';
        this.nextLevel = 'Expert';
        this.xpLeft = 500 - this.xp;
        this.barValue = this.xp / 500 * 100;
        this.pic = '/imgs/expert.svg';
        this.pic1 = '/imgs/senior.svg';
      } else if (this.xp >= 500 && this.xp <= 599) {
        this.level = 'Expert';
      ...
      } else if (this.xp >= 600 && this.xp <= 699) {
        this.level = 'Super Dev';
        this.nextLevel = 'Super';
        this.xpLeft = 700 - this.xp;
        this.barValue = this.xp / 700 * 100;
        this.pic = '';
                                                ...
                                                [
                                                  _c(
                                                    "v-btn",
                                                    {
                                                      ...
                                                      on: {
                                                        click: _vm.showAddPost
                                                      }
                                                    },
                                                    [_vm._v("Share a project")]
                                                  )
                                                ],
                                                1
                                              )
