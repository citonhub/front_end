...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    textProject: function textProject() {
      var iframe = document.querySelector("#testiframe");
      ...
      iframe.onload = function (event) {
        ...
        var isLoaded = event.target.contentWindow.window.length; // 0 or 1
      ...
      if (this.$refs.addPost.validate()) {
        ...
        axios.post('/save-hub-post', formData, {
          ...
          if (response.status == 200) {
            ...
            _this5.$root.formerPoint = _this5.$root.authProfile.points;
            _this5.$root.addedPoint = 0;

            if (_this5.$root.authProfile.points < 100) {
              _this5.$root.authProfile.points += 25;
              _this5.$root.addedPoint = 25;
            } else {
              _this5.$root.authProfile.points += 10;
              _this5.$root.addedPoint = 10;
            }

            _this5.$root.showRewardBoard = true;
            _this5.$root.hubComponents.loadingPost = false;
          }
        })["catch"](function (error) {
                    ...
                    "v-btn",
                    {
                      ...
                      on: {
                        click: function($event) {
                          ...
                          return _vm.handleProject($event)
                        }
                      }
                    },
                    [_vm._v("\n             Send\n             ")]
