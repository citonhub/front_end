...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    reactToKey: function reactToKey(e) {
      console.log(e);
    },
    ...
    reactToFocus: function reactToFocus() {},
    ...
    startrecord: function startrecord() {
      ...
      navigator.mediaDevices.getUserMedia({
        ...
        _this2.showAlert(5000, 'Recording Started');
      });
    },
    ...
    isTyping: function isTyping() {
      ...
      var channel = window.Echo.join('space.' + this.$route.params.spaceId);
      setTimeout(function () {
        channel.whisper('typing', {
          user: _this3.$root.username,
          typing: true,
          spaceId: _this3.$route.params.spaceId
        });
      }, 1000);
      setTimeout(function () {
        channel.whisper('typing', {
