...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    sendMessage: function sendMessage() {
      ...
      if (this.codeContent != '') {
        var _Data = null;
        this.$root.NewMsg = this.makeMessage('code', _Data);
      ...
      if (this.videoUrl != '') {
        var _Data2 = null;
        this.$root.NewMsg = this.makeMessage('video', _Data2);
      ...
      if (this.audioUrl != '') {
        var _Data3 = null;
        this.$root.NewMsg = this.makeMessage('audio', _Data3);
      ...
      if (this.fileUrl != '') {
        var _Data4 = null;
        this.$root.NewMsg = this.makeMessage('file', _Data4);
      ...
      if (this.showShareProject == true) {
        var _Data5 = null;
        this.$root.NewMsg = this.makeMessage('project', _Data5);
    ...
    [
      ...
      _c("div", [
        _c("div", { staticStyle: { "font-size": "13px" } }, [
          _vm._v("Click on image to edit")
        ]),
        _vm._v(" "),
        _c(
          "div",
          {
            staticClass: "col-lg-10 offset-lg-1 d-flex flex-row flex-wrap",
            staticStyle: {
              "align-items": "center",
              ...
              ? _c(
                  ...
                  [
                    _c(
                      ...
                      {
                        style:
                          "border:2px solid #3E8893; border-radius:10px; height:120px; background-image:url(" +
                          _vm.image1 +
