...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    followDiary: function followDiary(diary) {
      ...
      this.$root.suggestedDiaries.map(function (eachdiary) {
    ...
    getInterests: function getInterests() {
      ...
      axios.post('/save-user-interest').then(function (response) {
        if (response.status == 200) {
          _this2.$root.suggestedDiaries = response.data.suggested_diaries;

          _this2.$root.suggestedDiaries.map(function (diary) {
            diary.following = false;
          });

          _this2.$root.suggestedDiaries.sort(function (a, b) {
