  ...
  methods: {
    ...
    imageStyle: function imageStyle(width, data) {
      if (data.background_color == null) {
        var styleString = "border-radius:50%;height:100%;width:" + width + "px;background-size:cover;border-top-left-radius:7px;border-bottom-left-radius:7px; background-repeat: no-repeat; ";
        ...
        var _styleString = "border-radius:50%;height:100%;width:" + width + "px;background-size:cover;border-top-left-radius:7px;border-bottom-left-radius:7px; background-repeat: no-repeat; ";
                        ...
                        _c(
                          ...
                          [
                            ...
                            _c(
                              ...
                              [_vm._v(_vm._s(_vm.checkDuelStatus))]
                            ),
                            _vm._v(" "),
                            _c(
                              "v-icon",
