          ...
          _c(
            ...
            [
              ...
              _c(
                ...
                [
                  _c("v-text-field", {
                    ...
                    model: {
                      value: this.$root.noteContent.subject.tag_name,
                      callback: function($$v) {
                        _vm.$set(
                          this.$root.noteContent.subject,
                          "tag_name",
                          $$v
                        )
                      },
                      expression: "this.$root.noteContent.subject.tag_name"
                    }
                  })
                ],
                1
              ...
              _c(
                ...
                [
                  _c("v-combobox", {
                    ...
                    model: {
                      value: this.$root.noteContent.keywords.pattern_content,
                      callback: function($$v) {
                        _vm.$set(
                          this.$root.noteContent.keywords,
                          "pattern_content",
                          $$v
                        )
                      },
                      expression:
                        "this.$root.noteContent.keywords.pattern_content"
                    }
                  })
                ],
                1
              ...
              _c(
                ...
                [
                  _vm._l(this.$root.noteContent.pages, function(
                    content,
                    index
                  ) {
                    return _c(
              ...
              _c(
                ...
                [
                  _c("v-text-field", {
                    ...
                    model: {
                      value: this.$root.noteContent.pages[_vm.selectedContentId]
                        .name,
                      callback: function($$v) {
                        _vm.$set(
                          this.$root.noteContent.pages[_vm.selectedContentId],
                          "name",
                          $$v
                        )
                      },
                      expression:
                        "this.$root.noteContent.pages[selectedContentId].name"
                    }
                  })
                ],
                1
              ...
              _vm._v(" "),
              this.$root.noteContent.pages[_vm.selectedContentId].contents
                .length > 0
                ? [
                    _c(
                      "draggable",
                      _vm._b(
                        {
                          ...
                          model: {
                            value: this.$root.noteContent.pages[
                              _vm.selectedContentId
                            ].contents,
                            callback: function($$v) {
                              _vm.$set(
                                this.$root.noteContent.pages[
                                  _vm.selectedContentId
                                ],
                                "contents",
                                $$v
                            ...
                            expression:
                              "this.$root.noteContent.pages[selectedContentId].contents"
                          }
                        },
                        "draggable",
                        _vm.dragOptions,
