...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    generateOnlineUsersList: function generateOnlineUsersList() {
      ...
      var onlineUserList = [];
      this.$root.selectedSpaceMembers.forEach(function (member) {
        var userData = _this6.$root.globalUsers.filter(function (user) {
    ...
    runCode: function runCode() {
      ...
      if (this.selectedLangId == 0 || this.language == 'HTML') {
        ...
        if (this.$root.projectData.project_panel.panel_language == '39' || this.$root.projectData.project_panel.panel_language == '100') {
          var InputRegex = /(input\(')(.*)('\))/g;
          var InputFound = this.$root.projectData.project_files.code_files[0].content.match(InputRegex);
          ...
          if (InputFound.length > 0) {
            ...
            InputFound.forEach(function (input) {
              ...
              _this7.$root.projectInputData.push(inputData);
            });
    ...
    runCodeOnSandbox: function runCodeOnSandbox(codeContent) {
      ...
      axios.post('/run-code-on-sandbox', {
        ...
        if (response.status == 200) {
          ...
          if (response.data[0].status.description == 'Accepted') {
            _this8.ResultCode = response.data[0].stdout;
          } else if (response.data[0].status.description == 'In Queue') {
            _this8.ResultCode = 'In Queue...';

            _this8.checkResponse(token);
          } else if (response.data[0].status.description == 'Processing') {
            _this8.ResultCode = 'Processing...';
          ...
          _this8.sendCodeRunning();
        }
      })["catch"](function (error) {
        _this8.ResultCode = 'An issue occured,unable to run on sandbox...';
    ...
    _vm.showCode
      ...
      : _c(
          ...
          [
            ...
            _vm._v(" "),
            _vm.selectedLangId == 0 || _vm.selectedLangId == 35
              ? _c("iframe", {
                  staticStyle: {
                    border: "0",
                    height: "91%",
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_sass_loader_dist_cjs_js_ref_6_3_node_modules_vue_loader_lib_index_js_vue_loader_options_CodeEditorChat_vue_vue_type_style_index_0_id_0340c691_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_sass_loader_dist_cjs_js_ref_6_3_node_modules_vue_loader_lib_index_js_vue_loader_options_CodeEditorChat_vue_vue_type_style_index_0_id_0340c691_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_sass_loader_dist_cjs_js_ref_6_3_node_modules_vue_loader_lib_index_js_vue_loader_options_CodeEditorChat_vue_vue_type_style_index_0_id_0340c691_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default.a); 
