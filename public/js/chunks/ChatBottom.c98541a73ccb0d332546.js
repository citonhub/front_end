        ...
        !_vm.recording
          ? [
              _c("v-textarea", {
                ...
                attrs: {
                  "prepend-inner-icon": "las la-grin",
                  rounded: _vm.screenType == "large" ? false : true,
                  "append-icon":
                    _vm.showAttachment && this.$root.selectedSpace.type != "Bot"
                      ? "las la-paperclip"
                      : "",
                  placeholder: _vm.$t("general.type_here")
                },
                on: {
                  input: _vm.update,
                  "click:prepend-inner": function($event) {
                    return _vm.toggleEmoji()
                  },
                  "click:append": function($event) {
                    return _vm.showShareBoard()
                  },
