...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    deleteMessage: function deleteMessage() {
      ...
      var storedMsg = this.$root.getLocalStore('full_space_' + message.space_id + this.$root.username);
      storedMsg.then(function (result) {
        if (result != null) {
          ...
          _this.$root.Messages = _this.$root.handleResults(remainingMessages);

          _this.$root.LocalStore('full_space_' + message.space_id + _this.$root.username, finalResult);
        }
