            ...
            if (result != null) {
              ...
              axios.get('/fetch-chat-list/' + _this4.$root.userDeviceId).then(function (response) {
                if (response.status == 200) {
                  ...
                  _this4.$root.LocalStore('user_chat_list' + _this4.$root.username, response.data, false, 'sort_chat');
      ...
      if (this.$root.checkauthroot == 'auth') {
        ...
        storedMsg.then(function (result) {
          if (result != null) {
            ...
            _this11.messageIsDone = true; // check for unsent messages and resend
