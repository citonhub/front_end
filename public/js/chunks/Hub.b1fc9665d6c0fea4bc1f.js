...
var ProjectView = function ProjectView() {
  return Promise.all(/*! import() | ProjectView */[__webpack_require__.e("vendors~ChallengesList~ProjectView"), __webpack_require__.e("ProjectView")]).then(__webpack_require__.bind(null, /*! ./ProjectView.vue */ "./resources/js/components/Hub/ProjectView.vue"));
};
...
var ProfileView = function ProfileView() {
  return Promise.all(/*! import() | ProfileView */[__webpack_require__.e("vendors~AddGem~AddProject~ChallengePanel~ChallengesCreate~DiaryBoard~FeedForm~ForgotPassword~GetDiar~eb2f57d7"), __webpack_require__.e("vendors~ForgotPassword~Hub~ProfilePage~ResetPassword~SetUsername~register~verify"), __webpack_require__.e("ProfilePage")]).then(__webpack_require__.bind(null, /*! ../Profile/ProfilePage.vue */ "./resources/js/components/Profile/ProfilePage.vue"));
};
