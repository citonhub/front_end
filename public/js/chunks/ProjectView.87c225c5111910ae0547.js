...
var render = function() {
  ...
  return _c("div", { staticClass: "row px-0" }, [
    _c(
      "div",
      {
        staticClass:
          "col-lg-6 offset-lg-3 py-1 py-md-2 fixed-top d-flex flex-row px-2",
        staticStyle: {
          position: "sticky",
          background: "white",
          "z-index": "99999999",
      ...
      [
        ...
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _c("v-btn", { attrs: { icon: "" }, on: { click: _vm.likePost } }, [
              _c("i", {
                class:
    ...
    _vm._v(" "),
    _c("div", { staticClass: "col-lg-6 offset-lg-3 py-2 px-0 text-center" }, [
      _c(
        "span",
        {
