        ...
        ? [
            this.$root.TopBarComponentBoard.searchContent.length > 0
              ...
              : [
                  ...
                  !_vm.loadingProject
                    ? [
                        this.$root.projectList.user_projects.length == 0 &&
                        this.$root.projectList.contributor_projects.length ==
                          0 &&
                        this.$root.projectList.pinned_projects.length == 0
                          ? [
                              _c(
                                ...
                                {
                                  staticClass:
                                    "col-md-6 offset-md-3 px-md-4 py-1 px-2 mt-3 text-center d-flex flex-column "
                                },
                                [
                                  _vm._m(1),
                                  _vm._v(" "),
                          ...
                          : [
                              _c(
                                ...
                                {
                                  staticClass:
                                    "col-md-10 offset-md-1 py-1 px-2 "
                                },
                                [
                                  _c(
                                    "div",
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c(
      ...
      [
        _vm._v(
          "\n                      Build, test and collaborate on projects to improve your skill. You can build project in over "
        ),
        _c("b", [_vm._v("25 programming languages")]),
        _vm._v(
