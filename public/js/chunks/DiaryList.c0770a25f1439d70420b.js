...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getDiaryContent: function getDiaryContent(diary) {
      ...
      axios.get('/get-diary-data-' + diary.bot_id).then(function (response) {
        if (response.status == 200) {
          _this.$router.push({
            path: '/diary/board/' + _this.$route.params.bot_id + '/content'
          });
        }
      });
    },
    imageStyle: function imageStyle(size, data) {
      if (data.background_color == null) {
        var styleString = "height:" + size + ";width:" + size + "px;background-size:cover;border-radius:50%;background-repeat: no-repeat; ";
        ...
        var _styleString = "height:" + size + ";width:" + size + "px;background-size:cover;border-radius:50%;background-repeat: no-repeat; ";
    ...
    fetchUserDiary: function fetchUserDiary() {
      ...
      storedDiary.then(function (result) {
        if (result != null) {
          ...
          _this2.loadingDiary = false; // this.checkForNewDiary();
        } else {
                      ...
                      _c(
                        ...
                        [
                          _c("div", { staticClass: "mr-2 py-2" }, [
                            _c("div", { style: _vm.imageStyle(45, diary) })
                          ]),
                          _vm._v(" "),
                          _c(
                            "div",
