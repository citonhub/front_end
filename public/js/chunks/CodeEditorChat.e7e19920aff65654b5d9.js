...
/* harmony default export */ __webpack_exports__["default"] = ({
  mounted: function mounted() {
    this.detectchange(this.language); // this.$root.codeBoxOpened = true;
    // this.setCodeContent();
  ...
  methods: {
    ...
    showAdminUsers: function showAdminUsers() {
      this.showAdminOptions = true;
      this.adminMembers = this.$root.selectedSpaceMembers.filter(function (member) {
      ...
      ? _c(
          ...
          [
            _c(
              "div",
              {
                staticClass: "col-12 py-1 my-0 fixed-top",
                ...
                _c("div", { staticClass: "row py-1 my-0 px-1" }, [
                  _c(
                    "div",
                    {
                      ...
                      staticStyle: { "border-bottom": "2px solid #4495a2" }
                    },
                    [
                      _c(
                        "v-btn",
                        {
                          attrs: { icon: "", color: "#4495a2" },
                          on: { click: _vm.goBack }
                        },
  ...
  function() {
    ...
    return _c(
      "div",
      {
        ...
        staticStyle: {
          "border-bottom": "2px solid #4495a2",
          "align-items": "center",
          "justify-content": "center"
        }
      },
