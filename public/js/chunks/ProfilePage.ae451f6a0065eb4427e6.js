...
/* harmony default export */ __webpack_exports__["default"] = ({
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _this.$root.showMobileHub = false;
              _context.next = 3;
              return _this.setUsername();

            case 3:
              _this.fetchProfileContent();
  ...
  methods: {
    ...
    fetchProfileContent: function fetchProfileContent() {
      ...
      axios.get('/fetch-profile-' + this.username).then(function (response) {
        if (response.status == 200) {
          ...
          _this2.xp = _this2.profileData.coins;
          var point = _this2.profileData.coins;

          if (_this2.xp >= 50 && _this2.xp <= 99) {
            _this2.level = 'Newbie';
            _this2.nextLevel = 'Junior';
            _this2.xpLeft = 100 - _this2.xp;
            _this2.barValue = _this2.xp / 100 * 100;
            _this2.pic = '/imgs/junior.svg';
            _this2.pic1 = '/imgs/newbie.svg';
          } else if (_this2.xp >= 100 && _this2.xp <= 999) {
            _this2.level = 'Junior';
            _this2.nextLevel = 'Intermediate';
            _this2.xpLeft = 1000 - _this2.xp;
            _this2.barValue = _this2.xp / 1000 * 100;
            _this2.pic = '/imgs/intermediate.svg';
            _this2.pic1 = '/imgs/junior.svg';
          } else if (_this2.xp >= 1000 && _this2.xp <= 4999) {
            _this2.level = 'Intermediate';
            _this2.nextLevel = 'Senior';
            _this2.xpLeft = 5000 - _this2.xp;
            _this2.barValue = _this2.xp / 5000 * 100;
            _this2.pic = '/imgs/senior.svg';
            _this2.pic1 = '/imgs/intermediate.svg';
          } else if (_this2.xp >= 5000 && _this2.xp <= 9999) {
            _this2.level = 'Senior';
            _this2.nextLevel = 'Expert';
            _this2.xpLeft = 10000 - _this2.xp;
            _this2.barValue = _this2.xp / 10000 * 100;
            _this2.pic = '/imgs/expert.svg';
            _this2.pic1 = '/imgs/senior.svg';
          } else if (_this2.xp >= 10000 && _this2.xp <= 14999) {
            _this2.level = 'Expert';
            _this2.nextLevel = 'Super Dev';
            _this2.xpLeft = 15000 - _this2.xp;
            _this2.barValue = _this2.xp / 15000 * 100;
            _this2.pic = '/imgs/super_dev.svg';
            _this2.pic1 = '/imgs/expert.svg';
          } else if (_this2.xp >= 15000 && _this2.xp <= 100000) {
            _this2.level = 'Super Dev';
            _this2.nextLevel = 'Super';
            _this2.xpLeft = 100000 - _this2.xp;
            _this2.barValue = _this2.xp / 100000 * 100;
            _this2.pic = '';
            _this2.pic1 = '/imgs/super_dev.svg';
          }
        }
      });
    },
