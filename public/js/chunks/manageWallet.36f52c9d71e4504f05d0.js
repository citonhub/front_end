        ...
        _c("div", { staticClass: "row" }, [
          _c(
            ...
            [
              ...
              _vm._v(" "),
              _c("h5", [
                _vm._v(_vm._s(_vm.that.$root.selectedPaymentCard.name))
              ])
            ],
            1
          ),
              ...
              _c(
                ...
                [
                  ...
                  _c(
                    ...
                    [
                      _vm._l(this.$root.payoutAccounts, function(
                        payout,
                        index
                      ) {
                        return _c(
                          ...
                          [
                            ...
                            _vm._v(" " + _vm._s(payout.bank_name) + ", "),
                            _c(
                              "b",
                              { staticStyle: { "font-family": "MediumFont" } },
              ...
              _c(
                ...
                [
                  ...
                  _c(
                    ...
                    _vm._l(this.$root.planSubscriptions, function(bill, index) {
                      return _c(
                        "v-alert",
                        {
                          key: index,
                          ...
                          _c(
                            ...
                            [
                              _c("span", {
                                domProps: {
                                  innerHTML: _vm._s(
                                    _vm.currencyToCharacter(bill.currency)
                                  )
                                }
                              }),
                              _vm._v(" " + _vm._s(_vm.formatMoney(bill.amount)))
                            ]
                          ),
                          _vm._v(" "),
                          _c(
                            ...
                            [_vm._v(_vm._s(bill.type))]
                          ),
                          _vm._v(" for " + _vm._s(bill.name) + "\n    ")
                        ]
                      )
                    }),
                    1
