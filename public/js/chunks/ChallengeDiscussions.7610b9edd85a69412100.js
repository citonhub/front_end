...
var render = function() {
  ...
  return _c("div", [
    _c(
      ...
      {
        staticClass:
          "col-lg-10 offset-lg-1 scroller px-md-2 px-1 py-1 d-flex flex-column",
        staticStyle: {
          background: "#E1F0FC",
          position: "absolute",
          height: "100%",
      ...
      _vm._l(_vm.comments, function(comment, index) {
        return _c("div", { key: index, staticClass: "col-12 px-0" }, [
          _c("div", { staticClass: "row" }, [
            comment.username != this.$root.username
              ? _c(
                  "div",
                  {
                  ...
                  [
                    _c("div", { staticClass: "row" }, [
                      _c(
                        ...
                        [
                          _c("div", { style: _vm.imageStyleUser(30, comment) }),
                          _vm._v(" "),
                          _c(
                            "v-card",
                            {
                                ...
                                [
                                  ...
                                  _c(
                                    ...
                                    [
                                      _vm._v(
                                        _vm._s(
                                          _vm.checkDatereal(comment.created_at)
                                        )
                                      )
                                    ]
                                  )
    ...
    _c(
      "div",
      {
        staticClass: "fixed-bottom col-lg-10 d-md-block d-none offset-lg-1",
        staticStyle: { "font-family": "BodyFont", position: "absolute" }
      },
      [
        _c(
          "div",
