...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    showFullMsg: function showFullMsg(message) {
      document.querySelector('#moreContentbtn' + message.message_id + this.screenType).style.visibility = 'hidden !important';
      document.querySelector('#shortContent' + message.message_id + this.screenType).style.display = 'none !important';
      console.log(document.querySelector('#fullContent' + message.message_id + this.screenType));
      document.querySelector('#fullContent' + message.message_id + this.screenType).style.display = 'inline-block !important';
    },
                      ...
                      _vm.checkIfMsgIsLong(_vm.source)
                        ? [
                            _c("span", {
                              ...
                              domProps: {
                                innerHTML: _vm._s(
                                  _vm.shortenContent(_vm.source.content, 300)
                                )
                              }
                            }),
                            _vm._v(" "),
                              ...
                              "span",
                              {
                                ...
                                on: {
                                  click: function($event) {
                                    ...
                                    return _vm.showFullMsg(_vm.source)
                                  }
                                }
                              },
                              [_vm._v("more")]
