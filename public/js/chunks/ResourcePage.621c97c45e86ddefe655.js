...
/* harmony import */ var _playlists_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./playlists.vue */ "./resources/js/components/chats/playlists.vue");
//
//
//
//
...
var playlist = function playlist() {
  return Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./playlists */ "./resources/js/components/chats/playlists.vue"));
};
...
var render = function() {
  ...
  return _c("div", [
    _c(
      "div",
      {
        staticClass: "navigate d-flex px-2",
      ...
      [
        _c(
          ...
          { attrs: { color: "#3C87CD" } },
          [
            _c("v-icon", { staticClass: "mt-1" }, [_vm._v("las la-plus")]),
            _vm._v(" "),
            _c("span", { staticClass: "offset-lg-1 mt-1" }, [
              _vm._v("Add Playlist")
            ])
          ],
          1
