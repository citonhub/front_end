...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    openChat: function openChat(space) {
      this.$router.push({
        path: '/channels/' + space.space_id + '/content'
      });
...
var render = function() {
  ...
  return _c(
    "div",
    {
      ...
      style:
        _vm.source.space_id == _vm.that.$route.params.spaceId
          ? "align-items:center; justify-content:center; background:whitesmoke;"
          : "align-items:center; justify-content:center;",
      on: {
        click: function($event) {
          return _vm.openChat(_vm.source)
        }
      }
    },
    [
        ...
        [
          _c(
            ...
            [
              ...
              _c(
                "div",
                { staticClass: "px-1 py-0 my-0 col-4 d-flex flex-row-reverse" },
                [
                    ...
                    ? _c(
                        ...
                        [
                          _vm._v(
                            _vm._s(
                              _vm.checkDatereal(
                                _vm.source.last_message.created_at
                              )
                            )
                          )
                        ]
              ...
              _c(
                ...
                [
                  _vm.source.last_message.length != 0
                    ? _c("span", [
                        _vm._v(
                          _vm._s(_vm.source.last_message[0].username) +
                            ": " +
                            _vm._s(
                              _vm.generateMessageString(_vm.source.last_message)
                            )
                        )
                      ])
                    : _c("span", [
