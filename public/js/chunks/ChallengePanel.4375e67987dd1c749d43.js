...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    imageStyle: function imageStyle(height, data) {
      if (data.background_color == null) {
        var styleString = "position:absolute;height:" + height + ";top:0; left:0;width:100%;border-bottom:1px solid #c5c5c5; \n                 background-size: cover; border-top-left-radius:6px;border-top-right-radius:6px;\n                    background-repeat: no-repeat;";
        ...
        var _styleString2 = "position:absolute;height:" + height + ";top:0; left:0;width:100%;border-bottom:1px solid #c5c5c5; \n                 background-size: cover; border-top-left-radius:6px;border-top-right-radius:6px;\n                    background-repeat: no-repeat;";

        var imgLink = data.image_name + '.' + data.image_extension;
        _styleString2 += 'background-color:' + data.background_color + '; background-image:url(/imgs/challenges/' + imgLink + ');';
