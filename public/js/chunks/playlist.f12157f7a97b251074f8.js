...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      videos: ['Vue Routes', 'Props', 'Data Binding', 'Components', 'Code Along', 'Building '],
      lists: ['React Tutorial', 'Responsiveness', 'Tech Writing', 'MEVN Projects', 'Code Along'],
      toggleForm: false
    };
  }
});
      ...
      _c(
        ...
        [
          _c(
            "div",
            {
              staticClass: "created-lists mt-4",
              staticStyle: { background: "white", width: "90%" }
            },
            [
              _c(
                "div",
                { staticClass: "top d-flex mt-4" },
                [
