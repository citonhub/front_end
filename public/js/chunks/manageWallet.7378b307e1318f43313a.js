...
var render = function() {
  ...
  return _c("div", { staticStyle: { "overflow-x": "hidden" } }, [
    ...
    _c(
      ...
      {
        staticClass:
          "col-lg-10 offset-lg-1 py-0 application application--light",
        attrs: { "data-app": "true" }
      },
      [
        _c("div", { staticClass: "row" }, [
    ...
    _vm._v(" "),
    _c("div", {
      staticClass: "rounded-circle circle-1 shadow-sm",
      staticStyle: { width: "25px", height: "25px" }
    }),
    _vm._v(" "),
    _c("div", {
      staticClass: "rounded-circle circle-2 shadow-sm",
      staticStyle: { width: "25px", height: "25px" }
    }),
    _vm._v(" "),
    _c("div", {
      staticClass: "rounded-circle circle-3 shadow-sm",
      staticStyle: { width: "25px", height: "25px" }
    }),
    _vm._v(" "),
    _c("div", { staticClass: "steps d-flex col-lg-10 offset-1 px-0" }, [
      _vm._m(4),
      _vm._v(" "),
      _vm._m(5),
      _vm._v(" "),
      _c("div", { staticClass: "recurr col-lg-4" }, [
        _c(
          "h2",
          {
          ...
          [_vm._v("Setup Default Currency")]
        ),
        _vm._v(" "),
        _c(
          "div",
          { staticClass: "col-lg-10 offset-1" },
          [
            _c("v-select", {
              attrs: { label: "Naira(NGN)", outlined: "", height: "30px" }
            })
          ],
          1
        )
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "progress-bars col-lg-10 offset-1" }, [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "payment col-lg-4" }, [
      _c(
        "h2",
        {
          staticClass: "col-lg-12 text-center",
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "default col-lg-4" }, [
      _c(
        "h2",
        {
          staticClass: "col-lg-12 text-center",
        ...
        [_vm._v("Setup Recurring Payments")]
      )
    ])
  }
]
