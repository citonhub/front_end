...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    load: function load() {
      ...
      var fileurl = this.file;
      var download = this.saveFile(fileurl);
      download.then(function (results) {
        _this2.fileurl = URL.createObjectURL(results.response);

        if (_this2.audio.readyState >= 2) {
          _this2.loaded = true;
          _this2.loading = false;
          _this2.durationSeconds = parseInt(_this2.audio.duration);
