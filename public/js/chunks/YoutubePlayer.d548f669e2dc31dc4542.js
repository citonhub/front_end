            ...
            [
              _c(
                ...
                [
                  _vm._v(
                    "\n               " +
                      _vm._s(_vm.video.content.snippet.title) +
                      "\n          "
                  )
                ]
              ),
          ...
          _c(
            ...
            [
              _vm._v(
                "\n                " +
                  _vm._s(
                    _vm.convertDigit(_vm.video.content.statistics.viewCount, 1)
                  ) +
                  " views\n           "
              )
            ]
            ...
            [
              _c(
                ...
                [
                  _vm._v(
                    "\n               " +
                      _vm._s(_vm.content.content.snippet.channelTitle) +
                      "\n           "
                  )
                ]
              ),
                  ...
                  _c("div", [
                    _vm._v(
                      "\n                " +
                        _vm._s(
                          _vm.convertDigit(
                            _vm.video.content.statistics.likeCount,
                            1
                          )
                        ) +
                        " \n             "
                  ...
                  _c("div", [
                    _vm._v(
                      "\n                " +
                        _vm._s(
                          _vm.convertDigit(
                            _vm.video.content.statistics.dislikeCount,
                            1
                          )
                        ) +
                        " \n             "
