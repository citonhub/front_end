...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    if (this.$root.liveIsOn) {
      ...
      if (this.$root.remoteScreen) {// this.selectAction('screen_sharing')
      }

      if (this.$root.remoteCode) {//this.selectAction('live_coding')
      }

      if (this.$root.remoteAudio) {// this.selectAction('voice_chat')
      }
    } else {
  ...
  methods: (_methods = {
    setZoomer: function setZoomer() {
      var panzoom = __webpack_require__(/*! panzoom */ "./node_modules/panzoom/index.js");

      var element = document.getElementById('videos-container-sm-wrapper');
      panzoom(element);
    },
