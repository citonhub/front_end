  ...
  methods: {
    ...
    makeAdmin: function makeAdmin() {
      ...
      axios.post('/make-user-admin', {
        ...
        if (response.status == 200) {
          ...
          var storedMsg = _this2.$root.getLocalStore('full_' + _this2.$root.selectedSpace.space_id + _this2.$root.username);
          ...
          storedMsg.then(function (result) {
            if (result != null) {
              ...
              _this2.$root.LocalStore('full_' + _this2.$root.selectedSpace.space_id + _this2.$root.username, finalResult);
            }
          });
        }
    ...
    removeUser: function removeUser() {
      ...
      axios.post('/remove-user', {
        ...
        if (response.status == 200) {
          ...
          var storedMsg = _this3.$root.getLocalStore('full_' + _this3.$root.selectedSpace.space_id + _this3.$root.username);
          ...
          storedMsg.then(function (result) {
            if (result != null) {
              ...
              _this3.$root.LocalStore('full_' + _this3.$root.selectedSpace.space_id + _this3.$root.username, finalResult);
            }
          });
        }
      })["catch"](function (error) {});
    ...
    RemoveAdmin: function RemoveAdmin() {
      ...
      axios.post('/remove-user-admin', {
        ...
        if (response.status == 200) {
          ...
          var storedMsg = _this4.$root.getLocalStore('full_' + _this4.$root.selectedSpace.space_id + _this4.$root.username);
          ...
          storedMsg.then(function (result) {
            if (result != null) {
              ...
              _this4.$root.LocalStore('full_' + _this4.$root.selectedSpace.space_id + _this4.$root.username, finalResult);
            }
          });
        }
      })["catch"](function (error) {});
            ...
            axios.get('/fetch-space-messages-' + _this17.$route.params.spaceId).then(function (response) {
              if (response.status == 200) {
                if (response.data.space.space_id == _this17.$route.params.spaceId) {
                  ...
                  _this17.$root.LocalStore('full_' + _this17.$route.params.spaceId + _this17.$root.username, response.data);
    ...
    fetchSpaceInfo: function fetchSpaceInfo() {
      ...
      axios.get('/fetch-space-info-' + this.$root.selectedSpace.space_id).then(function (response) {
        if (response.status == 200) {
          var storedMsg = _this20.$root.getLocalStore('full_' + _this20.$root.selectedSpace.space_id + _this20.$root.username);
          ...
          storedMsg.then(function (result) {
            if (result != null) {
              ...
              _this20.$root.LocalStore('full_' + _this20.$root.selectedSpace.space_id + _this20.$root.username, finalResult);
            }
          }); // update chatList
