      ...
      axios.post('/like-hub-post', formData).then(function (response) {
        if (response.status == 204) {
          if (response.data == "liked") {
            _this4.$root.selectedPost.isLiked = 1;
          }
        } else {
...
var render = function() {
  ...
  return _c("div", { staticClass: "row px-2" }, [
    _c(
      ...
      {
        staticClass:
          "col-lg-6 offset-lg-3 py-1 py-md-2 fixed-top d-flex flex-row px-0",
        staticStyle: {
          position: "sticky",
          background: "white",
          "z-index": "99999999",
    ...
    _c(
      "div",
      { staticClass: "col-lg-6 offset-lg-3 px-2 mt-3 text-center" },
      [
        this.$root.selectedPost.project
          ? _c(
              "v-btn",
              {
                ...
                on: {
                  click: function($event) {
                    return _vm.goToProject(this.$root.selectedPost.project)
                  }
                }
              },
              [
    ...
    _c(
      "div",
      {
        staticClass: "col-lg-6 offset-lg-3 px-0 px-md-3 scroller",
        staticStyle: {
          background: "#E1F0FC",
    ...
    _c(
      "div",
      {
        staticClass: "col-lg-6 offset-lg-3 px-2 py-1 pb-2",
        staticStyle: {
      ...
      [
        _c("div", { staticClass: "row px-md-3 py-0" }, [
          _c(
            "div",
            {
              staticClass: "col-12  my-0 d-flex px-md-2 px-2 flex-row",
              staticStyle: {
                "align-items": "center",
                "justify-content": "center"
              }
