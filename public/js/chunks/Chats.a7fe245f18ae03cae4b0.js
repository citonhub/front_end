  ...
  methods: {
    TopIsVisible: function TopIsVisible(isVisible, entry) {
      if (isVisible) {
        ...
        var NextArrays = this.$root.returnedMessages.slice(Math.max(this.$root.returnedMessages.length - this.$root.messageSlicePosition, this.$root.messageSlicePosition));
        console.log(NextArrays);
        this.$root.messageSlicePosition += this.$root.messageSlicePosition;
        this.$root.Messages.concat(NextArrays);
      }
    },
    ...
    handleResults: function handleResults(messageArray) {
      ...
      var lastArrays = this.$root.returnedMessages.slice(Math.max(this.$root.returnedMessages.length - this.$root.messageSlicePosition, 0));
      return lastArrays;
    },
                                        ...
                                        directives: [
                                          {
                                            ...
                                            value: _vm.TopIsVisible,
                                            expression: "TopIsVisible"
                                          }
                                        ],
                                        staticClass: " col-12 text-center"
                                      },
