        ...
        axios.post('/check-if-email-exist', {
          ...
          if (response.status == 200) {
            ...
            if (response.data.status == 'exist') {
              _this2.$root.userEmail = _this2.email;

              _this2.$root.LocalStore('is_forget_password', [true]);
              ...
              _this2.showAlert('Oops!', 'Email not found, please try again.', 'error');
            }
          } else {
  ...
  return _c(
    ...
    [
      ...
      _c(
        "div",
        {
          staticClass: "d-lg-none col-md-8 offset-md-2 px-2  d-block",
          staticStyle: {
            "overflow-y": "auto",
            "z-index": "99999999",
            left: "0",
