  ...
  methods: {
    ...
    runCode: function runCode() {
      ...
      if (this.selectedLangId == 0 || this.language == 'HTML') {
        ...
        var status = this.$root.checkCodeForInput(this.code, this.selectedLangId);
      ...
      axios.post('/run-code-on-sandbox', {
        ...
        if (response.status == 200) {
          ...
          if (response.data[0].status.description == 'Accepted') {
            ...
            _this7.ResultCode = rresponse.data[0].stdout + '\n Error: \n' + response.data[0].stderr + ' \n' + response.data[0].compile_output + '\n' + response.data[0].error;
          }

          _this7.sendCodeRunning();
        }
      })["catch"](function (error) {
        _this7.ResultCode = 'An issue occured,unable to run on sandbox...';
