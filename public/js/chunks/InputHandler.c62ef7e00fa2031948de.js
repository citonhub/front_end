...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    SendToSandBox: function SendToSandBox() {
      var finalContent = this.$root.projectData.project_files.code_files[0].content;

      for (var index = 0; index < this.$root.projectInputData.length; index++) {
        var input = this.$root.projectInputData[index];

        var _ = __webpack_require__(/*! regexgen.js */ "./node_modules/regexgen.js/index.js");

        var inputRegex = _(_.capture('input\(\''), _.capture(input.name), _.capture('\'\)'));

        console.log(inputRegex);
        finalContent.replace(inputRegex, input.value);
      }
            ...
            return _c(
              ...
              [
                ...
                _c("v-text-field", {
                  ...
                  attrs: { dense: "", outlined: "", color: "#3C87CD" },
                  model: {
                    value: input.value,
                    callback: function($$v) {
