            ...
            [
              ...
              this.$root.selectedSpace.type == "Direct"
                ? _c(
                    ...
                    [_vm._v(_vm._s(this.$root.selectedSpace.userInfo.username))]
                  )
                : _vm._e(),
              _vm._v(" "),
              this.$root.selectedSpace.type == "Bot"
            ...
            [
              ...
              this.$root.typingSpace == this.$root.selectedSpace.space_id
                ? _c("span", { staticClass: "typingText d-block" }, [
                    _vm._v(_vm._s(this.$root.typinguser) + " is typing... ")
                  ])
                : _vm._e(),
              _vm._v(" "),
              !this.$root.typing &&
              ...
              this.$root.selectedSpaceMembers.length > 1
                ...
                : _vm._e(),
              _vm._v(" "),
              !this.$root.typing && this.$root.selectedSpace.type == "SubSpace"
                ? _c(
                    "span",
                    ...
                    [
                      ...
                      _c("span", { staticClass: "px-1" }, [
                        _vm._v("  " + _vm._s(this.$root.selectedSubSpaceName))
                      ])
                    ],
                    1
                  )
      ...
      [
        ...
        this.$root.selectedSpace.type == "Team"
          ? _c("div", {
              ...
              style: _vm.imageStyle(38, this.$root.selectedSpace, "channel"),
              on: {
                click: function($event) {
                  return _vm.showSideBar("channel_info")
                }
