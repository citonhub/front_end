...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    goToProfile: function goToProfile() {
      ...
      this.$root.selectedUsername = this.fetchedUser.username;
      this.$router.push({
        path: '/profile-view/' + this.fetchedUser.username
      });
    }
  }
});
...
var render = function() {
  ...
  return _c("div", [
    ...
    _c(
      ...
      [
        _c("div", { staticClass: "mt-1" }, [_vm._v(_vm._s(_vm.profileName))]),
        _vm._v(" "),
        _vm._l(_vm.fetchedUser, function(user) {
          return _c(
            "div",
            { key: user.user_temp_id, staticClass: "ml-4 mt-1" },
