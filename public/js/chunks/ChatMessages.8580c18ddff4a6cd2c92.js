...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  }, _defineProperty(_methods, "shortenContent", function shortenContent(content, limit) {
    if (content.length > limit) {
      var shortcontent = content.slice(0, limit);
      return shortcontent + '...';
    } else {
  ...
  }), _defineProperty(_methods, "checkDatereal", function checkDatereal(date) {
  ...
  }), _defineProperty(_methods, "covertDate", function covertDate(date) {
  ...
  }), _defineProperty(_methods, "languageExtensions", function languageExtensions(language) {
    if (language == 'HTML') {
      return 'html';
    }
