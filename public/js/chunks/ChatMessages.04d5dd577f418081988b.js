  ...
  methods: {
    ...
    scrollToMessage: function scrollToMessage(messageid) {
      ...
      setTimeout(function () {
        ...
        _this2.$root.chatComponent.$refs.messageContainer.scrollToItem(msgIndex - 2);

        _this2.$root.chatComponent.$refs.messageContainersmall.scrollToItem(msgIndex - 2);
      }, 200);
    },
            ...
            _c("div", { staticClass: "row" }, [
              _c(
                "div",
                {
                  ...
                  attrs: { id: "messageWrap" + _vm.source.message_id },
                  on: {
