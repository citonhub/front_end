    ...
    _c(
      ...
      _vm._l(_vm.comments, function(comment, i) {
        return _c("div", { key: i, staticClass: "row" }, [
          comment.user_id != _vm.that.$root.authProfile.id
            ? _c(
                "div",
                {
                      ...
                      [
                        _c("span", { staticClass: "d-inline-block mx-1" }, [
                          _c("i", {
                            ...
                            style: comment.liked == 1 ? "color: red;" : "",
                            on: {
                              click: function($event) {
                                return _vm.likeComment(comment.id)
                              }
                            }
                          }),
                          _vm._v(" "),
