...
/* harmony import */ var codemirror_addon_hint_anyword_hint_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! codemirror/addon/hint/anyword-hint.js */ "./node_modules/codemirror/addon/hint/anyword-hint.js");
/* harmony import */ var codemirror_addon_hint_anyword_hint_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(codemirror_addon_hint_anyword_hint_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var codemirror_addon_hint_css_hint_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! codemirror/addon/hint/css-hint.js */ "./node_modules/codemirror/addon/hint/css-hint.js");
/* harmony import */ var codemirror_addon_hint_css_hint_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(codemirror_addon_hint_css_hint_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var codemirror_addon_hint_html_hint_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! codemirror/addon/hint/html-hint.js */ "./node_modules/codemirror/addon/hint/html-hint.js");
/* harmony import */ var codemirror_addon_hint_html_hint_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(codemirror_addon_hint_html_hint_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var codemirror_addon_hint_javascript_hint_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! codemirror/addon/hint/javascript-hint.js */ "./node_modules/codemirror/addon/hint/javascript-hint.js");
/* harmony import */ var codemirror_addon_hint_javascript_hint_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(codemirror_addon_hint_javascript_hint_js__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony import */ var codemirror_addon_hint_show_hint_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! codemirror/addon/hint/show-hint.js */ "./node_modules/codemirror/addon/hint/show-hint.js");
/* harmony import */ var codemirror_addon_hint_show_hint_js__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(codemirror_addon_hint_show_hint_js__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var codemirror_addon_hint_sql_hint_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! codemirror/addon/hint/sql-hint.js */ "./node_modules/codemirror/addon/hint/sql-hint.js");
/* harmony import */ var codemirror_addon_hint_sql_hint_js__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(codemirror_addon_hint_sql_hint_js__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var codemirror_addon_hint_xml_hint_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! codemirror/addon/hint/xml-hint.js */ "./node_modules/codemirror/addon/hint/xml-hint.js");
/* harmony import */ var codemirror_addon_hint_xml_hint_js__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(codemirror_addon_hint_xml_hint_js__WEBPACK_IMPORTED_MODULE_9__);
var _methods;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: (_methods = {
  ...
  }, _defineProperty(_methods, "copyText", function copyText() {
  ...
  }), _defineProperty(_methods, "trackUser", function trackUser() {
    var _this2 = this;
  ...
  }), _defineProperty(_methods, "onCmCursorActivity", function onCmCursorActivity(codemirror) {
    console.debug('onCmCursorActivity', codemirror);
  }), _defineProperty(_methods, "loadPage", function loadPage() {
    this.$router.push({
      path: '/board/projects/panel/' + this.$route.params.project_slug + '/panel-loader'
    });
  }), _defineProperty(_methods, "fetchProject", function fetchProject() {
    var _this3 = this;
  ...
  }), _defineProperty(_methods, "showAlert", function showAlert(duration, text) {
    this.Alert = true;
    this.alertMsg = text;
  ...
  }), _defineProperty(_methods, "checkIfOwner", function checkIfOwner() {
    var _this4 = this;
  ...
  }), _defineProperty(_methods, "showCode", function showCode(codeBox) {
    var _this5 = this;
    ...
    if (this.$root.SelectedCodeBox.type == 'code_files' || this.$root.SelectedCodeBox.type == 'code_file') {
      ...
      this.$root.EditorLanguage = _codeData2.language_type;
      this.$root.codeEditorContent = _codeData2.content;
    ...
    this.canChange = true;
  }), _defineProperty(_methods, "removeCode", function removeCode(codeBox) {
    var newarray = [];

    if (this.$root.codeEditorArray.length >= 2) {
      var currentFilePosition = this.$root.codeEditorArray.indexOf(codeBox);
      ...
      if (currentFilePosition == 0) {
        ...
        var nextFilePosition = currentFilePosition - 1;
        var newSelectedCodeBox = this.$root.codeEditorArray[nextFilePosition];
      ...
      newarray = this.$root.codeEditorArray.filter(function (file) {
        return file.id != codeBox.id;
      });
    } else {
      this.$root.codeEditorComponent = undefined;
      this.$router.push({
        path: '/board/projects/panel/' + this.$root.projectData.project.project_slug
      });
      this.$root.codeEditorArray = newarray;
    }
  }), _defineProperty(_methods, "saveFileContent", _.debounce(function () {
    var _this6 = this;
    ...
    axios.post('/save-code-content-project', {
      ...
      _this6.$root.projectPanelComponent.showAlert('Oops!', 'Unable to save changes', 'error');

      _this6.loading = false;
    });
  }, 500)), _defineProperty(_methods, "handleIndexFile", function handleIndexFile(indexFile) {
    axios.post('/save-code-content-project', {
      project_slug: this.$route.params.project_slug,
  ...
  }), _defineProperty(_methods, "onCmReady", function onCmReady(codemirror) {
    codemirror.on('keypress', function () {
      codemirror.showHint();
    });
    console.debug('onCmReady', codemirror);
  }), _defineProperty(_methods, "onCmFocus", function onCmFocus(codemirror) {
    console.debug('onCmFocus', codemirror);
  }), _defineProperty(_methods, "onCmBlur", function onCmBlur(codemirror) {
    console.debug('onCmBlur', codemirror);
  }), _defineProperty(_methods, "onCmCodeChange", function onCmCodeChange(code) {
    var _this7 = this;
  ...
  }), _defineProperty(_methods, "saveFileHeight", function saveFileHeight(codemirror) {
  ...
  }), _defineProperty(_methods, "detectchange", function detectchange(language) {
    if (language == 'HTML') {
...
var render = function() {
  ...
  return _c("div", { staticClass: "row py-0 " }, [
    _c(
      "div",
      {
        ...
        _c(
          ...
          [
            _c(
              ...
              {
                staticClass:
                  "col-12 my-0 py-1 d-lg-flex flex-row d-none scroller ",
                staticStyle: {
                  "z-index": "9999999999",
                  left: "0",
                  background: "#F3F8FC"
