...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    ...
    }, _defineProperty(_ref, "loadingDelete", false), _defineProperty(_ref, "durationValueDay", 0), _defineProperty(_ref, "durationValueHr", 2), _defineProperty(_ref, "input", ''), _defineProperty(_ref, "language", ''), _defineProperty(_ref, "image", ''), _defineProperty(_ref, "imageDefault", 0), _defineProperty(_ref, "challengeIsActive", false), _ref;
  },
  ...
  methods: (_methods = {
    setEditValues: function setEditValues() {
      if (this.$root.selectedChallenge.length != 0 && this.$route.params.type == 'edit') {
        ...
        if (this.$root.selectedChallenge.languages) {
          this.language = this.$root.selectedChallenge.languages.toString();
    ...
    deleteChallenge: function deleteChallenge() {
      ...
      axios.post('/delete-challenge', {
        ...
        if (response.status == 200) {
          if (_this.$root.challengesList.length != 0) {
            var remainingChallenges = _this.$root.challengesList.filter(function (challenge) {
              return challenge.duel_id != _this.$root.selectedChallenge.duel_id;
            });

            _this.$root.challengesList = remainingChallenges;
          }
        ...
        _this.showAlert('Oops!', ' Unable to delete challenge', 'error');
    ...
    if (this.$refs.create.validate()) {
      ...
      axios.post('/save-challenge', formData, {
        ...
        if (response.status == 200) {
          // edit mode
          if (_this3.$route.params.type == 'edit') {
            _this3.showAlert('Saved', ' Your changes has been saved', 'success');
          ...
          var storedChallenges = _this3.$root.getLocalStore('user_challenges_' + _this3.$root.username);

          storedChallenges.then(function (result) {
            if (result != null) {
              var finalResult = JSON.parse(result);
              finalResult.unshift(response.data.challenge);
              _this3.$root.challengesList = finalResult;

              _this3.$root.LocalStore('user_challenges_' + _this3.$root.username, finalResult);
            }
        ...
        _this3.showAlert('Oops!', ' Unable to create challenge', 'error');
    ...
    axios.get('/fetch-user-channels-diary').then(function (response) {
      if (response.status == 200) {
        _this4.channelList = response.data;
      }
    })["catch"](function (error) {});
  }), _methods)
});
