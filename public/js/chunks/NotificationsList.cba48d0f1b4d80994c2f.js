  ...
  methods: {
    ...
    goToNotification: function goToNotification(notification) {
      if (notification.type == 'new_connection') {
        this.$router.push({
          path: '/profile/' + notification.dataArray[0].username
        });
      }
              ...
              : [
                  _vm.notifications.length == 0
                    ? [
                        _c(
                          "div",
                          { staticClass: "col-12 mt-md-4  mt-1 px-md-2 px-1" },
                          [
                            _c(
                              "div",
                              {
                              ...
                              [
                                ...
                                _c("p", [
                                  _vm._v(
                                    "Here is a brief description on each tab:"
                                  )
                                ]),
                                _vm._v(" "),
                                _vm._m(1),
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("p", [
      _c("b", { staticStyle: { "font-family": "MediumFont" } }, [
        _vm._v("1.) Channel:")
      ]),
      _vm._v(
        " Create your channel and add a payment plan to earn from teaching people how to code. Voice chat, share your screen, and live code in your channel.\n"
      )
    ])
  },
  function() {
    ...
    return _c("p", [
      ...
      _vm._v(" Organize challenges in multiple languages to help others.\n")
    ])
  },
  function() {
    var _vm = this
    ...
    return _c("p", [
      ...
      _vm._v(" Share your project with the community and get reviews. \n")
    ])
  },
  function() {
    var _vm = this
    ...
    return _c("p", [
      ...
      _vm._v(" Document your teaching in diaries.\n")
    ])
  },
  function() {
    var _vm = this
    ...
    return _c("p", [
      ...
      _vm._v(
        " Your earnings drop here. Pay out to your bank account from your wallet.\n"
      )
    ])
  }
]
