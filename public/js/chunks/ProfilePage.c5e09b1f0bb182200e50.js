...
var ImageCropperBoard = function ImageCropperBoard() {
  return Promise.resolve().then(function webpackMissingModule() { var e = new Error("Cannot find module '../dashboard.ImageCropper.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; });
};
