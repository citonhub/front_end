...
var render = function() {
  ...
  return _c("div", { staticClass: "row" }, [
    ...
    _c(
      "div",
      {
        staticClass: "col-md-1 py-1 d-md-block d-none text-right d-md-block",
        staticStyle: { "align-items": "center" }
      },
      [
        this.$root.selectedSpace.type != "Direct" &&
    ...
    _c(
      ...
      {
        staticClass:
          "col-md-1 py-1 d-md-block d-none text-right px-1 d-md-block",
        staticStyle: { "align-items": "center" }
      },
      [
        this.$root.selectedSpace.type != "Bot"
    ...
    _c(
      "div",
      {
        staticClass: "col-md-1 py-1 text-right d-none d-md-block",
        staticStyle: { "align-items": "center" }
      },
      [
        _c(
    ...
    _c(
      "div",
      {
        staticClass: "col-12 py-0 d-flex  flex-row d-md-none px-1",
        staticStyle: { "align-items": "center" }
      },
      [
        _c(
