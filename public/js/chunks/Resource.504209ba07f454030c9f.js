...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    if (!this.show_add_icon && this.checkIfisOwner() && this.resourceType != 'playlist_template') {
      setTimeout(function () {
        _this.saveResourceContentOrder(false);
      }, 1000);
    }
  },
  computed: {
    ...
    saveResourceContentOrder: function saveResourceContentOrder() {
      ...
      axios.post('/save-resources-content-order', {
        ...
        if (response.status == 200) {
          _this2.$root.LocalStore('channel_resource_content_' + _this2.$root.selectedResource.resource_id + _this2.$root.username, _this2.contents);
