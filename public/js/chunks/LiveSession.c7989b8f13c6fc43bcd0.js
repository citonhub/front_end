      ...
      _c(
        ...
        [
          _vm.liveBoardContent == "action_list"
            ...
            : _vm._e(),
          _vm._v(" "),
          _vm.liveBoardContent == "audio_speaker" ? [_vm._m(0)] : _vm._e()
        ],
        2
      ),
      _vm._v(" "),
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "col-8 py-0" }, [
      ...
      _vm._v(" ("),
      _c("span", { staticStyle: { "font-size": "12px" } }, [_vm._v("23")]),
      _vm._v(")\n                        ")
    ])
  },
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col-3 mr-2 py-0" }, [
      _c("div", {
        staticStyle: {
          "border-radius": "50%",
          height: "40px",
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col-7 py-0" }, [
