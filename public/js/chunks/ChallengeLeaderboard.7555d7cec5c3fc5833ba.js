...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    fetchParticipant: function fetchParticipant() {
      ...
      axios.get('/fetch-participants/' + that.$root.selectedChallenge.duel_id).then(function (response) {
        if (response.status == 200) {
          _this.participants = response.data.participants;
          _this.participants = _this.sortArray(_this.participants);
        } else {
    ...
    return _c("div", [
      _c("div", { staticClass: "col-lg-10 offset-lg-1 px-md-2 px-1" }, [
                ...
                _c(
                  ...
                  [
                    ...
                    _c("i", {
                      ...
                      staticStyle: { "font-size": "20px", color: "#560bad" }
                    })
                  ]
                ),
                _vm._v(" "),
        ...
        _c(
          "div",
          {
            staticClass: "col-12 py-0 pr-0 d-flex flex-row",
            staticStyle: { "align-items": "center" }
          },
          [
            _c(
            ...
            _c(
              ...
              [
                ...
                _c(
                  ...
                  {
                    staticClass:
                      "col-4 py-0 px-0 pt-1 pr-2 d-flex flex-row-reverse",
                    staticStyle: { "align-items": "center" }
                  },
                  [
                    _c("div", { staticStyle: { "font-size": "12px" } }, [
