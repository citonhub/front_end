...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios.get("/fetch-post/".concat(id)).then(function (response) {
      if (response.status == 200) {
        _this.post.currentPost = response.data;
      }
    });
  }
});
        ...
        _c(
          ...
          [
            ...
            _c(
              "span",
              { staticStyle: { "font-size": "12px", color: "grey" } },
              [_vm._v(_vm._s(_vm.post.likes / 1000) + "K")]
            )
          ],
          1
        )
      ...
      [
        _vm.post.project
          ? _c(
              ...
              [
                _vm._v("View source " + _vm._s(_vm.post.project)),
