      ...
      storedProjectData.then(function (result) {
        if (result != null) {
          ...
          if (_this.$root.projectData.project.is_web) {
            _this.$root.editorSideComponent.showEditor(_this.$root.projectData.project_files.code_files[0], 'front-end');
          } else {
            _this.$root.editorSideComponent.showEditor(_this.$root.projectData.project_files.code_files[0], 'code-file');
