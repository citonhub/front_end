...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    generateMessageString: function generateMessageString(message) {
      var finalString = '';
    ...
    imageStyle: function imageStyle(dimension, data) {
      if (data.background_color == null) {
        ...
        var _styleString = "border-radius:50%;height:" + dimension + "px;width:" + dimension + "px;background-size:contain;";

        var imgLink = data.image_name + '.' + data.image_extension;
        _styleString += 'background-color:' + data.background_color + '; background-image:url(' + this.$root.baseImageUrl + '/imgs/space/' + imgLink + ');';
        return _styleString;
      }
    }
  }
    ...
    _vm._l(_vm.that.$root.ChatList, function(space, index) {
      return _c(
        "div",
        {
          ...
          style:
            space.space_id == this.$route.params.space_id
              ...
              _c(
                ...
                [
                  _c(
                    "div",
                    {
                      staticClass: "col-8 px-0 py-0 my-0 ",
                      staticStyle: {
                        "white-space": "nowrap",
                        overflow: "hidden",
                  ...
                  _c("div", { staticClass: "col-4 py-0 my-0  text-right" }, [
                    space.last_message
                      ? _c(
                          ...
                          [
                            _vm._v(
                              "checkDatereal(space.last_message.created_at)"
                            )
                          ]
                        )
                      : _vm._e()
