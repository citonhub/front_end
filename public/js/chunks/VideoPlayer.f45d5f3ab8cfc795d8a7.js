            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  video = document.getElementById('video' + _this.playerId);
                  player = new shaka.Player(video);
                  videoContainer = document.getElementById('videocontainner' + _this.playerId);
      ...
      ? _c(
          "div",
          {
            ...
            style:
              ...
              _vm.backgroundImg +
              "); border-radius: 10px;",
            attrs: { id: "playerContainer" + _vm.playerId }
          },
          [
            _c("div", [
              _c(
    ...
    _c(
      "div",
      {
        ...
        attrs: {
          ...
          id: "videocontainner" + _vm.playerId
        }
      },
      [
        _c("video", {
