                      ...
                      directives: [
                        {
                          ...
                          rawName: "v-show",
                          value:
                            _vm.source.type == "Team" ||
                            _vm.source.type == "Channel",
                          expression:
                            "source.type == 'Team' || source.type == 'Channel'"
                        }
                      ],
                      staticStyle: { color: "green", "font-size": "13px" }
                    },
                    [
                      _c(
                        "v-icon",
                        {
                          staticStyle: { "font-size": "17px", color: "green" }
                        },
                        [_vm._v("mdi mdi-pound")]
                      ),
                      _vm._v(" (" + _vm._s(_vm.source.subspace_messages) + ") ")
                    ],
                    1
                  )
                ]
