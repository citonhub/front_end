...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    this.setType();
    this.contentInWord = this.$root.selectedResource.info;
  },
  methods: {
...
var render = function() {
  ...
  return _c("div", { staticClass: "py-1" }, [
    ...
    _c("div", { staticClass: "col-12 px-2 px-md-2" }, [
      _vm.that.$root.selectedResource.user_id != _vm.that.$root.user_temp_id
        ? _c(
            "span",
        ...
        : _c(
            "div",
            { staticStyle: { width: "100%", height: "90px" } },
            [
              _c("v-textarea", {
                staticStyle: { "font-size": "13px", "font-family": "BodyFont" },
                attrs: {
    ...
    _c(
      ...
      {
        staticStyle: { "font-size": "13px", "font-family": "BodyFont" },
        domProps: { innerHTML: _vm._s(_vm.contentInWord) }
      },
      [
        _vm._v(
          "\n          Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis totam praesentium sequi, suscipit officia numquam aut, voluptatibus culpa cumque ducimus ab quasi necessitatibus nulla omnis assumenda, ratione enim! Odit, quod?\n         "
