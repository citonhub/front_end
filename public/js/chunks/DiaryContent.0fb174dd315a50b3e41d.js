  ...
  methods: {
    ...
    imageStyle: function imageStyle(size, data) {
      if (data.background_color == null) {
        var styleString = "height:" + size + "px;width:" + size + "px;background-size:cover;border-radius:7px;background-repeat: no-repeat; border:5px solid #3C87CD;";
        ...
        var _styleString = "height:" + size + "px;width:" + size + "px;background-size:cover;border-radius:7px;background-repeat: no-repeat;border:5px solid #3C87CD; ";
        ...
        _vm.loading
          ...
          : [
              ...
              _c(
                "div",
                {
                  staticClass: "col-12 py-1 px-2 mt-2 d-flex flex-row",
                  staticStyle: {
                    "align-items": "center",
                  ...
                  _c("div", { staticClass: "d-flex flex-row" }, [
                    _c("div", [
                      _c(
                        ...
                        [_vm._v(" " + _vm._s(this.$root.selectedDiary.users))]
                      ),
                      _vm._v(" "),
                      _c(
                        "span",
                    ...
                    _c("div", { staticClass: "ml-1" }, [
                      _c(
                        ...
                        [_vm._v(_vm._s(_vm.calculateView()))]
                      ),
                      _vm._v(" "),
                      _c(
                        "span",
