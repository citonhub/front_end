...
var render = function() {
  ...
  return _c(
    "v-card",
    {
      staticClass: "py-0 px-0 col-lg-12 col-md-8 ",
      staticStyle: { "min-width": "200px", "max-width": "250px" }
    },
    [
      _c(
        "div",
        ...
        [
                ...
                "v-card",
                {
                  ...
                  on: {
                    click: function($event) {
                      return _vm.controlAction("resources")
                    }
                  }
                },
                [
          ...
          (this.$root.selectedSpace.type == "Channel" ||
            this.$root.selectedSpace.type == "SubSpace" ||
            this.$root.selectedSpace.type == "Team") &&
          this.$root.selectedSpace.payment_option == null
            ? _c(
                "v-card",
                {
                  staticClass: "px-2 py-2 d-flex flex-row",
                  ...
                  on: {
                    click: function($event) {
                      return _vm.controlAction("payment")
                    }
                  }
                },
                [
                  _c("v-icon", { staticClass: "mr-1" }, [
                    _vm._v("las la-credit-card")
                  ]),
                  _vm._v(" "),
                  _c(
                    "span",
