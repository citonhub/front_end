...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: (_methods = {
    ...
    if (data.background_color == null) {
      ...
      var _styleString2 = "border-radius:50%;height:" + dimension + "px;width:" + dimension + "px;background-size:contain;border:1px solid #c5c5c5;cursor:pointer; ";
    ...
    return imageUrl;
  }), _defineProperty(_methods, "showProject", function showProject(id, postId) {
  ...
  }), _defineProperty(_methods, "goToProfile", function goToProfile(username) {
                                        ...
                                        _c(
                                          ...
                                          [
                                            _c(
                                              ...
                                              {
                                                staticClass:
                                                  "col-12 py-0 my-0 px-1 text-left"
                                              },
                                              [
                                                _c(
                                                  "div",
                                                  ...
                                                  [
                                                    _c(
                                                      ...
                                                      {
                                                        staticClass:
                                                          "col-10 py-0 my-0 d-flex flex-row",
                                                        staticStyle: {
                                                          "align-items":
                                                            "center"
                                                        }
