    ...
    leaveSpace: function leaveSpace() {
      ...
      axios.post('/leave-space', {
        ...
        if (response.status == 200) {
          var storedChat = _this.$root.getLocalStore('user_chat_list' + _this.$root.username);
          ...
          storedChat.then(function (result) {
            if (result != null) {
              ...
              _this.$root.LocalStore('user_chat_list' + _this.$root.username, finalResult, false, 'leave_space');
            }
          });
        }
                ...
                return _c(
                  "v-card",
                  {
                    ...
                    on: {
                      click: function($event) {
                        $event.stopPropagation()
                        return _vm.goToProfile(member.username)
                      }
                    }
                  },
                  [
          ...
          [
            _vm.selectedSpaceMembers.is_admin == false
              ? _c(
                  ...
                  [
                    _c("span", { staticStyle: { "font-size": "13px" } }, [
                      _vm._v(_vm._s(_vm.$t("space.make_admin")))
                    ])
                  ]
                )
              : _c(
                  ...
                  [
                    _c("span", { staticStyle: { "font-size": "13px" } }, [
                      _vm._v(_vm._s(_vm.$t("space.remove_admin")))
                    ])
                  ]
                ),
            _vm._v(" "),
            ...
            _c(
              "v-card",
              {
                ...
                on: {
                  click: function($event) {
                    $event.stopPropagation()
                    return _vm.goToProfile(_vm.selectedSpaceMembers.username)
                  }
                }
              },
              [
                _c("span", { staticStyle: { "font-size": "13px" } }, [
                  _vm._v(_vm._s(_vm.$t("space.view_profile")))
                ])
              ]
            )
          ],
