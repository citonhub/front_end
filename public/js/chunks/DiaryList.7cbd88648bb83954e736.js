  ...
  methods: {
    ...
    imageStyle: function imageStyle(size, data) {
      if (data.background_color == null) {
        var styleString = "height:" + size + "px;width:" + size + "px;background-size:cover;border-radius:3px;background-repeat: no-repeat; ";
        ...
        var _styleString = "height:" + size + "px;width:" + size + "px;background-size:cover;border-radius:3px;background-repeat: no-repeat; ";
            ...
            this.$root.TopBarComponentBoard
              ? [
                  this.$root.TopBarComponentBoard.searchContent.length > 0
                    ? _vm._l(this.$root.diarySearchList, function(diary) {
                        return _c(
                          "div",
                          {
                            key: diary.id + "search",
                            ...
                            _c(
                              ...
                              [
                                _c(
                                  ...
                                  {
                                    staticClass:
                                      "col-12 py-0 my-0 d-flex flex-row"
                                  },
                                  [
                        ...
                        _vm.loadingDiary
                          ...
                          : [
                              _c(
                                ...
                                {
                                  staticClass:
                                    "col-12 text-center  px-2  pt-0 pb-2 d-md-none d-block"
                                },
                                [
                                  _c(
                                    "v-btn",
                              ...
                              this.$root.diaryList.length == 0
                                ...
                                : _vm._l(this.$root.diaryList, function(diary) {
                                    return _c(
                                      "div",
                                      {
                                        key: diary.id,
    ...
    return _c(
      ...
      [
        ...
        _c("span", { staticStyle: { "font-family": "MediumFont" } }, [
          _vm._v("what you know")
        ]),
        _vm._v(
          ". You can help others improve, by sharing them.\r\n                    "
        )
      ]
    )
  }
