    ...
    fetchPost: function fetchPost() {
      ...
      storedPostData.then(function (result) {
        if (result != null) {
          ...
          _this4.$root.selectedPost = finalResult;

          if (!_this4.$root.selectedPost.link) {
            _this4.showPage();
          }

          _this4.loadingPost = false; // this.updatePost();
        } else {
          axios.get('/fetch-post/' + _this4.$route.params.post_id).then(function (response) {
            if (response.status == 200) {
              _this4.$root.LocalStore('post_data_' + _this4.$route.params.post_id + _this4.$root.username, response.data.data);

              _this4.$root.selectedPost = response.data.data;

              if (!_this4.$root.selectedPost.link) {
                _this4.showPage();
              }

              _this4.loadingPost = false;
            }
          })["catch"](function (error) {
            _this4.loadingPost = false;
          });
...
var render = function() {
  ...
  return _c("div", { staticClass: "row px-2" }, [
    _c(
      "div",
      {
        staticClass: "col-lg-6 offset-lg-3 py-2 fixed-top d-flex flex-row px-1",
        staticStyle: {
          position: "sticky",
          background: "white",
          "z-index": "99999999",
          ...
          [
            _c(
              ...
              [
                ...
                _c(
                  "div",
                  { staticClass: "col-12", staticStyle: { height: "100%" } },
                  [
                    this.$root.selectedPost.link
                      ? [
                          _c("iframe", {
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col-6 py-0 px-0 d-flex flew-row" }, [
      _c("div", {
        staticClass: "mr-2",
        staticStyle: {
          "border-radius": "50%",
      ...
      _c(
        ...
        [
          ...
          _c("i", {
            staticClass: "las la-award",
            staticStyle: { "font-size": "25px", color: "#90BE6D" }
          })
        ]
      )
    ])
