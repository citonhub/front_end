...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      interests: ['red', 'indigo', 'orange', 'primary', 'secondary', 'success', 'info', 'warning', 'error', 'red darken-3', 'indigo darken-3', 'orange darken-3']
    };
  }
});
    ...
    _c(
      ...
      [
        _c("v-checkbox", {
          ...
          attrs: { value: "Javascript", color: "blue", "hide-details": "" },
          model: {
            value: _vm.picked,
            callback: function($$v) {
              _vm.picked = $$v
        ...
        _vm._v(" "),
        _c("p", { staticClass: "label mt-1 ml-2" }, [_vm._v("Javascript")])
      ],
      1
    )
  ])
