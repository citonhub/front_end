...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    postData: function postData() {
      ...
      axios.post('/save-hub-post', post).then(function (response) {
                ...
                _vm.postLink
                  ? _c("v-text-field", {
                      ...
                      model: {
                        value: _vm.post.link,
                        callback: function($$v) {
                          _vm.$set(_vm.post, "link", $$v)
                        },
                        expression: "post.link"
                      }
                    })
                  : _c("v-select", {
                      attrs: { label: "Select Project" },
                      model: {
                        value: _vm.post.projectSlug,
                        callback: function($$v) {
                          _vm.$set(_vm.post, "projectSlug", $$v)
                        },
                        expression: "post.projectSlug"
                      }
                    })
              ],
              1
