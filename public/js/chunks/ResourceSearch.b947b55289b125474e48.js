  ...
  methods: {
    ...
    searchTags: function searchTags(e) {
      ...
      var searchResult = this.allTagStore.filter(function (tag) {
        ...
        return nameValue.includes(_this.queryContent.toLowerCase());
      });
    ...
    fetchDevToTags: function fetchDevToTags() {
      ...
      axios.get('/devto-tags').then(function (response) {
        if (response.status == 200) {
          _this2.devToTags = response.data.tags;
          _this2.allTagStore = response.data.tags;
        }
    ...
    loadNextResult: function loadNextResult() {
      ...
      if (this.$root.resourceSearchType == 'youtube') {
        axios.get("/search-youtube/".concat(this.searchQuery, "/").concat(this.nextPageToken)).then(function (response) {
          if (response.status == 200) {
            ...
            _this3.searchResult = _this3.searchResult.concat(finalResult);
            _this3.loadingNext = false;
          }
        })["catch"](function (error) {
          _this3.loadingNext = false;
        });
      ...
      if (this.$root.resourceSearchType == 'devto') {
        var searchString = this.searchQuery.toString();
        this.devToPageCount++;
        axios.get("/search-devto/".concat(searchString, "/").concat(this.devToPageCount)).then(function (response) {
          if (response.status == 200) {
    ...
    searchSite: function searchSite() {
      ...
      if (this.$root.resourceSearchType == 'youtube') {
        axios.get("/search-youtube/".concat(this.searchQuery)).then(function (response) {
          if (response.status == 200) {
            ...
            _this4.searchResult = finalResult;
            _this4.loadingSearch = false;
          }
        })["catch"](function (error) {
          _this4.loadingSearch = false;
        });
      ...
      if (this.$root.resourceSearchType == 'devto') {
        var searchString = this.searchQuery.toString();
        axios.get("/search-devto/".concat(searchString)).then(function (response) {
          if (response.status == 200) {
        ...
        _c(
          ...
          [
            ...
            _c(
              "div",
              {
                staticClass: "col-12 text-center py-0 d-flex flex-row px-0",
