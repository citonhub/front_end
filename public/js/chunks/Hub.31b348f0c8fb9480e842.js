...
/* harmony import */ var _bootstraps_globalPackage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../bootstraps/globalPackage */ "./resources/js/bootstraps/globalPackage.js");
...
var ProjectView = function ProjectView() {
  return Promise.all(/*! import() | ProjectView */[__webpack_require__.e("vendors~Board~Hub~LiveSession~ProjectView~Resource~ResourceView"), __webpack_require__.e("vendors~ChallengesList~Chats~ProjectView"), __webpack_require__.e("ProjectView")]).then(__webpack_require__.bind(null, /*! ./ProjectView.vue */ "./resources/js/components/Hub/ProjectView.vue"));
};
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
      ...
      if (shown) {
        ...
        axios.get('/fetch-posts' + '?page=' + this.newPage).then(function (response) {
          if (response.status == 200) {
            ...
            if (_this2.newData.length == 0) {
              _this2.dataHasFinished = true;
            }
    ...
    showAlert: function showAlert() {
      ...
      if (type == 'info') {
        izitoast__WEBPACK_IMPORTED_MODULE_2___default.a.info({
          title: title,
          message: message,
          zindex: '9999999999',
      ...
      if (type == 'success') {
        izitoast__WEBPACK_IMPORTED_MODULE_2___default.a.success({
          title: title,
          message: message,
          zindex: '9999999999',
          timeout: 2000,
      ...
      if (type == 'warning') {
        izitoast__WEBPACK_IMPORTED_MODULE_2___default.a.warning({
          title: title,
          message: message,
          zindex: '9999999999',
          timeout: 2000,
      ...
      if (type == 'error') {
        izitoast__WEBPACK_IMPORTED_MODULE_2___default.a.error({
          title: title,
          message: message,
          zindex: '9999999999',
          timeout: 2000,
    ...
    [
      ...
      _c(
        "div",
        {
          ...
          style: !_vm.$screen.lg
            ? "position:absolute; height:92%; left:0%; top:9%; overflow-y:auto; overflow-x:hidden; padding-bottom:60px; padding-top:20px; "
