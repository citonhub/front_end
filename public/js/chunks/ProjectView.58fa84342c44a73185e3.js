...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: (_methods = {
    ...
    var storedPostData = this.$root.getLocalStore('post_data_' + this.$root.currentPost + this.$root.username);
    storedPostData.then(function (result) {
      if (result != null) {
        ...
        axios.get('/fetch-post/' + _this10.$root.currentPost).then(function (response) {
          if (response.status == 200) {
            _this10.$root.LocalStore('post_data_' + _this10.$root.currentPost + _this10.$root.username, response.data.data);
