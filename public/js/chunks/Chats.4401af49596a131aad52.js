...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getUserLevel: function getUserLevel() {
      var result = this.calculateLevel(this.$root.authProfile);
      return result[0];
    },
    getuserRemainingPoint: function getuserRemainingPoint() {
      var result = this.calculateLevel(this.$root.authProfile);
      return result[1];
    },
        ...
        if (this.$root.ChatList.length == 0) {
          ...
          storedChat.then(function (result) {
            if (result != null) {
              ...
              _this11.$root.loadingChatList = false;

              _this11.checkUserLevel();
            } else {
              axios.get('/fetch-chat-list/' + _this11.$root.userDeviceId).then(function (response) {
                if (response.status == 200) {
                  ...
                  _this11.$root.ChatList = responseList.channels.concat(responseList.direct_messages, responseList.pet_spaces);
    ...
    fetchSpaceInfo: function fetchSpaceInfo() {
      ...
      axios.get('/fetch-space-info-' + this.$root.selectedSpace.space_id).then(function (response) {
        if (response.status == 200) {
          var storedMsg = _this24.$root.getLocalStore('full_space_' + _this24.$root.selectedSpace.space_id + _this24.$root.username);
          ...
          storedMsg.then(function (result) {
            if (result != null) {
              ...
              if (response.data.space.type == 'SubSpace') {
                var generalSpace = response.data.space.gen_space;
                _this24.$root.selectedGenSpaceType = response.data.space.gen_space.type;
                ...
                var subSpaceData = response.data.space.sub_space_data;
                _this24.$root.selectedSubSpaceName = response.data.space.name;
                _this24.$root.selectedSubSpaceType = subSpaceData.type;
                generalSpace.sub_spaces = response.data.space.sub_spaces;
                _this24.$root.selectedSpace = generalSpace;
              } else {
                _this24.$root.selectedSpace = response.data.space;
              }

              finalResult.members = response.data.members;

              _this24.$root.LocalStore('full_space_' + _this24.$root.selectedSpace.space_id + _this24.$root.username, finalResult);
            }
          }); // update chatList

          var storedChat = _this24.$root.getLocalStore('user_chat_list_new_' + _this24.$root.username);
          ...
          storedChat.then(function (result) {
            if (result != null) {
              ...
              if (response.data.space.type == 'Channel' || response.data.space.type == 'Team') {
                finalResult.channels.map(function (chat) {
                  if (chat.space_id == _this24.$root.selectedSpace.space_id) {
              ...
              if (response.data.space.type == 'Direct') {
                finalResult.direct_messages.map(function (chat) {
                  if (chat.space_id == _this24.$root.selectedSpace.space_id) {
              ...
              if (response.data.space.type == 'Bot') {
                finalResult.pet_spaces.map(function (chat) {
                  if (chat.space_id == _this24.$root.selectedSpace.space_id) {
              ...
              var fullList = finalResult.channels.concat(finalResult.direct_messages, finalResult.pet_spaces);
              _this24.$root.ChatList = fullList;

              _this24.$root.sortChatList();

              _this24.SetUnread();

              _this24.$root.LocalStore('user_chat_list_new_' + _this24.$root.username, finalResult);
            }
          });
        }
      })["catch"](function (error) {});
                                        ...
                                        ? [
                                            _c(
                                              ...
                                              [
                                                ...
                                                _c("br"),
                                                _vm._v(
                                                  "\n                     \n                    We believe we can improve the way "
                                                ),
                                                _c(
                                                  "span",
                                                  {
                                                  ...
                                                  [
                                                    _vm._v(
                                                      "developers mentor and get mentored"
                                                    )
                                                  ]
                                                ),
                                                _vm._v(
                                                  " on the internet. Join us,\n\n\n\n                      "
                                                ),
                                                _c(
                                                  "div",
                                                  {
                                    ...
                                    _c(
                                      ...
                                      [
                                        ...
                                        _c(
                                          "div",
                                          {
                                            staticClass: "col-12 py-1 px-1 mt-3"
                                          },
                                          [
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c(
      ...
      [_c("div", { attrs: { id: "videos-container-sm" } })]
    )
  }
]
