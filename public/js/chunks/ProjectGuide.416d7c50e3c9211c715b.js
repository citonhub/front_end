  ...
  function() {
    ...
    return _c(
      ...
      [
        ...
        _vm._v(" "),
        _c("div", { staticClass: "body col-lg-6 px-1 py-1 mb-4" }, [
          _c(
            "h2",
            {
          ...
          _c("div", { staticClass: "assets col-lg-10 px-1 py-1 mb-4" }, [
            _c(
              ...
              [_vm._v("Uploading Assets")]
            ),
            _vm._v(" "),
            _c("p", [
              _vm._v(
                "\n       To add assets to your project you have to upload them. Choose the category that suits the assets you want to upload and click on the add button right beside it.\n       Click on the upload box to open up your device files.You can then browse through to pick the asset you want and click on the upload button to \n"
              )
            ])
          ])
        ])
