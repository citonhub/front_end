...
}), _defineProperty(_data$components$moun, "showAddPost", function showAddPost() {
  this.$router.push({
    path: '/hub/new-post'
  });
}), _defineProperty(_data$components$moun, "closeAddPost", function closeAddPost() {
  this.$root.showAddNewPost = false;
  window.history.length > 1 ? this.$router.go(-1) : this.$router.push('/');
}), _defineProperty(_data$components$moun, "fetchPost", function fetchPost() {
  var _this = this;
