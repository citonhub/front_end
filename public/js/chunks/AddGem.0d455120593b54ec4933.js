...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    showAddModal: function showAddModal() {
      this.$router.push({
        path: '/board/diary/board/' + this.$route.params.diary_id + '/modal'
      });
    },
    ...
    sendMessageData: function sendMessageData(formData) {
      ...
      axios.post('/create-response-content', formData, {
        ...
        onUploadProgress: function onUploadProgress(progressEvent) {
          _this5.progressvalue = parseInt(Math.round(progressEvent.loaded / progressEvent.total * 100));
        }
        ...
        if (response.status == 200) {
          ...
          _this5.responseContents.push(message);

          _this5.loadingSendMsg = false;
          _this5.progressvalue = 0;
        }
