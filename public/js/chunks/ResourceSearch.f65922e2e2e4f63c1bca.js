...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    loadNextResult: function loadNextResult() {
      ...
      if (this.$root.resourceSearchType == 'youtube') {
        axios.get("/search-youtube/".concat(this.searchQuery, "/").concat(this.$root.nextPageToken)).then(function (response) {
          if (response.status == 200) {
            var searchResult = response.data.result;
            _this4.$root.nextPageToken = response.data.nextPageToken;
            var finalResult = [];
            ...
            _this4.$root.searchResult = _this4.$root.searchResult.concat(finalResult);
      ...
      if (this.$root.resourceSearchType == 'youtube') {
        axios.get("/search-youtube/".concat(this.searchQuery)).then(function (response) {
          if (response.status == 200) {
            ...
            _this5.$root.searchResult = finalResult;
            _this5.$root.loadingSearch = false;
          }
        })["catch"](function (error) {
          _this5.$root.loadingSearch = false;
        });
