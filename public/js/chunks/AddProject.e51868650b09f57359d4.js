    ...
    createProject: function createProject() {
      ...
      axios.post('/create-project', {
        ...
        if (response.status == 200) {
          _this.$root.forcePanelReload = true;
          _this.$root.fromChatList = false;

          _this.$router.push({
            path: '/' + _this.$route.params.project_slug + '/panel'
          });
        }
      })["catch"](function (error) {
        _this.showAlert(5000, 'Failed- ' + error);
