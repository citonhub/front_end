...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getReplyMsg: function getReplyMsg() {
      var finalString = '';
                ...
                [
                  ...
                  _c(
                    ...
                    [
                      _c("div", { staticStyle: { "font-size": "13px" } }, [
                        _vm._v(_vm._s(_vm.getReplyMsg(_vm.source)))
                      ]),
                      _vm._v(" "),
                      _c("div", { staticClass: "text-right" }, [
                        _c(
                          ...
                          [_vm._v(_vm._s(_vm.source.replied_message.username))]
                        )
                      ])
                    ]
                  ),
                  ...
                  _vm.checkIfMsgIsLong(_vm.source)
                    ? [
                        _c("span", {
                          staticStyle: { "font-size": "13px" },
                          attrs: { id: "shortContent" + _vm.source.message_id },
                          domProps: {
                            innerHTML: _vm._s(
                              _vm.shortContent(_vm.source.content, 300)
                            )
                        ...
                        _vm._v(" "),
                        _c("span", {
                          staticStyle: { "font-size": "13px", display: "none" },
                          attrs: { id: "fullContent" + _vm.source.message_id },
