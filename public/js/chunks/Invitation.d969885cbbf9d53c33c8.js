...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: (_methods = {
    ...
    var link = 'whatsapp://send?text=' + shareLink + '. Sent from CitonHub.';
    window.location = link;
  }), _defineProperty(_methods, "shareToTwitter", function shareToTwitter() {
    var link = 'https://twitter.com/intent/tweet?' + 'url=' + shareLink + '&text=Sent from CitonHub.';
    window.location = link;
  }), _defineProperty(_methods, "shareToFacebook", function shareToFacebook() {
    var link = 'https://www.facebook.com/sharer/sharer.php?u=' + shareLink + '. Sent from CitonHub.';
    window.location = link;
