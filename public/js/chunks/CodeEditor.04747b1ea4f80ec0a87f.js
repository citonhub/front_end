...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    generateRegex: function generateRegex() {
      ...
      var regex = _(_.startOfLine(), _.capture('http', _.maybe('s')), '://', _.capture(_.anyCharBut(':/').repeat()), _.group(':', _.capture(_.digital().multiple(2, 4))).maybe(), '/', _.capture(_.anything()), _.endOfLine());
