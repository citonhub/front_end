  ...
  methods: {
    imageStyle: function imageStyle(size, data) {
      if (data.background_color == null) {
        var styleString = "height:" + size + "px;width:" + size + "px;background-size:cover;border-radius:8px;background-repeat: no-repeat; ";
        ...
        var _styleString = "height:" + size + "px;width:" + size + "px;background-size:cover;border-radius:8px;background-repeat: no-repeat; ";
    ...
    imageStyleUser: function imageStyleUser(size, data) {
      if (data.background_color == null) {
        ...
        var _styleString2 = "height:" + size + "px;width:" + size + "px;background-size:cover;border-radius:50%;background-repeat: no-repeat; ";
          ...
          _c(
            ...
            [
              _c("div", { staticClass: "mx-2" }, [
                _c("div", { style: _vm.imageStyle(40, ["data"]) })
              ]),
              _vm._v(" "),
              _vm._m(1)
            ]
