  ...
  methods: {
    ...
    imageStyle: function imageStyle(height, data) {
      if (data.background_color == null) {
        var styleString = "width:100%;height:" + height + "px;position:absolute; left:0%; top:0%; border-left-top-radius:10px;  border-right-top-radius:10px; border:1px solid transparent;background-repeat: no-repeat; box-shadow: 0px 0px 8px -2px rgba(60, 135, 205, 0.25);background-size:cover; ";
