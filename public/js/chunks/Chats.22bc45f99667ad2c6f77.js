...
var ChatList = function ChatList() {
  return Promise.all(/*! import() | ChatList */[__webpack_require__.e("vendors~ChatList~ChatMessages~ReplyView"), __webpack_require__.e("ChatList")]).then(__webpack_require__.bind(null, /*! ./ChatList.vue */ "./resources/js/components/chats/ChatList.vue"));
};

var ChatMessages = function ChatMessages() {
  return Promise.all(/*! import() | ChatMessages */[__webpack_require__.e("vendors~ChatList~ChatMessages~ReplyView"), __webpack_require__.e("ChatMessages")]).then(__webpack_require__.bind(null, /*! ./ChatMessages.vue */ "./resources/js/components/chats/ChatMessages.vue"));
};
...
var ReplyView = function ReplyView() {
  return Promise.all(/*! import() | ReplyView */[__webpack_require__.e("vendors~ChatList~ChatMessages~ReplyView"), __webpack_require__.e("ReplyView")]).then(__webpack_require__.bind(null, /*! ./ReplyView.vue */ "./resources/js/components/chats/ReplyView.vue"));
};
                        ...
                        _vm.that.$root.Messages.length != 0
                          ? _c(
                              "div",
                              {
                                ...
                                attrs: { "data-app": "true", id: "largeView" }
                              },
                              [
                                _c("DynamicScroller", {
          ...
          _vm.chatIsOpen && _vm.that.$root.Messages != null
            ? [
                _c(
                  "div",
                  {
                    staticClass: "application application--light row py-0",
                    attrs: { "data-app": "true", id: "smallView" }
                  },
                  [
                    _c(
                      "div",
