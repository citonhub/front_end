...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: (_methods = {
    ...
    deleteResource: function deleteResource(resource) {
      ...
      this.playlists = remainingResources;
      axios.post('/delete-resources', {
        resource_id: resource.resource_id
      }).then(function (response) {
        if (response.status == 200) {
          _this2.$root.chatComponent.showAlert('Deleted!', 'Resource has been deleted', 'success');

          _this2.$root.LocalStore('channel_resource_' + _this2.$root.selectedSpace.space_id + _this2.$root.username, _this2.response);

          _this2.saveResourceOrder(false);
        }
      })["catch"](function (error) {
        _this2.$root.chatComponent.showAlert('Oops!', 'Unable to delete resource,please try again', 'error');
      });
    },
    ...
    storedResouces.then(function (result) {
      if (result != null) {
        ...
        _this3.checkForNewResource();
      } else {
        axios.get("/fetch-resource/".concat(_this3.$root.selectedSpace.space_id, "/resource")).then(function (response) {
          if (response.status == 200) {
            _this3.$root.LocalStore('channel_resource_' + _this3.$root.selectedSpace.space_id + _this3.$root.username, response.data.resources);

            var _finalResult = response.data.resources;
            _this3.resources = _finalResult;
            _this3.loadingResources = false;
          }
        })["catch"](function (error) {
          _this3.loadingResources = false;
    ...
    axios.post('/create-resource', {
      ...
      if (response.status == 200) {
        ...
        var storedResouces = _this6.$root.getLocalStore('channel_resource_' + _this6.$root.selectedSpace.space_id + _this6.$root.username);
        ...
        storedResouces.then(function (result) {
          if (result != null) {
            ...
            _this6.$root.LocalStore('channel_resource_' + _this6.$root.selectedSpace.space_id + _this6.$root.username, finalResult);
          } else {}
        });

        _this6.resources.unshift(response.data.resource);
                              ...
                              [
                                _c(
                                  "v-btn",
                                  {
                                    ...
                                    on: {
                                      click: function($event) {
                                        return _vm.deleteResource(resource)
                                      }
                                    }
                                  },
                                  [_vm._v("Yes")]
