...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    selectEmoji: function selectEmoji(emoji) {
      if (this.$refs.bottomSm) {
        this.$refs.bottomSm.input = this.$root.channelBottomComp.input + emoji.data;
      }

      if (this.$refs.bottomLg) {
        this.$refs.bottomLg.input = this.$root.channelBottomComp.input + emoji.data;
      }
    },
