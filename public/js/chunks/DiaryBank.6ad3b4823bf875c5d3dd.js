  ...
  methods: {
    ...
    imageStyle: function imageStyle(size, data) {
      if (data.background_color == null) {
        var styleString = "height:" + size + "px;width:" + size + "px;background-size:cover;border-radius:7px;background-repeat: no-repeat;border:1px solid #c5c5c5; ";
        ...
        var _styleString = "height:" + size + "px;width:" + size + "px;background-size:cover;border-radius:10px;background-repeat: no-repeat; border:1px solid #c5c5c5;";
