          ...
          _c(
            ...
            [
              _c(
                "v-btn",
                { attrs: { icon: "" } },
                [_c("v-icon", [_vm._v("las la-trash-alt")])],
                1
              )
            ],
            1
                  ...
                  [
                      ...
                      : [
                          _c("div", [
                            _c(
                              ...
                              {
                                staticClass:
                                  "col-12 px-2 px-md-2 mt-1 d-flex justify-content-between"
                              },
                              [
                                _c(
                                  "h6",
                            ...
                            _c("div", [
                              _c(
                                ...
                                {
                                  staticClass:
                                    "col-12 py-1 my-0 px-2 d-flex mt-3 form-group"
                                },
                                [
                                  _c(
                                    "div",
                                    ...
                                    [
                                      ...
                                      _c("input", {
                                        ...
                                        domProps: { value: _vm.currentBranch },
                                        on: {
                              ...
                              _c(
                                ...
                                [
                                  _c(
                                    ...
                                    [_vm._v("You have not made any changes")]
                                  ),
                                  _vm._v(" "),
                                  _c("div")
                                ],
                              ...
                              _c(
                                "div",
                                { staticClass: "col-12 px-2 px-md-2 py-1" },
                                [
                                  _c("h6", [_vm._v("Commit History")]),
                                  _vm._v(" "),
                                  _vm._l(_vm.commits, function(commit, index) {
                                    return _c(
                                      "div",
                                      {
                                        key: index,
                                        staticClass: "action px-2 py-2 mt-3",
                                        staticStyle: {
                                          border:
                                            "2px solid rgba(125, 179, 229, 0.4)",
                                          "border-radius": "5px",
                                          "font-family": "BodyFont"
                                        }
                                      },
                                      [
                                        ...
                                        _c(
                                          ...
                                          [
                                            _c("span", [_vm._v("Adenikym")]),
                                            _vm._v(" . "),
                                            _c("span", [_vm._v("20-8-21")])
                                          ]
                                        ),
                                        _vm._v(" "),
                                        _c(
                    ...
                    _vm.branch
                      ? _c(
                          ...
                          {
                            staticClass:
                              "col-8 d-flex flex-column align-items-center py-1 px-2",
                            staticStyle: {
                              position: "absolute",
                              background: "white",
                              top: "25%",
                          ...
                          [
                            ...
                            _c(
                              ...
                              {
                                staticClass:
                                  " text-center col-12 py-1 mt-4 my-0 px-2"
                              },
                              [
                                _c(
                                  "v-btn",
                    ...
                    _vm.listBranch
                      ? _c(
                          "v-card",
                          {
                            staticClass: "col-4 d-flex flex-column  py-1 px-1",
                            staticStyle: {
                              position: "absolute",
                              background: "white",
                              top: "5%",
                          ...
                          _vm._l(_vm.branches, function(branch, index) {
                            return _c(
                              "div",
                              {
                                ...
                                staticStyle: {
                                  "border-bottom":
                                    "1px solid rgba(125, 179, 229, 0.4)",
                                  "border-radius": "0"
                                },
                                on: {
                                  click: function($event) {
                                    return _vm.changeBranch(branch)
                                  }
                                }
                              },
                              [
