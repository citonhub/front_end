...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
      ...
      if (!this.$root.authProfile.user_onboarded) {
        axios.post('/save-user-onboarded-status').then(function (response) {
          if (response.status == 200) {
            _this.$root.authProfile.user_onboarded = true;
          }
    ...
    searchChatList: function searchChatList(e) {
      var _this2 = this;
...
var render = function() {
  ...
  return _c("div", [
    _c(
      "div",
      {
        staticClass: "col-12 d-block d-lg-none py-2 ",
        staticStyle: {
          position: "absolute",
          top: "0",
          left: "0",
              ...
              [
                _c("div", { staticClass: "row" }, [
                  _c(
                    ...
                    [
                      _c(
                        ...
                        {
                          attrs: { icon: "" },
                          on: { click: _vm.showSidebarHandler }
                        },
                        [
                  ...
                  _c(
                    "div",
                    {
                      staticClass: "col-7 d-flex flex-row py-0 px-1",
                      staticStyle: {
                  ...
                  _c(
                    "div",
                    { staticClass: "col-1 px-0 text-center py-0" },
                    [
