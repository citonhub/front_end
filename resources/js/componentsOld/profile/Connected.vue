<template>
       <div style="position:absolute; height:100%;  overflow-y:auto;left:0;top:0%;border-right:1px solid #e6e6e6;  border-left:1px solid #e6e6e6;" class=" scrollerStyle  col-lg-6 offset-lg-3 py-0 px-0 my-0"> 
