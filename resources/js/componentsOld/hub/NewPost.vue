<template>
    ...
    <v-row>
       ...
       <v-row>
         ...
         <div  @click="closeAddBoardCtl()"  v-if="!closeAddBoard" style="position:fixed;  height:100%; background:rgba(38, 82, 89,0.5); overflow-y:hidden; overflow-x:hidden; left:0%; top:0%; align-items:center; justify-content:center; z-index:999999999999999999;" class="  col-lg-6 offset-lg-3 py-2 my-0 px-0 d-flex ">
