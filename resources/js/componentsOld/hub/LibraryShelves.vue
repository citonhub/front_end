<template>
     <div  style="background:transparent; font-family:BodyText;">
       ...
       <div class="   col-lg-6 offset-lg-3 py-0 px-0 my-0" style=" border-right:1px solid #e6e6e6;  border-left:1px solid #e6e6e6; position:fixed;  background:rgba(38, 82, 89,0.6); height:100%; overflow-y:auto; overflow-x:hidden; z-index:200;" 
         @click="closeShelve">
