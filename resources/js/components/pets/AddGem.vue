        ...
        <div class="row">
         ...
         <div class="col-lg-6 offset-lg-1 mb-2">
           ...
           <div class="col-lg-6 offset-lg-1 py-1">
            ...
            <h5 style="font-size:15px;color:gray;" >Responses</h5>
            
         </div>

          <div class="col-lg-10 offset-lg-1 d-flex flex-row flex-wrap py-0" style="align-items:center;">
           
            <v-chip close dense color="#3C87CD" class="mr-2 my-1"  style="font-size:13px; color:#ffffff; font-family:BodyFont;" >First response</v-chip>

              <v-chip close dense outlined color="#3C87CD" class="mx-r my-1"  style="font-size:13px;  font-family:BodyFont;" >Another response</v-chip>
         ...
         <div class="col-lg-10 py-1 offset-lg-1 d-flex flex-row" style="align-items:center;">
             ...
             <div style="font-family:MediumFont;font-size:14px;color:gray;">Contents</div>
              <v-btn icon class="mx-1"><v-icon style="font-size:20px;">las la-plus</v-icon></v-btn>
