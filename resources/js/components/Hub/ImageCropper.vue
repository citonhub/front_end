<template>
    <div class="d-flex px-2 flex-column py-2"  style="height:90%;weight:100%;left:0%;">
        ...
        <div style="height:100%;">
               ...
               <image-cropper :img="that.$root.imagepath" :componentType="cropType" :stencilProps="cropProp" class=" d-flex col-12 " ref="cropper"
...
const ImageCropper = () => import(
    /* webpackChunkName: "ImageCropperMain" */ '../dashboard/ImageCropperMain.vue'
  );
export default {
    data(){
        return{
