<template>
    <div data-app="true" class=" application application--light" style="position:fixed;height:100%;background:#F5F5FB; width:100%;">
       ...
       <!-- hub content -->
        ...
        <div class="col-lg-10  offset-lg-1 d-none d-md-block col-12 px-0 d-md-block d-none" style="background:#F5F5FB;z-index:99999999999999; position:absolute; height:auto; top:8%; " >
