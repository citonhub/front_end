     ...
     <!-- top bar -->
       ...
       <div class="row py-1 my-0 px-1" >
         ...
         <div class="col-6 py-0 my-0 d-flex"  style="border-bottom:2px solid #4495a2; align-items:center; justify-content:center;" >
           <span  style="font-size:12px; color:#4495a2; font-weight:bolder;font-family:HeaderText;">Create New Bot</span>
         </div>
         <div class="col-3 py-1 my-0 text-right px-1"  style="border-bottom:2px solid #4495a2; " >
             <v-btn rounded x-small :loading="loading" :disabled="editFeild" @click="saveChanges" color="#3E8893" style="font-size:11px; font-weight:bolder; color:white;font-family: Headertext;">create</v-btn>
         </div>
      </div>
     </div>
      ...
      <div class="col-12 py-1 my-0" >
         <v-form class="row my-2 py-2 px-2 ">
              ...
              <div class="col-12 col-lg-8 offset-lg-2 py-2 my-0 px-2">
                 <div>
                     <span style="font-size:12px;color:#666666;">Bot Profile Image</span>
                 </div>
...
var blob = this.b64toBlob(realData, contentType);
 ...
 goBack() {
       ...
       axios.post( '/create-new-bot',formData,
         {
             headers:{
          ...
          .then(response => {
           ...
           if (response.status == 201) {
                this.loading = false;
                   ...
                   this.$router.push({ path: '/panel/bot/setup/' + response.data.bot_id });
            }else{
