<template>
       <div style="position:absolute; height:100%;  overflow-y:auto;left:0;top:0%;border-right:1px solid #e6e6e6;  border-left:1px solid #e6e6e6;" class=" scrollerStyle col-md-8 offset-md-2  col-lg-6 offset-lg-3 py-0 px-0 my-0"> 
       ...
       <div class="row py-1 my-0 px-1" >
         ...
         <router-link :to="'/profile/connections/' + this.$route.params.username"  class="col-5 py-0 my-0 d-flex" style="border-bottom:2px solid #c9e4e8; align-items:center;justify-content:center;">
          <span  style="font-size:12px; color:#3E8893; font-weight:bolder;font-family:HeaderText;">Connections</span>
         </router-link>
         <router-link :to="'/profile/connected/' + this.$route.params.username" class="col-5 py-0 my-0 d-flex" style="border-bottom:2px solid #3E8893; align-items:center;justify-content:center;">
         ...
         <div class="row my-0 py-0">
           ...
           <div class="col-12 py-1 my-0" v-for="(user,index) in connected" :key="index">
...
export default {
    ...
    methods:{
      ...
      if (response.status == 200) {
       ...
       this.connected = response.data.data;
