...
<div>
  <!-- small and medium and large screen -->
     ...
     <div class="col-12  px-0  d-block  py-0" style="position:fixed; left:0; height:100%; top:0%; background:white; z-index:99999999999999999999;">
      ...
      <div class="col-12 py-0 px-0 px-md-2 " style="position:fixed;width:100%;border-bottom:2px solid #3C87CD; border-radius:0px; background:white; z-index:9999999999999999999;">
