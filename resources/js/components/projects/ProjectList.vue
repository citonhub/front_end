...
<div>
   ...
   <div class="col-12 d-md-block d-none fixed-top" style="position:sticky; background:#F5F5FB;">
    <h5>Projects</h5>
   </div>
  ...
  <div class="col-lg-10 offset-lg-1 py-1 col-md-10 offset-md-1 px-2">
      ...
      <div class="row text-center">
          ...
          border-radius:20px;box-shadow: 0px 0px 8px -2px rgba(60, 135, 205, 0.25);background: url(/imgs/projectImg.jpg);background-size:cover;">
           ...
           <div class="py-2 px-2 d-flex" style="height:auto; position:absolute; bottom:16%; width:auto; 
           right:0%;  border:1px solid transparent; align-items:center; justify-content:center;background: rgba(27, 27, 30, 0.4);">
             <div>
            <span class="d-inline-block mx-1" >
                <i class="lar la-heart" style="font-size:20px;color:white;" ></i> 
                <span style="font-family:MediumFont; font-size:12px; color:white;">231</span>
            </span>

             <span class="d-inline-block mx-1" >
                <i class="las la-comment" style="font-size:20px;color:white;" ></i> 
                <span style="font-family:MediumFont; font-size:12px; color:white;">32</span>
            </span>
            ...
            <div class="col-12 py-0 my-0 text-left">
                <div class="row py-0 my-0">
                   ...
                   <div class="col-2 text-right py-0 my-0">
                       <i class="lab la-python" style="font-size:25px;"></i>
                   </div>
                </div>
            </div>
          </v-card>
          ...
          border-bottom-right-radius:20px;">
              ...
              <div class="col-12 py-0 my-0 text-left">
                <div class="row py-0 my-0">
                   <div class="col-10 py-0 my-0 d-flex" style="align-items:center;">
                      <div style="font-family:MediumFont; font-size:13px;" >Project title 2 </div>
                   </div>
                   <div class="col-2 text-right py-0 my-0">
                       <i class="lab la-html5" style="font-size:25px;"></i>
                   </div>
                </div>
            </div>
       ...
       <div class="py-2 px-2 d-flex" style="height:auto; position:absolute; bottom:16%; width:auto; 
          ...
          border-bottom-right-radius:20px;">
               <div class="col-12 py-0 my-0 text-left">
                <div class="row py-0 my-0">
                   <div class="col-10 py-0 my-0 d-flex" style="align-items:center;">
                      <div style="font-family:MediumFont; font-size:13px;" >Project title 3</div>
                   </div>
                   <div class="col-2 text-right py-0 my-0">
                       <i class="lab la-js-square" style="font-size:25px;"></i>
                   </div>
                </div>
            </div>
          </v-card>
