<template> 
    ...
    <template v-if="that.$root.authProfile.points < 100">
      ...
      <div class="py-3   px-md-3 px-2" style="font-size:13px; font-family:BodyFont;">
        ...
        at least a <span style="font-size:13px; font-family:MediumFont;">Bronze developer</span> On CitonHub. As a mentor, you can <span style="font-size:13px; font-family:MediumFont;">create a channel to mentor and earn</span>.
