...
<div class="py-2 d-flex flex-column text-center " style="position:absolute;background-color:white;top:0;justify-content:center;align-items:center;width:90%;">
...
">
  ...
  <input @change="addInterest()" class="form-check-input mt-2" type="checkbox" value="" id="defaultCheck1">
...
<div style="position:absolute;background-color:white;bottom:0%;right:0%;" class="buttons mt-2 col-lg-12 offset-8 d-flex ">
  <p class="offset-lg-9" style="font-size:1.2rem;font-weight:bold;">Skip</p>  <v-btn    class="ml-2 px-2" style="color:white;background-color: #3C87CD;border-radius:10px;height:30px;">Done</v-btn>
</div>
