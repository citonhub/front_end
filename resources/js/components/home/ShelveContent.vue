<template>
    ...
    <div class="col-12 py-1" :id="'postShelve'+source.id">
        ...
        <div style="background:#b8dbe0; border:1px solid #b8dbe0; border-radius:10px;" class="px-2  pt-2 pb-2 my-0">
             ...
             <div class="col-10 py-0 my-0 px-0 text-left">
                 <span style="font-size:12px; font-family:HeaderText;" class="d-block" @click.stop="viewUser(source.commented_post)" ><b>{{source.commented_post.username}}</b></span>
             ...
             <div class="py-0 px-2 col-12 my-0">
                   <div class="row">
                    <div class="col-3 my-0 py-0 text-center">
                     ...
                     <v-btn class="d-inline-block" icon @click.stop="viewPost(source)">
                     ...
                     <div class="col-3 my-0 py-0 text-center">
                      <v-btn class="d-inline-block" icon @click="share(source)">
...
export default {
   ...
   this.$router.push({ path: '/post/' + postData.username + '/' + postData.PostId + '/user' });
        ...
        library: function(post){
            ...
            this.$root.postArrayType = this.$root.postShelveData;
