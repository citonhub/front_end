     ...
     <div style="overflow-y:hidden;">
       ...
       <div class="row py-1 my-0 px-1" >
         ...
         <div class="col-4 py-0 my-0 d-flex"  style="border-bottom:2px solid #4495a2; align-items:center; justify-content:center;" >
            <span  style="font-size:12px; color:#4495a2; font-weight:bolder;font-family:HeaderText;">Privacy Policy</span>
         </div>
         <div class="col-4 py-0 my-0  d-flex"  style="border-bottom:2px solid #4495a2; align-items:center; justify-content:center;" >
       ...
       <div class="py-1 my-0" style="position:absolute;top:7%; height:93%;width:100%; left:0; overflow-y:auto; overflow-x:hidden; ">
        ...
        <div class="row px-2"  style="background-color:white; " >
        ...
        These changes are effective immediately, after they are posted on this page.
          ...
          <p class="paragraphTextStyle">
       If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at citonhub@gmail.com.
          </p>
