<template>
     <v-app style="background:transparent; font-family:BodyText;">
       ...
       <div class="col-md-8 offset-md-2  col-lg-6 offset-lg-3 py-0 px-0 my-0" style=" border-right:1px solid #e6e6e6;  border-left:1px solid #e6e6e6; position:fixed; background:white; height:100%; overflow-y:auto; overflow-x:hidden; ">
         <div class="row my-0 py-0 px-2">

         <div :style="'position:absolute; height:100%; width:100%; overflow-y:auto;left:0;top:0%;background:' + this.$root.fullImageColor +';'"> 
