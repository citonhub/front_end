...
body {
 ...
 @section('content')
  ...
  <!-- this contains all that is shown in the profile tab -->
...
<!-- The profile component, this is where all other vue components are pulled in  -->
<profile></profile>
<!-- ends -->
...
<!-- The large(system view)  rigth side navigator-->
 ...
 style="border-radius:7px; height:80%; position:fixed; width:15%;top:10%; right:8.30%; background:transparent; border:1px solid transparent;" >
      ...
      <div  color="#ffffff" v-if="isLogged"  @click="logout"  class="col-12 px-2 py-2 card" style="border:1px solid transparent; border-radius:10px;cursor:pointer; position:absolute;bottom:0%;">
           <div class="row py-0">
            <div class="col-3 py-0 d-flex" style="align-items:center; justify-content:center;">
