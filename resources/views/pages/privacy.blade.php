...
@section('title')
 ...
 @endsection
 @section('meta') 
 <meta name="description" content="CitonHub privacy" />
  ...
  <meta name="apple-mobile-web-app-capable" content="yes">
    ...
    <meta property="og:description" content="CitonHub privacy" />
    <meta property='twitter:title' content="CitonHub privacy"/>
 ...
 <div class="mt-5 pt-5">
        ...
        <div >
            ...
            <p class="paragraphTextStyle">
              Citonhub operates the Website citonhub.com, which provides the internet service.
            </p>

            <p class="paragraphTextStyle">
              This page is used to inform website visitors regarding our policies with the collection, 
              use, and disclosure of Personal Information if anyone decided to use our services at citonhub.com
            </p>
           ...
           The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions,
            which is accessible at  citonhub.com, unless otherwise defined in this Privacy Policy.

            </p>

            <h5  style="font-family:HeaderFont;" >Information Collection and Use</h5>

             <p class="paragraphTextStyle">
            For a better experience while using our Service, we may require you to provide us with certain personally identifiable information, 
            including your name and email. The information that we collect will be used to contact or identify you.

            </p>


            <h5  style="font-family:HeaderFont;">Log Data</h5>
           ...
           the time and date of your visit, the time spent on those pages, and other statistics.
            ...
            <h5  style="font-family:HeaderFont;">Cookies</h5>
          ...
          <h5  style="font-family:HeaderFont;">Service Providers</h5>
         ...
         <h5  style="font-family:HeaderFont;">Security</h5>
         ...
         or method of electronic storage is 100% secure and reliable, and we cannot guarantee its absolute security.
          ...
          <h5  style="font-family:HeaderFont;">Links to Other Sites</h5>
         ...
         Our Service may contain links to other sites. If you click on a third-party link, you will be directed to that site.
          ...
          We have no control over, and assume no responsibility for the content, privacy policies, or practices of any third-party sites or services.
           ...
           <h5  style="font-family:HeaderFont;">Children's Privacy</h5>

          <p class="paragraphTextStyle">
         Our Services do not address anyone under the age of 4. We do not knowingly collect personal identifiable information from children under 4.
          In the case we discover that a child under 4 has provided us with personal information, we immediately delete this from our servers. 
          ...
          please contact us so that we will be able to do necessary actions.
           ...
           <h5  style="font-family:HeaderFont;">Changes to This Privacy Policy</h5>
        ...
        These changes are effective immediately, after they are posted on this page.
           ...
           <h5  style="font-family:HeaderFont;">Contact Us</h5>

          <p class="paragraphTextStyle">
       If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at admin@citonhub.com.
          </p>
