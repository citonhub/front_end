 ...
 @section('content')
    ...
    <div class="container">
      <div class="mt-5 p-5 text-center">
        <h1 class="mt-5 text-uppercase">This is a test</h1>
      </div>
      <div>
        <h3 class="text-uppercase">Please read this document carefully</h3>
...
<pre>Option 1: The Site is intended for users who are at least 18 years old. Persons under the age of 18 are not permitted to register for the Site.
