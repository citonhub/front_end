...
<div class="wallet-option d-lg-none d-md-none d-block col-12 px-0" style="width:100%;height:400px;margin-top:150px;">
<img src="imgs/topbg.png" alt="" width="100%" height="100%">
<img src="imgs/credit-vector.png"  alt="" style="position:absolute;z-index:1;left:22%;top:-150px;width:450px;height:330px;">
<p class="text-center"  style="position:absolute;z-index:1;left:33%;top:200px;color:black;">Grow developer communities and earn <br> from paid sessions and paid communities.</p>
...
<div class="collab col-12 d-lg-none d-md-none d-sm-block  px-0 py-0" style="">
...
<div class="teach d-lg-none d-md-none d-block col-12 px-0" style="width:100%;height:400px;margin-top:150px;">
<img src="imgs/topbg.png" alt="" width="100%" height="100%">
...
<div class="features col-lg-12 px-0 d-md-block d-none">
...
<div class="features  d-md-none d-block px-0">
...
<img src="imgs/twitter-bird.png" style="height: 17px;width: 21.25px;margin-top:220px;" class="offset-5" alt="">
<img src="imgs/instagram-home.png"  style="height: 17px;width:17px;margin-top:220px;" class="ml-2" alt="">
...
<ul style="list-style:none;color:white;margin-top:160px;" class="d-lg-none d-block">
