...
<meta name="twitter:card" content="summary_large_image"/>
 ...
 @section('content')
<div id="home" style="overflow-y:auto; position:absolute;width:100%;height:100%;">
...
<div class="col-lg-12 text-center  d-none d-lg-block flex-column mt-4" style=" align-items:center; justify-content:center;  z-index:20;">
...
<div class="d-lg-none d-block col-12 " style="left:0%;  z-index:80;">
...
<!-- bottom text -->
<div class="col-12 d-lg-block d-none" style=" height:auto;z-index:83;">
...
<div style="width:100%;height:700px; z-index:20;margin-top:330px;" class="d-lg-block d-none ">
<img src="imgs/topbg.png" height="100%" width="100%">
</div>



<div  style="width:100%; height:20%; bottom:0; z-index:20;" class="d-lg-none d-block">
...
<div style="width:100%; height:100%; left:-425px; top:-5px; opacity: 0.5;" class="d-lg-none d-block">
